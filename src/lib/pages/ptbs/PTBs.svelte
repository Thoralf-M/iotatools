<script lang="ts">
    ...
    import { copyToClipboard, formatAddress } from '../../utils/formatting';
    import { EpochPTBAnalyzer, type DisplayData } from '../programmable-transaction-block';
    import {
        getNextCheckpoint,
    ...
    function previousCheckpoint() {
        const prev = getPreviousCheckpoint(selectedCheckpoint, displayData.checkpointData);
        if (prev !== undefined) {
            selectedCheckpoint = prev;
            fetchCheckpointTransactions(selectedCheckpoint);
        }
    }

    function nextCheckpoint() {
        const next = getNextCheckpoint(selectedCheckpoint, displayData.checkpointData);
        if (next !== undefined) {
            selectedCheckpoint = next;
            fetchCheckpointTransactions(selectedCheckpoint);
        }
    }
                                    ...
                                    <div class="function-signature">
                                        <div class="function-parts">
                                            ...
                                            <button
                                                ...
                                                on:click={async () =>
                                                    await copyToClipboard(func.fullName)}
                                ...
                                <div class="address-header">
                                    <div class="address-left">
                                        ...
                                        <button
                                            ...
                                            style="padding: 4px 8px; align-self: center;"
                                            on:click={async () =>
                                                await copyToClipboard(sender.address)}
                                            title="Copy address"
                                        >
                                            📋
                                        </button>
                                ...
                                <div class="address-header">
                                    <div class="address-left">
                                        ...
                                        <button
                                            ...
                                            style="padding: 4px 8px; align-self: center;"
                                            on:click={async () =>
                                                await copyToClipboard(pkg.package)}
                                            title="Copy address"
                                        >
                                            📋
                                        </button>
                                        ...
                                        <div class="package-info">
                                            <div class="package-id-row">
                                                ...
                                                <button
                                                    ...
                                                    style="padding: 4px 8px; align-self: center;"
                                                    on:click={async () =>
                                                        await copyToClipboard(pkg.packageId)}
                                            ...
                                            <div class="sender-row">
                                                ...
                                                <button
                                                    ...
                                                    style="padding: 4px 8px; align-self: center;"
                                                    on:click={async () =>
                                                        await copyToClipboard(pkg.sender)}
                                        ...
                                        <div class="function-signature">
                                            <div class="address-left">
                                                ...
                                                <button
                                                    ...
                                                    style="padding: 4px 8px; align-self: center;"
                                                    on:click={async () =>
                                                        await copyToClipboard(cmd.type)}
