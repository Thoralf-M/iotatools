...
<main>
    <div class="lang-toggle">
        ...
        <button class:active={lang === 'de'} onclick={() => (lang = 'de')}>Deutsch</button>
    </div>
    ...
    {#if lang === 'en'}
        ...
        <h2>1. General</h2>
        <p>
            This website ("iotatools.dev") is an experimental, open-source tool for interacting with
            the IOTA blockchain. It is provided "as is" and "as available" without warranty of any
            kind, express or implied. Use of this website is entirely at your own risk.
        </p>

        <h2>2. No Financial Advice</h2>
        <p>
            Nothing on this website constitutes financial, investment, legal, or tax advice. The
            information and tools provided are for informational and educational purposes only. You
            should consult a qualified professional before making any financial decisions.
        </p>

        <h2>3. Blockchain Data</h2>
        <p>
            Blockchain data displayed on this website is retrieved directly from public blockchain
        ...
        <h2>4. Transaction Irreversibility</h2>
        <p>
            Blockchain transactions are irreversible once confirmed. You are solely responsible for
        ...
        <h2>5. Private Keys and Security</h2>
        <p>
            If you use the local key storage features, your private keys are stored exclusively in
        ...
        <p>
            This website may interact with third-party services, including but not limited to
            blockchain nodes, faucet endpoints, and hardware wallet interfaces. We are not
            responsible for the availability, accuracy, or security of these external services.
        </p>

        <h2>7. Limitation of Liability</h2>
        <p>
            To the fullest extent permitted by law, the operators of this website shall not be
            ...
            funds, data loss, or business interruption.
        </p>

        <h2>8. Experimental Software</h2>
        <p>
            This website is experimental software under active development. Features may change,
            break, or be removed without notice. Always verify critical operations independently and
            do not rely solely on this tool for important transactions.
        </p>
    {:else}
        ...
        <h2>1. Allgemeines</h2>
        <p>
            Diese Website ("iotatools.dev") ist ein experimentelles, quelloffenes Werkzeug zur
            ...
            dieser Website erfolgt vollständig auf eigenes Risiko.
        </p>

        <h2>2. Keine Finanzberatung</h2>
        <p>
            Nichts auf dieser Website stellt eine Finanz-, Anlage-, Rechts- oder Steuerberatung dar.
            ...
            konsultieren, bevor Sie finanzielle Entscheidungen treffen.
        </p>

        <h2>3. Blockchain-Daten</h2>
        <p>
            Die auf dieser Website angezeigten Blockchain-Daten werden direkt von öffentlichen
        ...
        <h2>4. Unumkehrbarkeit von Transaktionen</h2>
        <p>
            Blockchain-Transaktionen sind nach der Bestätigung unwiderruflich. Sie sind allein dafür
            ...
            Transaktionen rückgängig machen, stornieren oder ändern.
        </p>

        <h2>5. Private Schlüssel und Sicherheit</h2>
        <p>
            Wenn Sie die lokale Schlüsselspeicherung nutzen, werden Ihre privaten Schlüssel
        ...
        <p>
            Diese Website kann mit Diensten Dritter interagieren, einschließlich, aber nicht
        ...
        <p>
            Soweit gesetzlich zulässig, haften die Betreiber dieser Website nicht für direkte,
            ...
            beschränkt auf Verlust von Guthaben, Datenverlust oder Betriebsunterbrechung.
        </p>

        <h2>8. Experimentelle Software</h2>
        <p>
            Diese Website ist experimentelle Software in aktiver Entwicklung. Funktionen können sich
            ...
            nicht ausschließlich auf dieses Werkzeug.
        </p>
    {/if}
</main>
