<main>
    ...
    <p>
        ...
        des Verantwortlichen finden Sie weiter unten in dieser Datenschutzerklärung.
    </p>

    <p>
        <strong>Wie erfassen wir Ihre Daten?</strong><br />
        Diese Website erhebt und speichert keine personenbezogenen Daten auf Servern des Betreibers. Es
    ...
    <p>
        Es werden keine Tracking- oder Analyseverfahren eingesetzt. GitHub Pages (Hosting-Anbieter)
    ...
    <h2>2. Hosting</h2>
    <p>
        Diese Website wird bei GitHub Pages gehostet. Der Anbieter ist GitHub, Inc., 88 Colin P.
    ...
    <p>
        iotatools.dev - Thoralf Müller<br />
        c/o Online-Impressum.de #5383<br />
        Europaring 90<br />
        53757 Sankt Augustin<br />
        Deutschland<br />
        E-Mail: info@iotatools.dev
    </p>
    ...
    <p>
        ...
        Rechtsgrundlagen wird in den folgenden Abschnitten dieser Datenschutzerklärung informiert.
    </p>
    ...
    <p>
        Für diese Website ist die zuständige Aufsichtsbehörde: Medienanstalt Mecklenburg-Vorpommern,
        Sitz: Deutschland.
    </p>
    ...
    <h3>Cookies</h3>
    <p>
        Diese Website setzt keine Cookies und verwendet keine Tracking- oder Analyse-Tools wie
        Google Analytics.
    </p>

    <h3>Lokale Speicherung (Local Storage)</h3>
    <p>
        Einige Funktionen speichern Daten ausschließlich lokal in Ihrem Browser (Local Storage), z.
    ...
    <p>
        ...
        Der Websitebetreiber nutzt diese Logdaten nicht zu Analyse- oder Trackingzwecken.
    </p>

    <h3>API-Anfragen an Drittanbieter (Blockchain)</h3>
    <p>
        Einige Tools der Website senden auf Ihre ausdrückliche Aktion hin Anfragen an externe
    ...
    <p>
        Diese Website verwendet keine externen Plugins oder Analysetools wie Google Analytics oder
        ähnliche Dienste.
    </p>
</main>
