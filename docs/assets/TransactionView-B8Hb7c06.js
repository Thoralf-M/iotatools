import { B as delegate, p as push, N as prop, E as state, F as proxy, Z as user_effect, n as set, g as get, a3 as user_derived, K as comment, J as first_child, b as if_block, k as append, l as pop, f as from_html, c as child, s as sibling, H as each, d as set_attribute, I as index, t as template_effect, Y as set_class, e as set_text, L as text, w as getSelectedNetworkConfig, y as fromBase64, ab as bcs, ac as bind_checked, h as event, ay as to_array, P as legacy_pre_effect, m as mutable_source, Q as deep_read_state, R as legacy_pre_effect_reset, i as init, S as untrack, X as set_style, ad as derived_safe_equal, b7 as Signer, A as toBase64, b8 as PasskeyPublicKey, b9 as Secp256r1PublicKey, ba as Secp256k1PublicKey, at as Ed25519PublicKey, az as parseSerializedSignature, bb as PublicKey, z as iotaBcs, bc as SIGNATURE_FLAG_TO_SCHEME, bd as SIGNATURE_SCHEME_TO_FLAG, G as normalizeIotaAddress, b2 as bytesToHex, be as blake2b, bf as bytesEqual, o as getClient } from "./index-CuIM6A1L.js";
import { f as formatJsonWithCompactArrays, r as removeKindFields, i as isTransactionData, g as getTransactionData, R as Root } from "./transaction-view-C6ornlT_.js";
import { g as getObjectLink, a as getTransactionLink, b as getAddressLink } from "./explorer-links-Bx4a9wSX.js";
import { I as IotaGraphQLClient } from "./client-CCqJYyp4.js";
import { a as formatNumberWithUnderscores, n as nanoToIota } from "./iota-nano-conversion-D8I6hx8e.js";
...
var root_8$2 = from_html(`<div class="error-item svelte-19ydf4y"> </div>`);
var root_7$2 = from_html(`<div class="error-banner svelte-19ydf4y"><strong>Package fetch errors:</strong> <!></div>`);
...
var root_16$1 = from_html(`<span> </span>`);
var root_21$2 = from_html(`<a target="_blank" rel="noopener noreferrer"> </a>`);
var root_23$2 = from_html(`<a target="_blank" rel="noopener noreferrer"> </a>`);
var root_24$2 = from_html(`<span> </span>`);
var root_17$2 = from_html(`<span></span>`);
...
var root_25$1 = from_html(`<div class="no-data svelte-19ydf4y">No PTB commands found</div>`);
...
var root_7$1 = from_html(`<div class="fee-main"><span class="field-label svelte-1n6aswm">Fee:</span> <span class="gas-fee svelte-1n6aswm"> </span> <span class="field-label svelte-1n6aswm">Storage cost:</span> <span class="field-value svelte-1n6aswm"> </span> <span class="field-label svelte-1n6aswm">Rebate:</span> <span class="field-value svelte-1n6aswm"> </span></div>`);
var root_10 = from_html(`<a target="_blank" rel="noopener noreferrer" class="full-address link-style svelte-1n6aswm"> </a>`);
var root_11$1 = from_html(`<div class="full-address svelte-1n6aswm">N/A</div>`);
...
var root_8$1 = from_html(`<div class="section svelte-1n6aswm"><h4 class="svelte-1n6aswm"> </h4> <div class="balance-columns svelte-1n6aswm"><div class="negative-changes svelte-1n6aswm"><h5 class="column-header deleted svelte-1n6aswm"> </h5> <div class="balance-content svelte-1n6aswm"></div></div> <div class="positive-changes svelte-1n6aswm"><h5 class="column-header created svelte-1n6aswm"> </h5> <div class="balance-content svelte-1n6aswm"></div></div></div></div>`);
var root_17$1 = from_html(`<a target="_blank" rel="noopener noreferrer" class="object-id link-style svelte-1n6aswm"> </a>`);
var root_19$1 = from_html(`<a target="_blank" rel="noopener noreferrer" class="object-id link-style svelte-1n6aswm"> </a>`);
var root_20 = from_html(`<div class="object-type svelte-1n6aswm"> </div>`);
var root_21$1 = from_html(`<div class="object-version svelte-1n6aswm"> </div>`);
var root_22 = from_html(`<div class="object-sender svelte-1n6aswm"> </div>`);
var root_23$1 = from_html(`<details class="state-collapsible svelte-1n6aswm" open><summary class="state-summary svelte-1n6aswm">Previous State:</summary> <div class="object-json svelte-1n6aswm"><pre class="svelte-1n6aswm"> </pre></div></details>`);
var root_16 = from_html(`<div class="object-box deleted svelte-1n6aswm"><!> <!> <!> <!> <!></div>`);
...
var root_25 = from_html(`<a target="_blank" rel="noopener noreferrer" class="object-id link-style svelte-1n6aswm"> </a> <!> <details class="state-collapsible svelte-1n6aswm" open><summary class="state-summary svelte-1n6aswm">Current State:</summary> <div class="object-json svelte-1n6aswm"><pre class="svelte-1n6aswm"> </pre></div></details>`, 1);
  ...
  var node = first_child(fragment);
  {
    ...
    var alternate_1 = ($$anchor2) => {
      ...
      each(div_1, 21, () => get(parsedSignatures), index, ($$anchor3, sig, index2) => {
        ...
        button.__click = async () => await copyToClipboard(get(sig).publicKey.toBase64());
        var div_7 = sibling(div_5, 2);
        var div_8 = sibling(child(div_7), 2);
        var span_4 = child(div_8);
        var text_2 = child(span_4);
        var button_1 = sibling(span_4, 2);
        button_1.__click = async () => await copyToClipboard(get(sig).publicKey.toIotaPublicKey());
        var div_9 = sibling(div_7, 2);
        var div_10 = sibling(child(div_9), 2);
        var span_5 = child(div_10);
        var text_3 = child(span_5);
        var button_2 = sibling(span_5, 2);
        button_2.__click = async () => await copyToClipboard(get(sig).publicKey.toIotaAddress());
        var div_11 = sibling(div_9, 2);
        var div_12 = sibling(child(div_11), 2);
        var span_6 = child(div_12);
        var text_4 = child(span_6);
        var button_3 = sibling(span_6, 2);
        button_3.__click = async () => await copyToClipboard(bufferExports.Buffer.from(get(sig).signature).toString("base64"));
        var div_13 = sibling(div_11, 2);
        var div_14 = sibling(child(div_13), 2);
        var span_7 = child(div_14);
        var text_5 = child(span_7);
        var button_4 = sibling(span_7, 2);
        button_4.__click = async () => await copyToClipboard(get(sig).rawSignature);
        template_effect(
          ($0, $1, $2, $3) => {
            set_text(text2, `Signature #${index2 + 1} (${get(sig).signatureScheme ?? ""})`);
            set_text(text_1, $0);
            set_text(text_2, $1);
            set_text(text_3, $2);
            set_text(text_4, $3);
...
var root_4 = from_html(`<button>Signatures</button>`);
var root_5 = from_html(`<button>Tx Bytes</button>`);
var root_6 = from_html(`<button class="svelte-1787xw1"> </button>`);
var root_7 = from_html(`<div class="error-message svelte-1787xw1"> <button class="svelte-1787xw1">×</button></div>`);
...
var root_11 = from_html(`<div class="tx-bytes-section svelte-1787xw1"><div class="tx-bytes-header svelte-1787xw1"><strong>Transaction Bytes</strong> <button class="copy-btn svelte-1787xw1">Copy</button></div> <pre class="wrap-bytes svelte-1787xw1"> </pre></div>`);
var root_14 = from_html(`<span class="signature-label svelte-1787xw1"></span>`);
var root_13 = from_html(`<div class="signature-item svelte-1787xw1"><!> <pre class="wrap-bytes svelte-1787xw1"> </pre></div>`);
var root_12 = from_html(`<div class="tx-bytes-section svelte-1787xw1"><div class="tx-bytes-header svelte-1787xw1"><strong> </strong> <button class="copy-btn svelte-1787xw1">Copy All</button></div> <!></div>`);
var root_15 = from_html(`<div class="tx-bytes-section svelte-1787xw1"><div class="tx-bytes-header svelte-1787xw1"><strong>Signed Transaction (SenderSignedData)</strong> <button class="copy-btn svelte-1787xw1">Copy</button></div> <pre class="wrap-bytes svelte-1787xw1"> </pre></div>`);
var root_8 = from_html(`<div class="tx-bytes-view svelte-1787xw1"><!> <!> <!></div>`);
var root_17 = from_html(`<div class="signatures-view"><!></div>`);
var root_19 = from_html(`<div class="formatted-view svelte-1787xw1"><!></div>`);
var root_21 = from_html(`<div class="tree-view svelte-1787xw1"><!></div>`);
var root_23 = from_html(`<div class="commands-view-container svelte-1787xw1"><!></div>`);
var root_24 = from_html(`<div class="json-view svelte-1787xw1"><pre class="svelte-1787xw1"> </pre></div>`);
...
function TransactionView($$anchor, $$props) {
  ...
  let hasTxBytes = user_derived(() => value() && (typeof value() === "string" || typeof value() === "object" && ("transactionBytes" in value() && value().transactionBytes || "rawTransaction" in value() && value().rawTransaction || "bytes" in value() && value().bytes || isTransactionData(value()))));
  ...
  var node = first_child(fragment);
  {
    var consequent_16 = ($$anchor2) => {
      ...
      var node_3 = sibling(button_3, 2);
      {
        ...
        if_block(node_3, ($$render) => {
          if (get(hasSignatures)) $$render(consequent_2);
        });
      }
      ...
      var node_5 = sibling(node_4, 2);
      {
        ...
        if_block(node_5, ($$render) => {
          if (get(hasTxBytes)) $$render(consequent_4);
        });
      }
      var button_7 = sibling(node_5, 2);
      ...
      var node_6 = sibling(div_2, 2);
      {
        ...
        if_block(node_6, ($$render) => {
          if (get(dryRunError)) $$render(consequent_5);
        });
      }
      var node_7 = sibling(node_6, 2);
      {
        var consequent_11 = ($$anchor3) => {
          ...
          var node_8 = child(div_4);
          {
            ...
            var alternate = ($$anchor4) => {
              ...
              var node_9 = first_child(fragment_1);
              {
                ...
                if_block(
                  node_9,
                  ($$render) => {
                    if (get(txBytes) && !get(signedTxBytes)) $$render(consequent_7);
                  },
                  true
                );
              }
            ...
            if_block(node_8, ($$render) => {
              if (get(unsignedTxBytes)) $$render(consequent_6);
              else $$render(alternate, false);
            });
          }
          var node_10 = sibling(node_8, 2);
          {
            var consequent_9 = ($$anchor4) => {
              ...
              each(node_11, 17, () => get(transactionData).signatures, index, ($$anchor5, sig, i) => {
                var div_11 = root_13();
                var node_12 = child(div_11);
                {
                  ...
                  if_block(node_12, ($$render) => {
                    if (get(transactionData).signatures.length > 1) $$render(consequent_8);
                  });
                }
                var pre_2 = sibling(node_12, 2);
            ...
            if_block(node_10, ($$render) => {
              if (get(transactionData)?.signatures && Array.isArray(get(transactionData).signatures) && get(transactionData).signatures.length > 0) $$render(consequent_9);
            });
          }
          var node_13 = sibling(node_10, 2);
          {
            ...
            if_block(node_13, ($$render) => {
              if (get(signedTxBytes)) $$render(consequent_10);
            });
          }
        ...
        var alternate_5 = ($$anchor3) => {
          ...
          var node_14 = first_child(fragment_2);
          {
            ...
            var alternate_4 = ($$anchor4) => {
              ...
              var node_16 = first_child(fragment_3);
              {
                ...
                var alternate_3 = ($$anchor5) => {
                  ...
                  var node_18 = first_child(fragment_4);
                  {
                    ...
                    var alternate_2 = ($$anchor6) => {
                      ...
                      var node_20 = first_child(fragment_5);
                      {
                        ...
                        var alternate_1 = ($$anchor7) => {
                          ...
                          template_effect(($0) => set_text(text_8, $0), [() => formatJsonWithCompactArrays(value())]);
                          append($$anchor7, div_18);
                        };
                        if_block(
                          node_20,
                          ($$render) => {
                            if (get(viewMode) === "commands") $$render(consequent_15);
                            else $$render(alternate_1, false);
                          },
                          true
                        );
                    ...
                    if_block(
                      node_18,
                      ($$render) => {
                        if (get(viewMode) === "tree") $$render(consequent_14);
                        else $$render(alternate_2, false);
                      },
                      true
                    );
                ...
                if_block(
                  node_16,
                  ($$render) => {
                    if (get(viewMode) === "formatted" && isTransactionData(value())) $$render(consequent_13);
                    else $$render(alternate_3, false);
                  },
                  true
                );
            ...
            if_block(
              node_14,
              ($$render) => {
                if (get(viewMode) === "signatures" && get(hasSignatures)) $$render(consequent_12);
                else $$render(alternate_4, false);
              },
              true
            );
        ...
        if_block(node_7, ($$render) => {
          if (get(viewMode) === "txbytes" && get(hasTxBytes)) $$render(consequent_11);
          else $$render(alternate_5, false);
        });
      }
      template_effect(
    ...
    if_block(node, ($$render) => {
      if (!get(hidden)) $$render(consequent_16);
    });
  }
  append($$anchor, fragment);
  pop();
