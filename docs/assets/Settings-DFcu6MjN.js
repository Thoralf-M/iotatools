import { p as push, r as prop, m as mutable_source, aG as get, j as set, i as init, f as from_html, c as child, s as sibling, b as if_block, V as store_get, t as template_effect, K as set_class, d as set_text, E as bind_value, g as get$1, k as append, l as pop, U as setup_stores, Y as delegate, aR as clientConfigErrorMsg, aS as defaultClientConfig, ap as sharedClientConfig, S as state, aT as updateSelectedSignerAccounts, aU as privateKeysErrorMsg, aV as defaultPrivateKeyAccounts, aW as sharedPrivateKeyAccounts, aX as keypairFromBech32PrivateKey } from "/iota-utils/index-BnYhK8oQ.js";
var root_1 = from_html(`<div style="color: red;"> </div>`);
var on_click$1 = (_, store, defaultValue) => store().set(defaultValue());
...
function JsonStoreEditor($$anchor, $$props) {
  ...
  textarea.__change = [
    function(...$$args) {
      var _a;
      (_a = onChangeFn()) == null ? void 0 : _a.apply(this, $$args);
    }
  ];
  let classes;
  ...
  button.__click = [on_click$1, store, defaultValue];
...
var on_click = (_, newBech32PrivateKey, error) => {
...
function Settings($$anchor, $$props) {
  ...
  button.__click = [on_click, newBech32PrivateKey, error];
