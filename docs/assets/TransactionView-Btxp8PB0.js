import { B as delegate, p as push, N as prop, E as state, F as proxy, Z as user_effect, l as set, g as get, K as comment, J as first_child, b as if_block, h as append, j as pop, a3 as user_derived, s as sibling, H as each, c as set_attribute, I as index, t as template_effect, Y as set_class, d as set_text, k as child, L as text, w as getSelectedNetworkConfig, n as from_html, y as fromBase64, ab as bcs, ac as bind_checked, e as event, ay as to_array, P as legacy_pre_effect, Q as deep_read_state, R as legacy_pre_effect_reset, i as init, m as mutable_source, S as untrack, X as set_style, af as derived_safe_equal, b7 as Signer, A as toBase64, b8 as PasskeyPublicKey, b9 as Secp256r1PublicKey, ba as Secp256k1PublicKey, at as Ed25519PublicKey, az as parseSerializedSignature, bb as PublicKey, z as iotaBcs, bc as SIGNATURE_FLAG_TO_SCHEME, bd as SIGNATURE_SCHEME_TO_FLAG, G as normalizeIotaAddress, b2 as bytesToHex, be as blake2b, bf as bytesEqual, o as getClient } from "./index-CDp1uGc2.js";
import { f as formatJsonWithCompactArrays, r as removeKindFields, i as isTransactionData, g as getTransactionData, R as Root } from "./transaction-view-Dk3UbdgS.js";
import { g as getObjectLink, a as getTransactionLink, b as getAddressLink } from "./explorer-links-Bx4a9wSX.js";
import { I as IotaGraphQLClient } from "./client-Cz4Csz9Y.js";
import { a as formatNumberWithUnderscores, n as nanoToIota } from "./iota-nano-conversion-ChrZDrC2.js";
...
var root_13$1 = from_html(`<a target="_blank" rel="noopener noreferrer"> </a>`);
var root_15$1 = from_html(`<a target="_blank" rel="noopener noreferrer"> </a>`);
...
var root_24$1 = from_html(`<span> </span>`);
var root_17$2 = from_html(`<span></span>`);
var root_9$1 = from_html(`<div><a class="command-index svelte-19ydf4y"></a> <button class="expand-btn svelte-19ydf4y"> </button> <div class="command-content svelte-19ydf4y"><span class="command-call"></span> <!></div></div>`);
...
var root_9 = from_html(`<div class="balance-box negative svelte-1n6aswm"><!> <div class="amount-value svelte-1n6aswm"> </div></div>`);
var root_13 = from_html(`<a target="_blank" rel="noopener noreferrer" class="full-address link-style svelte-1n6aswm"> </a>`);
...
var root_8 = from_html(`<div class="tx-bytes-view svelte-1787xw1"><button class="copy-btn svelte-1787xw1">Copy Bytes</button> <pre class="wrap-bytes svelte-1787xw1"> </pre></div>`);
var root_10 = from_html(`<div class="signatures-view"><!></div>`);
var root_12 = from_html(`<div class="formatted-view svelte-1787xw1"><!></div>`);
var root_14 = from_html(`<div class="tree-view svelte-1787xw1"><!></div>`);
var root_16 = from_html(`<div class="commands-view-container svelte-1787xw1"><!></div>`);
var root_17 = from_html(`<div class="json-view svelte-1787xw1"><pre class="svelte-1787xw1"> </pre></div>`);
...
function TransactionView($$anchor, $$props) {
  ...
  let hasTxBytes = user_derived(() => value() && typeof value() === "object" && ("transactionBytes" in value() && value().transactionBytes || "bytes" in value() && value().bytes));
  let txBytes = user_derived(() => value().transactionBytes || value().bytes);
  ...
  var node = first_child(fragment);
  {
    var consequent_11 = ($$anchor2) => {
      ...
      var node_7 = sibling(node_6, 2);
      {
        var consequent_6 = ($$anchor3) => {
          ...
          button_9.__click = () => navigator.clipboard.writeText(get(txBytes));
          var pre = sibling(button_9, 2);
          var text_3 = child(pre);
          template_effect(() => set_text(text_3, get(txBytes)));
        ...
        var alternate_4 = ($$anchor3) => {
          ...
          var node_8 = first_child(fragment_1);
          {
            ...
            var alternate_3 = ($$anchor4) => {
              ...
              var node_10 = first_child(fragment_2);
              {
                ...
                var alternate_2 = ($$anchor5) => {
                  ...
                  var node_12 = first_child(fragment_3);
                  {
                    ...
                    var alternate_1 = ($$anchor6) => {
                      ...
                      var node_14 = first_child(fragment_4);
                      {
                        ...
                        if_block(
                          node_14,
                          ($$render) => {
                            if (get(viewMode) === "commands") $$render(consequent_10);
                            else $$render(alternate, false);
                          },
                          true
                        );
                    ...
                    if_block(
                      node_12,
                      ($$render) => {
                        if (get(viewMode) === "tree") $$render(consequent_9);
                        else $$render(alternate_1, false);
                      },
                      true
                    );
                ...
                if_block(
                  node_10,
                  ($$render) => {
                    if (get(viewMode) === "formatted" && isTransactionData(value())) $$render(consequent_8);
                    else $$render(alternate_2, false);
                  },
                  true
                );
            ...
            if_block(
              node_8,
              ($$render) => {
                if (get(viewMode) === "signatures" && get(hasSignatures)) $$render(consequent_7);
                else $$render(alternate_3, false);
              },
              true
            );
        ...
        if_block(node_7, ($$render) => {
          if (get(viewMode) === "txbytes" && get(hasTxBytes)) $$render(consequent_6);
          else $$render(alternate_4, false);
        });
      }
      template_effect(
    ...
    if_block(node, ($$render) => {
      if (!get(hidden)) $$render(consequent_11);
    });
  }
  append($$anchor, fragment);
  pop();
