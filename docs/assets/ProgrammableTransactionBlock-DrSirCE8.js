import { p as push, F as proxy, q as onMount, E as state, f as from_html, c as child, s as sibling, H as each, g as get, n as set, t as template_effect, Y as set_class, aJ as clsx, e as set_text, h as event, k as append, I as index, d as set_attribute, x as bind_value, l as pop, v as setup_stores, o as getClient, r as store_get, ae as getSelectedChain, af as Transaction$1, ab as activeAddress, ag as iota_wallets, B as delegate } from "./index-DX1peBGM.js";
import { b as bind_this } from "./this-CrS-dLXM.js";
import { p as process } from "./browser-CB3Xs3d3.js";
import { T as TransactionView } from "./TransactionView-Dx8yDNJw.js";
import "./transaction-view-B7rUiYc7.js";
import "./explorer-links-Bx4a9wSX.js";
import "./client-D9Wr2js1.js";
import "./iota-nano-conversion-DZ7CpNrb.js";
...
var root_1 = from_html(`<div><button class="svelte-hlojhh"> </button></div>`);
var root = from_html(`<main><div><div class="codeSnippet-selection" style="float: left; padding-right: 1em;"><div style="float: left; display:flexbox"><button class="svelte-hlojhh">new</button> <button class="svelte-hlojhh">rename</button> <button class="svelte-hlojhh">delete</button></div> <br/> Name: <input placeholder="string" size="15"/> <div style="border: 1px solid #dee2e6; "></div></div> <div><div class="codemirror-wrapper svelte-hlojhh"></div></div> <div><div class="codemirror-wrapper svelte-hlojhh"></div></div></div> <button class="svelte-hlojhh">dev inspect</button> <button class="svelte-hlojhh">dry run</button> <button class="svelte-hlojhh">execute</button> <!></main>`);
