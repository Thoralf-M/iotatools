import { p as push, r as onMount, u as store_get, g as get, m as mutable_source, q as mutate, i as init, f as from_html, s as sibling, c as child, n as set, b as if_block, t as template_effect, e as set_text, k as append, l as pop, v as setup_stores, w as getSelectedNetworkConfig, x as bind_value, o as getClient, y as fromBase64, z as iotaBcs, T as TransactionDataBuilder, A as toBase64, B as delegate } from "/iota-utils/assets/index-vY-WO24d.js";
...
import { g as getTransactionData } from "/iota-utils/assets/transaction-view-ug2gjdCS.js";
import "/iota-utils/assets/iota-nano-conversion-b3Q1k4mO.js";
var root_1 = from_html(`<div class="filter-section svelte-od7va"><div class="filter-row svelte-od7va"><div class="filter-group svelte-od7va"><label for="input-object-filter" class="svelte-od7va">Input Object:</label> <input id="input-object-filter" type="text" placeholder="0x... object ID" class="svelte-od7va"/></div> <div class="filter-group svelte-od7va"><label for="function-filter" class="svelte-od7va">Function (package, package::module, or package::module::function):</label> <input id="function-filter" type="text" placeholder="package::module::function" class="svelte-od7va"/></div></div></div>`);
var root_2 = from_html(`<div class="error-message svelte-od7va"><strong>Error:</strong> </div>`);
var root_4 = from_html(`<div class="loading-message svelte-od7va"><div class="spinner svelte-od7va"></div> <span>Loading transaction...</span></div>`);
var root_3 = from_html(`<div class="transaction-result svelte-od7va"><!> <!></div>`);
var root = from_html(`<div class="transaction-page svelte-od7va"><h2 class="svelte-od7va">Transaction Viewer</h2> <div class="input-section svelte-od7va"><label for="tx-input" class="svelte-od7va">Tx digest (base58), Tx bytes (base64), or JSON: <textarea id="tx-input" placeholder="Enter transaction bytes (base64), transaction digest (base58), or JSON..." rows="6" class="svelte-od7va"></textarea></label> <div class="button-group svelte-od7va"><button class="svelte-od7va"> </button> <button class="svelte-od7va"> </button> <button class="svelte-od7va"> </button> <button class="svelte-od7va">Filter options</button> <div class="divider svelte-od7va"></div> <span class="examples-label svelte-od7va">Examples:</span> <button class="example-btn svelte-od7va">Example Tx (base64)</button> <button class="example-btn svelte-od7va">Example Signed Tx (base64)</button></div> <!></div> <!> <!></div>`);
