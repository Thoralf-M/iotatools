...
function determineSignatureRole(signerAddress, senderAddress, gasSponsorAddress, signatureIndex, totalSignatures) {
    ...
    try {
      ...
      try {
        ...
        if (parsedData && parsedData.txSignatures && parsedData.txSignatures.length > 0) {
          set(signatureResult, parsedData.txSignatures.join(SIGNATURE_SEPARATOR2));
