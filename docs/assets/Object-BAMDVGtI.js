import { C as render_effect, D as teardown, p as push, E as state, F as proxy, r as onMount, u as store_get, n as set, f as from_html, s as sibling, c as child, G as normalizeIotaAddress, b as if_block, g as get, k as append, l as pop, v as setup_stores, t as template_effect, e as set_text, w as getSelectedNetworkConfig, H as each, I as index, d as set_attribute, J as first_child, j as bind_select_value, K as comment, L as text, B as delegate } from "./index-XL7x2wrT.js";
import { b as bind_this } from "./this-8kcnrVQa.js";
import { I as IotaGraphQLClient } from "./client-CPDFbaX6.js";
import { q as queryDynamicFields } from "./dynamic-fields-utils-Cf-sO_Rm.js";
import { g as getObjectLink, a as getTransactionLink, b as getAddressLink } from "./explorer-links-Bx4a9wSX.js";
import { u as usePageQueryParams, a as updatePageQueryParams } from "./page-query-params-B9VRWLkY.js";
...
var root = from_html(`<div class="object-page svelte-1wgd05d"><h3 class="svelte-1wgd05d">Object Viewer</h3> <div class="input-section svelte-1wgd05d"><div class="input-header svelte-1wgd05d"><label for="object-input" class="svelte-1wgd05d">Object ID (hex), Object Type, or Package ID:</label> <div class="examples-section svelte-1wgd05d"><span class="svelte-1wgd05d">Examples:</span> <div class="button-group svelte-1wgd05d"><button class="svelte-1wgd05d">IOTA Framework</button> <button class="svelte-1wgd05d">System Package</button> <button class="svelte-1wgd05d">Clock Object</button> <button class="svelte-1wgd05d">IOTA-Names testnet</button> <button class="svelte-1wgd05d">IOTA-Names mainnet</button></div></div></div> <input type="text" id="object-input" placeholder="Enter object ID (0x...), type (0x2::coin::Coin), or package ID (0x...)" class="svelte-1wgd05d"/></div> <!> <!> <!> <!> <!></div>`);
