import { p as push, F as legacy_pre_effect, g as get, m as mutable_source, Y as isValidIotaAddress, n as set, H as legacy_pre_effect_reset, i as init, f as from_html, s as sibling, c as child, b as if_block, J as untrack, t as template_effect, e as set_text, X as set_value, h as event, x as bind_value, k as append, l as pop, v as setup_stores, o as getClient, Q as comment, O as first_child, G as deep_read_state, R as set_style, u as store_get, ae as Transaction, aL as IOTA_SYSTEM_STATE_OBJECT_ID, a6 as bcs, a8 as activeAddress, I as each, K as index } from "/iota-utils/assets/index-DnAm28wB.js";
import { T as TransactionView } from "/iota-utils/assets/TransactionView-CjgdhLhj.js";
import { a as formatNumberWithUnderscores, f as formatNumbersWithUnderscores } from "/iota-utils/assets/iota-nano-conversion-bLekXApH.js";
import { c as computeStakingRewards } from "/iota-utils/assets/staking-utils-Ch0LgUsa.js";
import { e as executeTransaction } from "/iota-utils/assets/transaction-execution-dlFMiQ96.js";
...
var root_5 = from_html(`<button class="svelte-js78w8">Load Validators</button>`);
var root_9 = from_html(`<div class="validator-item svelte-js78w8" style="margin: 0.125rem 0; border: 1px solid grey; border-radius: 4px; cursor: pointer;" role="button" tabindex="0"><div class="validator-content svelte-js78w8"><span class="validator-address svelte-js78w8"> </span> <span class="validator-status svelte-js78w8" style="color: #c62828;"> </span> <span class="validator-name svelte-js78w8"> </span> <span class="validator-stake svelte-js78w8"> </span></div></div>`);
var root_7 = from_html(`<div style="margin-bottom: 1rem;"><div class="section-header svelte-js78w8" style="font-weight: bold; border: 1px solid #ddd; border-radius: 4px; cursor: pointer; display: flex; justify-content: space-between; align-items: center;" role="button" tabindex="0"><span class="svelte-js78w8"> </span> <span class="svelte-js78w8"> </span></div> <!></div>`);
var root_12 = from_html(`<div class="validator-item svelte-js78w8" style="margin: 0.125rem 0; border: 1px solid #ddd; border-radius: 4px; cursor: pointer;" role="button" tabindex="0"><div class="validator-content svelte-js78w8"><span class="validator-address svelte-js78w8"> </span> <span class="validator-status svelte-js78w8"> </span> <span class="validator-name svelte-js78w8"> </span> <span class="validator-stake svelte-js78w8"> </span></div></div>`);
var root_10 = from_html(`<div><div class="section-header svelte-js78w8" style="font-weight: bold; border: 1px solid grey; border-radius: 4px; cursor: pointer; display: flex; justify-content: space-between; align-items: center;" role="button" tabindex="0"><span class="svelte-js78w8"> </span> <span class="svelte-js78w8"> </span></div> <!></div>`);
var root_6 = from_html(`<div><strong>Select a validator:</strong></div> <!> <!>`, 1);
var root_2 = from_html(`<div class="validator-selection svelte-js78w8"><!></div>`);
var root_14 = from_html(`<div class="validator-selection svelte-js78w8"><div><strong>Selected Validator:</strong> <button style="margin-left: 1rem; font-size: 0.8em;" class="svelte-js78w8">Change</button></div> <div class="validator-item svelte-js78w8" style="padding: 0.25rem 0.5rem; border: 1px solid #ddd; border-radius: 4px;"><div class="validator-content svelte-js78w8"><span class="validator-address svelte-js78w8"> </span> <span class="validator-status svelte-js78w8"> </span> <span class="validator-name svelte-js78w8"> </span> <span class="validator-stake svelte-js78w8"> </span></div></div></div>`);
var root = from_html(`<main><button class="svelte-js78w8">list staked IOTA</button> <br/> <span class="svelte-js78w8">staked object id: <input placeholder="staked IOTA object id 0x..." style="width: min(74ch, 100%); max-width: 100%; box-sizing: border-box; font-family: monospace;" class="svelte-js78w8"/></span> <button class="svelte-js78w8">compute real rewards</button> <!> <hr/> It's only possible to stake to a candidate or active/committee validator, pending is not possible. <br/> <span class="svelte-js78w8">validator address: <input placeholder="validator address 0x..." style="width: min(74ch, 100%); max-width: 100%; box-sizing: border-box; font-family: monospace;" class="svelte-js78w8"/> <button class="svelte-js78w8"> </button></span> <!> <br/> <span class="svelte-js78w8">amount (min 1 IOTA, to unstake with rewards even more): <input type="number" placeholder="amount in NANO" min="1000000000" style="width: 14rem;"/> <input type="number" placeholder="amount in IOTA" min="1" style="width: 14rem;"/></span> <br/> <button class="svelte-js78w8">stake</button> <button class="svelte-js78w8">unstake single object</button> <button class="svelte-js78w8">unstake all</button> <button class="svelte-js78w8">simulate unstake specific amount</button> <button class="svelte-js78w8">unstake specific amount (exact is usually not possible)</button> <hr/> <button class="svelte-js78w8">list timelocked objects</button> <button class="svelte-js78w8">stake all timelocked objects</button> <!></main>`);
