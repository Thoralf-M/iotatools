import { o as getClient, p as push, E as state, F as proxy, f as from_html, c as child, s as sibling, b as if_block, g as get, n as set, H as each, t as template_effect, d as set_attribute, e as set_text, k as append, X as set_class, h as event, a2 as user_derived, x as bind_value, j as bind_select_value, l as pop, v as setup_stores, r as store_get, ah as TransactionExecution, A as toBase64, ai as getActiveWallet, aj as getSelectedChain, _ as isValidIotaAddress, L as text, I as index, K as comment, J as first_child, af as iota_accounts, ak as sharedTransactionExecution, al as Transaction, B as delegate } from "./index-B8jofGkn.js";
import { a as action } from "./actions-DAisEJQh.js";
import { T as TransactionView } from "./TransactionView-CCITwhcQ.js";
import { n as nanoToIota } from "./iota-nano-conversion-CM2yWp_2.js";
import { c as calculateGasFee } from "./transaction-execution-D2kzaiM-.js";
import { c as computeStakingRewards } from "./staking-utils-Bd8UMwwg.js";
...
var root_16 = from_html(`<div style="position: absolute; left: 0; top: 0; height: 1.2rem; display: flex; align-items: center; font-size: 0.7rem; color: #f59e0b; pointer-events: none;"> </div>`);
...
var root_17 = from_html(`<div style="text-align: center; color: var(--text-muted); padding: 1rem; font-size: 0.8rem;">No objects</div>`);
var root_19 = from_html(`<div class="object-item svelte-1dnveep" style="border-color: rgba(248, 113, 113, 0.3);"><div class="object-header svelte-1dnveep"><span class="object-type svelte-1dnveep"> </span> <span class="object-amount svelte-1dnveep"><!></span></div> <details class="object-details svelte-1dnveep"><summary class="svelte-1dnveep">Data</summary> <pre class="svelte-1dnveep"> </pre></details></div>`);
var root_18 = from_html(`<div style="margin-top: 0.5rem; border-top: 1px solid var(--border-color); padding-top: 0.5rem;"><div style="font-size: 0.8rem; color: #f87171; margin-bottom: 0.25rem;">Timelocked</div> <!></div>`);
...
function MultiAccountView($$anchor, $$props) {
  ...
  button_2.__click = executeTransfers;
  ...
  var node_2 = sibling(node_1, 2);
  {
    var consequent_3 = ($$anchor2) => {
      ...
      each(node_3, 17, () => get(transactionResults), index, ($$anchor3, result, i) => {
        ...
        var button_3 = root_4();
        button_3.__click = () => set(currentResultIndex, i, true);
  ...
  button_4.__click = () => fetchCurrentPrice().then((price) => set(currentPrice, price, true));
  ...
  each(div_13, 21, () => get(extendedAccounts), (account) => account.id, ($$anchor2, account) => {
    ...
    button_5.__click = () => navigator.clipboard.writeText(get(account).address);
    var div_18 = sibling(div_17, 2);
    var button_6 = child(div_18);
    button_6.__click = () => toggleCollapse(get(account).id);
    var text_16 = child(button_6);
    var div_19 = sibling(div_16, 2);
    var button_7 = child(div_19);
    button_7.__click = () => removeAccount(get(account).address);
      ...
      var consequent_13 = ($$anchor3) => {
        ...
        each(node_7, 17, () => get(account).objects, (item) => item.id, ($$anchor4, item) => {
          ...
          var node_8 = child(span_2);
          {
            ...
            if_block(node_8, ($$render) => {
              if (get(item).label.startsWith("Coin<0x2::iota::IOTA>")) $$render(consequent_4);
          ...
          var node_9 = child(span_3);
          {
            var consequent_5 = ($$anchor5) => {
              var text_20 = text();
              template_effect(($0) => set_text(text_20, $0), [() => nanoToIota(get(item).data?.content.fields?.balance)]);
            ...
            var alternate_2 = ($$anchor5) => {
              ...
              var node_10 = first_child(fragment_3);
              {
                ...
                if_block(
                  node_10,
                  ($$render) => {
                    if (get(item).label == "StakedIota") $$render(consequent_6);
            ...
            if_block(node_9, ($$render) => {
              if (get(item).label.startsWith("Coin<0x2::iota::IOTA>")) $$render(consequent_5);
        ...
        var node_14 = sibling(node_13, 2);
        {
          var consequent_12 = ($$anchor4) => {
            var div_27 = root_18();
            var node_15 = sibling(child(div_27), 2);
            each(node_15, 17, () => get(account).timelockedObjects, (item) => item.id, ($$anchor5, item) => {
              var div_28 = root_19();
                ...
                var alternate_3 = ($$anchor6) => {
                  ...
                  var node_17 = first_child(fragment_8);
                  {
                    var consequent_11 = ($$anchor7) => {
                      var text_27 = text();
                      template_effect(($0) => set_text(text_27, $0), [() => nanoToIota(get(item).data?.content.fields?.balance)]);
                      append($$anchor7, text_27);
                    };
                    if_block(
                      node_17,
                      ($$render) => {
                        if (get(item).label.startsWith("Coin<0x2::iota::IOTA>")) $$render(consequent_11);
                      },
                      true
                    );
                  }
