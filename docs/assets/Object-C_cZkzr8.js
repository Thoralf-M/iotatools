import { F as render_effect, G as teardown, I as IotaGraphQLClient, p as push, H as state, J as proxy, q as onMount, r as store_get, n as set, a as from_html, s as sibling, c as child, b as if_block, g as get, v as delegated, K as normalizeIotaAddress, k as append, l as pop, w as setup_stores, t as template_effect, e as set_text, L as each, M as getObjectLink, x as getSelectedNetworkConfig, N as user_derived, O as index, P as getTransactionLink, d as set_attribute, Q as first_child, j as bind_select_value, R as comment, S as getAddressLink, U as text, E as delegate } from "./index-BCoJFR-s.js";
import { b as bind_this } from "./this-C2HCA3N4.js";
import { q as queryDynamicFields } from "./dynamic-fields-ClIS95_I.js";
import { u as usePageQueryParams, a as updatePageQueryParams } from "./page-query-params-AwWuR-tg.js";
import { g as getIotaNamesPackageId } from "./iota-names-config-3rzGyM5E.js";
...
var root_14 = from_html(`<div class="detail-row svelte-h7f06r"><strong class="svelte-h7f06r">Last tx:</strong> <span class="svelte-h7f06r"><a target="_blank" class="address-link svelte-h7f06r"> </a></span></div>`);
var root_15 = from_html(`<li class="svelte-h7f06r"> </li>`);
...
var root_18 = from_html(`<a target="_blank" class="address-link svelte-h7f06r"> </a>`);
var root_17 = from_html(`<div class="detail-row svelte-h7f06r"><strong class="svelte-h7f06r">Owner:</strong> <span class="svelte-h7f06r"><!></span></div>`);
var root_21 = from_html(`<div class="detail-row svelte-h7f06r"><strong class="svelte-h7f06r">Last tx:</strong> <span class="svelte-h7f06r"><a target="_blank" class="address-link svelte-h7f06r"> </a></span></div>`);
var root_23 = from_html(`<div class="detail-row svelte-h7f06r"><strong class="svelte-h7f06r">Type:</strong> <code class="svelte-h7f06r"> </code></div>`);
var root_24 = from_html(`<details class="dynamic-fields-details svelte-h7f06r"><summary class="dynamic-fields-summary svelte-h7f06r"><strong> </strong></summary> <pre class="json-content svelte-h7f06r"> </pre></details>`);
var root_22 = from_html(`<!> <div class="detail-row svelte-h7f06r"><strong class="svelte-h7f06r">Contents:</strong> <button class="dynamic-fields-btn svelte-h7f06r"> </button></div> <pre class="json-content svelte-h7f06r"> </pre> <!>`, 1);
...
var root_26 = from_html(`<button class="load-more-btn svelte-h7f06r"> </button>`);
var root_29 = from_html(`<a target="_blank" class="address-link svelte-h7f06r"> </a>`);
var root_28 = from_html(`<div class="detail-row svelte-h7f06r"><strong class="svelte-h7f06r">Owner:</strong> <span class="svelte-h7f06r"><!></span></div>`);
var root_32 = from_html(`<div class="detail-row svelte-h7f06r"><strong class="svelte-h7f06r">Last tx:</strong> <span class="svelte-h7f06r"><a target="_blank" class="address-link svelte-h7f06r"> </a></span></div>`);
var root_34 = from_html(`<div class="detail-row svelte-h7f06r"><strong class="svelte-h7f06r">Type:</strong> <code class="svelte-h7f06r"> </code></div>`);
var root_35 = from_html(`<details class="dynamic-fields-details svelte-h7f06r"><summary class="dynamic-fields-summary svelte-h7f06r"><strong> </strong></summary> <pre class="json-content svelte-h7f06r"> </pre></details>`);
var root_33 = from_html(`<!> <div class="detail-row svelte-h7f06r"><strong class="svelte-h7f06r">Contents:</strong> <button class="dynamic-fields-btn svelte-h7f06r"> </button></div> <pre class="json-content svelte-h7f06r"> </pre> <!>`, 1);
var root_27 = from_html(`<div class="object-item svelte-h7f06r"><details class="object-details svelte-h7f06r"><summary class="object-summary svelte-h7f06r"><code class="object-address svelte-h7f06r"> </code> <button class="explorer-btn svelte-h7f06r">Explorer</button></summary> <div class="object-details-content svelte-h7f06r"><!> <!> <!></div></details></div>`);
var root_36 = from_html(`<button class="load-more-btn bottom-load-more svelte-h7f06r"> </button>`);
var root_25 = from_html(`<div class="objects-list svelte-h7f06r"><div class="objects-header svelte-h7f06r"><div class="header-controls svelte-h7f06r"><div class="expand-controls svelte-h7f06r"><button class="svelte-h7f06r">Expand All</button> <button class="svelte-h7f06r">Collapse All</button></div> <!> <div class="page-size-control svelte-h7f06r"><label for="page-size" class="svelte-h7f06r">Page Size:</label> <select id="page-size" class="svelte-h7f06r"><option>1</option><option>5</option><option>10</option><option>20</option><option>50</option></select></div></div> <h3 class="svelte-h7f06r"> </h3></div> <!> <!></div>`);
...
function Object$1($$anchor, $$props) {
  ...
  var node_8 = sibling(node_2, 2);
  {
    var consequent_17 = ($$anchor2) => {
      ...
      var node_9 = child(div_15);
      {
        var consequent_9 = ($$anchor3) => {
            ...
            var consequent_8 = ($$anchor4) => {
              ...
              template_effect(
                ($0) => {
                  ...
                  set_text(text_8, get(objectData).previousTransactionBlock.digest);
                },
                [
          ...
          var div_17 = sibling(node_10, 4);
          var ul = sibling(child(div_17), 2);
          each(ul, 21, () => get(objectData).asMovePackage.modules.nodes, index, ($$anchor4, module) => {
            var li = root_15();
            var text_9 = child(li);
            template_effect(() => set_text(text_9, get(module).name));
            append($$anchor4, li);
          });
        ...
        var alternate_2 = ($$anchor3) => {
          ...
          var node_11 = first_child(fragment_3);
          {
            var consequent_12 = ($$anchor4) => {
              ...
              var node_12 = child(span_2);
              {
                var consequent_10 = ($$anchor5) => {
                  ...
                  template_effect(
                    ($0) => {
                      ...
                      set_text(text_10, get(objectData).owner.owner.address || get(objectData).owner.owner);
                    },
                    [
                ...
                var consequent_11 = ($$anchor5) => {
                  var text_11 = text();
                  template_effect(() => set_text(text_11, `Shared (v${get(objectData).owner.initialSharedVersion ?? ""})`));
                  append($$anchor5, text_11);
                };
                var alternate_1 = ($$anchor5) => {
                  var text_12 = text();
                  template_effect(($0) => set_text(text_12, $0), [() => JSON.stringify(get(objectData).owner)]);
                  append($$anchor5, text_12);
                };
                if_block(node_12, ($$render) => {
                  if (get(objectData).owner.owner) $$render(consequent_10);
                  else if (get(objectData).owner.initialSharedVersion) $$render(consequent_11, 1);
            ...
            if_block(node_11, ($$render) => {
              if (get(objectData).owner) $$render(consequent_12);
            });
          }
          var node_13 = sibling(node_11, 2);
          {
            var consequent_13 = ($$anchor4) => {
              ...
              template_effect(
                ($0) => {
                  ...
                  set_text(text_13, get(objectData).previousTransactionBlock.digest);
                },
                [
                  () => getTransactionLink(getSelectedNetworkConfig(), get(objectData).previousTransactionBlock.digest)
                ]
            ...
            if_block(node_13, ($$render) => {
              if (get(objectData).previousTransactionBlock) $$render(consequent_13);
            });
          }
          var node_14 = sibling(node_13, 2);
          {
            var consequent_16 = ($$anchor4) => {
              ...
              var node_15 = first_child(fragment_6);
              {
                var consequent_14 = ($$anchor5) => {
                  var div_20 = root_23();
                  var code_3 = sibling(child(div_20), 2);
                  var text_14 = child(code_3);
                  template_effect(() => set_text(text_14, get(objectData).asMoveObject.contents.type?.repr || "Unknown"));
                  append($$anchor5, div_20);
                };
                if_block(node_15, ($$render) => {
                  if (get(currentInputType) === "hex") $$render(consequent_14);
                });
              }
              var div_21 = sibling(node_15, 2);
              var button_9 = sibling(child(div_21), 2);
              var text_15 = child(button_9);
              var pre = sibling(div_21, 2);
              var text_16 = child(pre);
              var node_16 = sibling(pre, 2);
              {
                var consequent_15 = ($$anchor5) => {
                  ...
                  var text_18 = child(pre_1);
                  template_effect(
                    ($0, $1, $2) => {
                      details_1.open = $0;
                      set_text(text_17, `Dynamic Fields (${$1 ?? ""})`);
                      set_text(text_18, $2);
                    },
                    [
            ...
            if_block(node_14, ($$render) => {
              if (get(objectData).asMoveObject) $$render(consequent_16);
            });
          }
          append($$anchor3, fragment_3);
        };
        if_block(node_9, ($$render) => {
          if (get(objectData).asMovePackage) $$render(consequent_9);
    ...
    if_block(node_8, ($$render) => {
      if (get(objectData)) $$render(consequent_17);
    });
  }
  var node_17 = sibling(node_8, 2);
  {
    var consequent_27 = ($$anchor2) => {
      ...
      var node_18 = sibling(div_25, 2);
      {
        var consequent_18 = ($$anchor3) => {
          var button_12 = root_26();
          var text_19 = child(button_12);
          template_effect(() => {
            button_12.disabled = get(loadingNext);
            set_text(text_19, get(loadingNext) ? "Loading..." : "Load More");
          });
          delegated("click", button_12, loadNextPage);
          append($$anchor3, button_12);
        };
        if_block(node_18, ($$render) => {
          if (get(hasNext)) $$render(consequent_18);
        });
      }
      var div_26 = sibling(node_18, 2);
      var select = sibling(child(div_26), 2);
      ...
      var h3_1 = sibling(div_24, 2);
      var text_20 = child(h3_1);
      var node_19 = sibling(div_23, 2);
      each(node_19, 17, () => get(objectsList), index, ($$anchor3, obj, i) => {
        var div_27 = root_27();
        var details_2 = child(div_27);
        var summary_2 = child(details_2);
        var code_4 = child(summary_2);
        var text_21 = child(code_4);
        var button_13 = sibling(code_4, 2);
        var div_28 = sibling(summary_2, 2);
        var node_20 = child(div_28);
        {
          var consequent_21 = ($$anchor4) => {
            var div_29 = root_28();
            var span_4 = sibling(child(div_29), 2);
            var node_21 = child(span_4);
            {
              var consequent_19 = ($$anchor5) => {
                var a_3 = root_29();
                var text_22 = child(a_3);
                template_effect(
                  ($0) => {
                    set_attribute(a_3, "href", $0);
                    set_text(text_22, get(obj).owner.owner.address || get(obj).owner.owner);
                  },
                  [
              ...
              var consequent_20 = ($$anchor5) => {
                var text_23 = text();
                template_effect(() => set_text(text_23, `Shared (v${get(obj).owner.initialSharedVersion ?? ""})`));
                append($$anchor5, text_23);
              };
              var alternate_3 = ($$anchor5) => {
                var text_24 = text();
                template_effect(($0) => set_text(text_24, $0), [() => JSON.stringify(get(obj).owner)]);
                append($$anchor5, text_24);
              };
              if_block(node_21, ($$render) => {
                if (get(obj).owner.owner) $$render(consequent_19);
                else if (get(obj).owner.initialSharedVersion) $$render(consequent_20, 1);
          ...
          if_block(node_20, ($$render) => {
            if (get(obj).owner) $$render(consequent_21);
          });
        }
        var node_22 = sibling(node_20, 2);
        {
          var consequent_22 = ($$anchor4) => {
            var div_30 = root_32();
            var span_5 = sibling(child(div_30), 2);
            var a_4 = child(span_5);
            var text_25 = child(a_4);
            template_effect(
              ($0) => {
                set_attribute(a_4, "href", $0);
                set_text(text_25, get(obj).previousTransactionBlock.digest);
              },
              [
          ...
          if_block(node_22, ($$render) => {
            if (get(obj).previousTransactionBlock) $$render(consequent_22);
          });
        }
        var node_23 = sibling(node_22, 2);
        {
          var consequent_25 = ($$anchor4) => {
            ...
            var node_24 = first_child(fragment_9);
            {
              var consequent_23 = ($$anchor5) => {
                var div_31 = root_34();
                var code_5 = sibling(child(div_31), 2);
                var text_26 = child(code_5);
                template_effect(() => set_text(text_26, get(obj).asMoveObject.contents.type?.repr || "Unknown"));
            ...
            var div_32 = sibling(node_24, 2);
            var button_14 = sibling(child(div_32), 2);
            var text_27 = child(button_14);
            var pre_2 = sibling(div_32, 2);
            var text_28 = child(pre_2);
            var node_25 = sibling(pre_2, 2);
            {
              var consequent_24 = ($$anchor5) => {
                var details_3 = root_35();
                var summary_3 = child(details_3);
                var strong_2 = child(summary_3);
                var text_29 = child(strong_2);
                var pre_3 = sibling(summary_3, 2);
                var text_30 = child(pre_3);
                template_effect(
                  ($0, $1, $2) => {
                    details_3.open = $0;
                    set_text(text_29, `Dynamic Fields (${$1 ?? ""})`);
                    set_text(text_30, $2);
                  },
                  [
              ...
              if_block(node_25, ($$render) => {
                if (get(d_3)) $$render(consequent_24);
              });
            }
            template_effect(
              ($0, $1, $2) => {
          ...
          if_block(node_23, ($$render) => {
            if (get(obj).asMoveObject) $$render(consequent_25);
          });
        }
        template_effect(() => set_text(text_21, get(obj).address));
      ...
      var node_26 = sibling(node_19, 2);
      {
        var consequent_26 = ($$anchor3) => {
          var button_15 = root_36();
          var text_31 = child(button_15);
          template_effect(() => {
            button_15.disabled = get(loadingNext);
            set_text(text_31, get(loadingNext) ? "Loading..." : "Load More");
          });
          delegated("click", button_15, loadNextPage);
          append($$anchor3, button_15);
        };
        if_block(node_26, ($$render) => {
          if (get(hasNext)) $$render(consequent_26);
        });
      }
      template_effect(() => set_text(text_20, `Objects (${get(objectsList).length ?? ""})`));
    ...
    if_block(node_17, ($$render) => {
      if (get(objectsList).length > 0) $$render(consequent_27);
    });
  }
