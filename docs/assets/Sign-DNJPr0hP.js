...
import { az as Signer, A as toBase64, aA as PasskeyPublicKey, aB as Secp256r1PublicKey, aC as Secp256k1PublicKey, at as Ed25519PublicKey, aD as parseSerializedSignature, aE as PublicKey, y as fromBase64, z as iotaBcs, aF as SIGNATURE_FLAG_TO_SCHEME, aG as SIGNATURE_SCHEME_TO_FLAG, G as normalizeIotaAddress, aH as bytesToHex, aI as blake2b, aJ as bytesEqual, T as TransactionDataBuilder, p as push, P as legacy_pre_effect, g as get, l as set, R as legacy_pre_effect_reset, i as init, s as sibling, k as child, b as if_block, t as template_effect, _ as set_value, d as set_text, h as append, j as pop, u as store_get, v as setup_stores, m as mutable_source, o as getClient, aK as getActiveWallet, aL as get$1, ad as activeAddress, ah as getSelectedChain, ai as Transaction, r as mutate, H as each, S as untrack, K as comment, J as first_child, I as index, n as from_html, B as delegate } from "./index-Be4Wjvgu.js";
...
var root_8 = from_html(`<span class="role-badge sender svelte-2sgbh3">Sender</span>`);
var root_10 = from_html(`<span class="role-badge sponsor svelte-2sgbh3">Gas Sponsor</span>`);
...
function Sign($$anchor, $$props) {
  ...
  function processTransactionBytes(inputString) {
    try {
      ...
      try {
        ...
        set(value, parsedData);
        if (parsedData && parsedData.txSignatures && parsedData.txSignatures.length > 0) {
          set(signatureResult, parsedData.txSignatures.join("\n"));
          set(signatureTypeLabel, "Transaction Signature (from signed tx)");
      ...
      each(div_11, 5, () => get(signaturePubkeyPairs), index, ($$anchor3, pair, index2) => {
        ...
        var node_7 = sibling(text_2);
        {
          ...
          var alternate = ($$anchor4) => {
            ...
            var node_8 = first_child(fragment);
            {
              ...
              if_block(
                node_8,
                ($$render) => {
                  if (get(pair), untrack(() => get(pair).role === "gas_sponsor")) $$render(consequent_6);
                },
                true
              );
            }
          ...
          if_block(node_7, ($$render) => {
            if (get(pair), untrack(() => get(pair).role === "sender")) $$render(consequent_5);
  ...
  var node_9 = sibling(div_5, 2);
  {
    ...
    if_block(node_9, ($$render) => {
      if (get(submitResult)) $$render(consequent_8);
    });
  }
