import { p as push, f as from_html, s as sibling, c as child, V as state, b as if_block, g as get, a0 as user_derived, t as template_effect, d as set_text, Q as set_style, L as bind_value, j as append, k as pop, N as first_child, l as set, z as delegate } from "/iota-utils/assets/index-Cpg3fODn.js";
...
var root_1 = from_html(`<span class="remaining-text svelte-11n2l2b">...</span>`);
var root_2 = from_html(`<span class="status-missing svelte-11n2l2b"> </span>`);
var root_3 = from_html(`<span class="status-more svelte-11n2l2b"> </span>`);
...
var root_7 = from_html(`<div class="metric-box svelte-11n2l2b"><h3 class="metric-title svelte-11n2l2b">Numbers Found</h3> <div class="metric-content svelte-11n2l2b" style="word-break: break-all;"> </div></div>`);
var root = from_html(`<main class="svelte-11n2l2b"><div class="text-input-container svelte-11n2l2b"><textarea id="textInput" placeholder="Paste your text here for analysis..." class="text-input svelte-11n2l2b"></textarea> <div class="controls svelte-11n2l2b"><label for="limitInput">Show first</label> <input id="limitInput" type="number" min="0" max="10000" class="limit-input svelte-11n2l2b"/> <span>chars:</span> <button class="repeat-button svelte-11n2l2b">Repeat to limit</button> <div class="preview-text svelte-11n2l2b"><span class="highlighted-text svelte-11n2l2b"> </span><!></div> <!> <!></div></div> <div class="metrics-grid svelte-11n2l2b"><div class="metric-box svelte-11n2l2b"><h3 class="metric-title svelte-11n2l2b">Basic Metrics</h3> <div class="metric-content svelte-11n2l2b"><div>Total Characters: <strong> </strong></div> <div>Characters (no spaces): <strong> </strong></div> <div>Lines: <strong> </strong></div> <div>Words: <strong> </strong></div> <div>Paragraphs: <strong> </strong></div> <div>Unique Words: <strong> </strong></div> <div>Reading Time: <strong> </strong></div></div></div> <div class="metric-box svelte-11n2l2b"><h3 class="metric-title svelte-11n2l2b">Character Analysis</h3> <div class="metric-content svelte-11n2l2b"><div>Uppercase: <strong> </strong></div> <div>Lowercase: <strong> </strong></div> <div>Digits: <strong> </strong></div> <div>Whitespace: <strong> </strong></div> <div>Special Characters: <strong> </strong></div> <div>Commas: <strong> </strong></div></div></div> <div class="metric-box svelte-11n2l2b"><h3 class="metric-title svelte-11n2l2b">Numbers & Patterns</h3> <div class="metric-content svelte-11n2l2b"><div>Number Count: <strong> </strong></div> <!></div></div> <div class="metric-box svelte-11n2l2b"><h3 class="metric-title svelte-11n2l2b">Structure Analysis</h3> <div class="metric-content svelte-11n2l2b"><div>Parentheses pairs: <strong> </strong></div> <div>Square brackets pairs: <strong> </strong></div> <div>Curly braces pairs: <strong> </strong></div> <div>Single quote pairs: <strong> </strong></div> <div>Double quote pairs: <strong> </strong></div> <div>Backtick pairs: <strong> </strong></div></div></div> <div class="metric-box svelte-11n2l2b"><h3 class="metric-title svelte-11n2l2b">Averages & Extremes</h3> <div class="metric-content svelte-11n2l2b"><div>Avg words/line: <strong> </strong></div> <div>Avg chars/word: <strong> </strong></div> <!></div></div> <div class="metric-box svelte-11n2l2b"><h3 class="metric-title svelte-11n2l2b">Format Detection</h3> <div class="metric-content svelte-11n2l2b"><div>Valid JSON: <strong> </strong></div> <div>Valid Base64: <strong> </strong></div> <div>Valid Hex: <strong> </strong></div> <div>Valid Bytes: <strong> </strong></div></div></div></div> <!></main>`);
