import { w as getSelectedNetworkConfig, al as Transaction, o as getClient, an as toHex, aU as IOTA_CLOCK_OBJECT_ID, p as push, E as state, F as proxy, q as onMount, Y as user_effect, r as store_get, f as from_html, b as if_block, g as get, c as child, s as sibling, n as set, t as template_effect, e as set_text, x as bind_value, k as append, l as pop, v as setup_stores, aH as sharedClientConfig, H as each, K as comment, J as first_child, I as index, ad as activeAddress, B as delegate } from "./index-glF25VeB.js";
import { I as IotaAmountInput } from "./IotaAmountInput-DR3srOlV.js";
import { T as TransactionView } from "./TransactionView-CI-9frRn.js";
import { c as config, s as setCustomPackageId, g as getIotaNamesPackageId } from "./iota-names-config-wnsUBDvL.js";
...
async function getReverseRegisteredAddresses(onProgress, signal) {
  try {
    ...
    let res = { total: 0, reverseRegistry: [] };
    let cursorSection = "";
    while (true) {
      if (signal?.aborted) {
        throw new Error("Operation cancelled");
...
function IotaNames($$anchor, $$props) {
  ...
  button.__click = handleToggleIotaNamesIds;
  var text_2 = child(button);
  var button_1 = sibling(button, 2);
  button_1.__click = handleGetDynamicFields;
  ...
  button_2.__click = handleGetRegistryEntry;
  var button_3 = sibling(button_2, 2);
  button_3.__click = handleResolveName;
  var button_4 = sibling(button_3, 2);
  button_4.__click = handleResolveAddress;
  var div_18 = sibling(div_16, 2);
  var div_19 = sibling(child(div_18), 2);
  var button_5 = child(div_19);
  button_5.__click = handleRegisterName;
  var button_6 = sibling(button_5, 2);
  button_6.__click = handleSetTargetAddress;
  var button_7 = sibling(button_6, 2);
  button_7.__click = handleSetReverseLookup;
  var div_20 = sibling(div_18, 2);
  var div_21 = sibling(child(div_20), 2);
  var button_8 = child(div_21);
  button_8.__click = handleStartAuctionAndPlaceBid;
  var button_9 = sibling(button_8, 2);
  button_9.__click = handlePlaceBid;
  var button_10 = sibling(button_9, 2);
  button_10.__click = handleClaim;
  var button_11 = sibling(button_10, 2);
  button_11.__click = handleListAuctions;
  ...
  var node_6 = child(div_23);
  {
    var consequent_3 = ($$anchor2) => {
      ...
      button_12.__click = handleCancelFetch;
      append($$anchor2, button_12);
    };
    var alternate = ($$anchor2) => {
      var button_13 = root_6();
      button_13.__click = handleListRegisteredNames;
  ...
  var node_7 = sibling(node_6, 2);
  {
    var consequent_4 = ($$anchor2) => {
      ...
      button_14.__click = handleCancelFetch;
      append($$anchor2, button_14);
    };
    var alternate_1 = ($$anchor2) => {
      var button_15 = root_8();
      button_15.__click = handleGetReverseRegisteredAddresses;
