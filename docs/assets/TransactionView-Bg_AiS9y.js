import { y as fromBase64, a9 as bcs, p as push, N as prop, P as legacy_pre_effect, n as set, m as mutable_source, Q as deep_read_state, g as get, R as legacy_pre_effect_reset, i as init, f as from_html, b as if_block, c as child, k as append, l as pop, J as first_child, s as sibling, S as untrack, t as template_effect, w as getSelectedNetworkConfig, d as set_attribute, e as set_text, X as set_style, K as comment, H as each, I as index, a8 as derived_safe_equal, L as text, E as state, F as proxy, Z as user_effect, a3 as user_derived, Y as set_class, B as delegate, o as getClient } from "./index-CrBkJ6Na.js";
import { R as Root } from "./Root-Ch4kcPBT.js";
import { a as getTransactionLink, b as getAddressLink, g as getObjectLink } from "./explorer-links-Bx4a9wSX.js";
import { f as formatJsonWithCompactArrays, r as removeKindFields, i as isTransactionData, g as getTransactionData } from "./transaction-view-CX5wfVGv.js";
import { T as TransactionCommands } from "./TransactionCommands-D2Vwda5a.js";
import { a as formatNumberWithUnderscores, n as nanoToIota } from "./iota-nano-conversion-Cbp-fQmb.js";
          ...
          each(div_45, 5, () => get(events), index, ($$anchor4, event, index2) => {
            ...
            var node_30 = sibling(span_9, 2);
            {
              ...
              if_block(node_30, ($$render) => {
                if (get(event), untrack(() => get(event).parsedJson)) $$render(consequent_28);
              });
            }
            template_effect(() => set_text(text_44, (get(event), untrack(() => get(event).type || "Unknown"))));
