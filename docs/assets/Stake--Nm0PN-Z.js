import { aE as Transaction, aF as IOTA_SYSTEM_STATE_OBJECT_ID, aK as bcs, ab as isValidIotaAddress, p as push, a0 as legacy_pre_effect, g as get, s as set, a2 as legacy_pre_effect_reset, v as init, b as sibling, h as child, i as if_block, O as TransactionView, t as template_effect, c as set_text, w as event, J as bind_value, d as append, l as pop, G as setup_stores, y as mutable_source, aI as addAndRun, n as nanoToIotaFormatted, z as getClient, f as formatNumbersWithUnderscores, aC as formatNumberWithUnderscores, a3 as untrack, m as user_derived, a1 as deep_read_state, a9 as set_style, q as from_html, F as store_get, au as activeAddress, X as first_child, Y as comment, e as each, j as index } from "./index-BJSKw4Xx.js";
import { I as IotaAmountInput } from "./IotaAmountInput-3y3PC1kj.js";
...
function Stake($$anchor, $$props) {
  ...
  async function unstakeSpecificAmount(stakedIotaObjectId2) {
    try {
      ...
      await addAndRun({
        label: `Unstake ${nanoToIotaFormatted(String(get(amount)))} IOTA from ${shortAddr(stakedIotaObjectId2)}`,
        transaction: tx
      });
    } catch (err) {
      console.error(err);
