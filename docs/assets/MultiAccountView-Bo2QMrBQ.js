import { p as push, V as state, W as proxy, f as from_html, r as store_get, c as child, s as sibling, b as if_block, g as get, l as set, G as each, t as template_effect, a0 as user_derived, d as set_text, L as bind_value, h as bind_select_value, j as append, k as pop, u as setup_stores, ai as iota_accounts, am as iota_wallets, n as getClient, an as Transaction, Y as isValidIotaAddress, y as toBase64, z as delegate, R as set_attribute, S as set_class, e as event, O as text, P as comment, N as first_child } from "/iota-utils/assets/index-LSzG6O2x.js";
import { b as fetchCurrentPrice, a as action } from "/iota-utils/assets/price-fetching-C8A_j6Cm.js";
import { T as TransactionView } from "/iota-utils/assets/TransactionView-BqBJn15y.js";
import { n as nanoToIota } from "/iota-utils/assets/iota-nano-conversion-63uBrWen.js";
import { c as computeStakingRewards } from "/iota-utils/assets/staking-utils-JrjltwVn.js";
import { c as calculateGasFee } from "/iota-utils/assets/transaction-execution-CHwLwHxx.js";
...
var on_click_2 = (__7, toggleCollapse, account) => toggleCollapse(get(account).id);
var on_click_3 = (__8, removeAccount, account) => removeAccount(get(account).address);
...
var root_4 = from_html(`<div><div class="object-header svelte-i6rown"><span class="object-type svelte-i6rown"><!></span> <span class="object-amount svelte-i6rown"><!></span></div> <div style="position: relative;"><!> <details class="object-details svelte-i6rown"><summary style="text-align: center; list-style-position: inside;" class="svelte-i6rown">Data</summary> <pre class="svelte-i6rown"> </pre></details></div></div>`);
var root_13 = from_html(`<div style="text-align: center; color: var(--text-muted); padding: 1rem; font-size: 0.8rem;">No objects</div>`);
var root_15 = from_html(`<div class="object-item svelte-i6rown" style="border-color: rgba(248, 113, 113, 0.3);"><div class="object-header svelte-i6rown"><span class="object-type svelte-i6rown"> </span> <span class="object-amount svelte-i6rown"><!></span></div> <details class="object-details svelte-i6rown"><summary class="svelte-i6rown">Data</summary> <pre class="svelte-i6rown"> </pre></details></div>`);
...
var root_3 = from_html(`<div class="object-list svelte-i6rown"><!> <!> <!></div>`);
var root_2 = from_html(`<div class="account-card svelte-i6rown"><div class="account-header svelte-i6rown"><div style="display: flex; flex-direction: column;"><div style="display: flex; align-items: center; gap: 0.5rem;"><span class="account-title svelte-i6rown"> </span> <button style="font-size: 0.7rem; padding: 0.1rem 0.3rem; width: fit-content; background: var(--secondary-color); border-radius: 3px;">Copy Address</button></div> <div class="account-buttons svelte-i6rown" style="display: flex; gap: 0.5rem; margin-top: 0.2rem;"><button style="font-size: 0.7rem; padding: 0.1rem 0.3rem; width: fit-content; border-radius: 3px;"> </button></div></div> <div style="text-align: right; display: flex; flex-direction: column; align-items: flex-end; gap: 0.2rem;"><button class="danger svelte-i6rown" style="font-size: 0.7rem; padding: 0.1rem 0.3rem; width: fit-content; border-radius: 3px;">Remove</button> <div class="account-balance svelte-i6rown"> <span style="font-size: 0.8em; color: var(--text-muted);">IOTA</span></div></div></div> <!></div>`);
var root = from_html(`<main class="container svelte-i6rown"><div class="toolbar svelte-i6rown"><div style="display: flex; gap: 0.5rem;"><button style="background: #059669;" class="svelte-i6rown">Sync/Reset</button></div> <div style="display: flex; align-items: center; gap: 0.5rem; flex-grow: 1; flex-wrap: wrap;"><input type="text" placeholder="Enter external address (0x...)" class="svelte-i6rown"/> <button class="svelte-i6rown">Add Account</button></div> <div style="display: flex; gap: 0.5rem;"><button class="svelte-i6rown">Dry Run</button> <button class="svelte-i6rown">Prepare Tx Bytes</button> <button class="svelte-i6rown">Send</button></div></div> <!> <!> <div class="summary-section svelte-i6rown"><div class="summary-header svelte-i6rown"><h3 class="svelte-i6rown">Balance Breakdown</h3> <div class="price-controls svelte-i6rown"><select class="svelte-i6rown"><option>USD</option><option>EUR</option></select> <button class="svelte-i6rown">Fetch Price</button></div></div> <div class="table-wrapper"><table class="summary-table svelte-i6rown"><thead><tr><th class="svelte-i6rown">Category</th><th class="svelte-i6rown">Amount (IOTA)</th><th class="svelte-i6rown"> </th></tr></thead><tbody><tr class="total-row" style="background: rgba(16, 185, 129, 0.1);"><td class="svelte-i6rown"><strong>Total</strong></td><td class="svelte-i6rown"><strong> </strong></td><td class="svelte-i6rown"><strong> </strong></td></tr><tr><td class="svelte-i6rown">IOTA Coins</td><td class="svelte-i6rown"> </td><td class="svelte-i6rown"> </td></tr><tr><td class="svelte-i6rown">Staked</td><td class="svelte-i6rown"> </td><td class="svelte-i6rown"> </td></tr><tr><td class="svelte-i6rown">Staking Rewards</td><td class="svelte-i6rown"> </td><td class="svelte-i6rown"> </td></tr></tbody></table></div></div> <div class="accounts-grid svelte-i6rown"></div></main>`);
function MultiAccountView($$anchor, $$props) {
  ...
  each(div_9, 21, () => get(extendedAccounts), (account) => account.id, ($$anchor2, account) => {
    ...
    button_7.__click = [on_click_2, toggleCollapse, account];
    var text_11 = child(button_7);
    var div_15 = sibling(div_12, 2);
    var button_8 = child(div_15);
    button_8.__click = [on_click_3, removeAccount, account];
    ...
    var node_2 = sibling(div_11, 2);
    {
      var consequent_10 = ($$anchor3) => {
        ...
        each(node_3, 17, () => get(account).objects, (item) => item.id, ($$anchor4, item) => {
          ...
          action(div_19, ($$node) => dragHandle == null ? void 0 : dragHandle($$node));
          ...
          template_effect(
            ($0, $1) => {
              classes = set_class(div_18, 1, "object-item svelte-i6rown", null, classes, $0);
        ...
        action(div_17, ($$node, $$action_arg) => dragHandleZone == null ? void 0 : dragHandleZone($$node, $$action_arg), () => ({ items: get(account).objects, flipDurationMs: 200 }));
