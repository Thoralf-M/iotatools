const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/jspdf.es.min-B5EtLTJO.js","assets/index-C4YbiW93.js","assets/index-zai7kGCS.css"])))=>i.map(i=>d[i]);
import { af as block, ag as EFFECT_TRANSPARENT, ah as BranchManager, ai as effect, a3 as untrack, p as push, a as prop, C as onMount, $ as onDestroy, g as get, a0 as legacy_pre_effect, a1 as deep_read_state, a2 as legacy_pre_effect_reset, v as init, b as sibling, h as child, E as bind_this, k as delegated, d as append, l as pop, y as mutable_source, s as set, D as mutate, q as from_html, r as delegate, o as state, R as proxy, u as user_effect, aj as attribute_effect, i as if_block, e as each, Y as comment, X as first_child, t as template_effect, a9 as set_style, m as user_derived, ak as STYLE, al as rest_props, am as __vitePreload, A as set_class, W as set_attribute, c as set_text, a6 as bind_group, an as bind_checked, J as bind_value, j as index, _ as text, ao as get$1, ap as sharedStakingCurrency, x as bind_select_value, a8 as copyToClipboard, w as event, H as getSelectedNetworkConfig, aq as noop, ar as NANOS_PER_IOTA, B as to_array, ab as isValidIotaAddress, as as store_set, at as sharedStakingSkipPaginationSenders, F as store_get, au as activeAddress, av as sharedStakingSkipPaginationEnabled, G as setup_stores, aa as set_value, aw as derived_safe_equal, ax as iota_accounts } from "./index-C4YbiW93.js";
import { J as JsonToggleView } from "./JsonToggleView-CPwxobzt.js";
import { u as usePageQueryParams, a as updatePageQueryParams } from "./page-query-params-C7dYk8AL.js";
import { E as EpochPTBAnalyzer } from "./epoch-ptb-analyzer-Dcup8qk8.js";
import { f as fetchPoolExchangeRates, s as safeBigInt$1, g as getTokenAmount, a as getIotaAmount, b as fetchSystemState, c as getCurrentActiveValidatorsExchangeRateIds, d as getInactiveValidatorsExchangeRateIds, e as getValidatorInfo, h as fetchAllExchangeRates, i as exchangeRateCache, j as formatNanoAsIota, n as nanoToIota, k as formatNanoAsIotaFullPrecision, l as fetchEpochTimestampsForDisplay, m as action, o as setInitialExchangeRateCacheFromBinary, p as exchangeRateCacheBinary, q as mapWithConcurrency, r as fetchStakeTransactions, t as fetchReceivedStakeTransactions, u as fetchCurrentStakedObjects } from "./utils-CC6U2QqM.js";
...
import "./dynamic-fields-DB2KHK6b.js";
...
async function renderSectionsToPdf(sections, onProgress) {
  const [{ jsPDF }, autoTableModule] = await Promise.all([
    __vitePreload(() => import("./jspdf.es.min-B5EtLTJO.js").then((n) => n.j), true ? __vite__mapDeps([0,1,2]) : void 0),
