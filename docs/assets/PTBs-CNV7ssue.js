...
var root_4 = from_html(`<span class="checkpoint-count svelte-ex19u4"> </span>`);
...
var root_8 = from_html(`<span class="checkpoint-count svelte-ex19u4"> </span>`);
...
var root_18 = from_html(`<div class="progress-section svelte-ex19u4"><div class="progress-label svelte-ex19u4"><span> </span> <span class="progress-percentage svelte-ex19u4"> </span></div> <div class="progress-bar svelte-ex19u4"><div class="progress-fill svelte-ex19u4"></div></div></div>`);
var root_17 = from_html(`<div class="progress-info svelte-ex19u4"><div class="progress-header svelte-ex19u4"><p class="svelte-ex19u4"><strong>Progress:</strong> </p> <button class="stop-btn svelte-ex19u4" title="Stop fetching data"> </button></div> <!></div>`);
...
var root_24 = from_html(`<div class="transaction-id-item svelte-ex19u4"><span class="tx-id svelte-ex19u4"> </span> <button class="copy-btn" style="padding: 4px 8px; align-self: center;" title="Copy transaction ID">📋</button></div>`);
var root_23 = from_html(`<div class="function-item svelte-ex19u4"><div class="function-header svelte-ex19u4"><div class="function-signature svelte-ex19u4"><div class="function-parts svelte-ex19u4"><span class="package-id svelte-ex19u4"> </span><span class="separator svelte-ex19u4">::</span><span class="module svelte-ex19u4"> </span><span class="separator svelte-ex19u4">::</span><span class="function-name svelte-ex19u4"> </span> <button class="copy-btn svelte-ex19u4" style="padding: 4px 8px; font-size: 13px;" title="Copy full function signature">📋</button></div> <div class="function-actions svelte-ex19u4"><details class="svelte-ex19u4"><summary class="svelte-ex19u4">Txs</summary></details></div></div> <div class="function-stats svelte-ex19u4"><div class="call-count svelte-ex19u4"><span class="count-label">Calls:</span> <span class="count-value"> </span></div> <div class="tx-count svelte-ex19u4"><span class="count-label">Txs:</span> <span class="count-value"> </span></div></div></div> <div class="transaction-ids-section svelte-ex19u4"><div class="transaction-ids-list svelte-ex19u4"></div></div></div>`);
var root_25 = from_html(`<div class="address-item svelte-ex19u4"><div class="address-header svelte-ex19u4"><div class="address-left svelte-ex19u4"><div class="address-info svelte-ex19u4"><span> </span></div> <button class="copy-btn" style="padding: 4px 8px; align-self: center;" title="Copy address">📋</button></div> <div class="address-stats svelte-ex19u4"><div class="tx-count svelte-ex19u4"><span class="count-label">TXs:</span> <span class="count-value"> </span></div></div></div></div>`);
var root_26 = from_html(`<div class="address-item svelte-ex19u4"><div class="address-header svelte-ex19u4"><div class="address-left svelte-ex19u4"><div class="address-info svelte-ex19u4"><span> </span></div> <button class="copy-btn" style="padding: 4px 8px; align-self: center;" title="Copy address">📋</button></div> <div class="address-stats svelte-ex19u4"><div class="call-count svelte-ex19u4"><span class="count-label">Calls:</span> <span class="count-value"> </span></div></div></div></div>`);
