const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/jspdf.es.min-D9FNRAA-.js","assets/index-BxEuZFuQ.js","assets/index-hJPMGCb5.css"])))=>i.map(i=>d[i]);
import { af as block, ag as EFFECT_TRANSPARENT, ah as BranchManager, ai as effect, a3 as untrack, p as push, a as prop, C as onMount, $ as onDestroy, g as get, a0 as legacy_pre_effect, a1 as deep_read_state, a2 as legacy_pre_effect_reset, v as init, b as sibling, h as child, E as bind_this, k as delegated, d as append, l as pop, y as mutable_source, s as set, D as mutate, q as from_html, r as delegate, o as state, R as proxy, u as user_effect, aj as attribute_effect, i as if_block, e as each, Y as comment, X as first_child, t as template_effect, a9 as set_style, m as user_derived, ak as STYLE, al as rest_props, am as __vitePreload, A as set_class, W as set_attribute, c as set_text, a6 as bind_group, an as bind_checked, J as bind_value, j as index, _ as text, ao as get$1, ap as sharedStakingCurrency, x as bind_select_value, a8 as copyToClipboard, w as event, H as getSelectedNetworkConfig, aq as noop, ar as NANOS_PER_IOTA, B as to_array, ab as isValidIotaAddress, as as store_set, at as sharedStakingSkipPaginationSenders, F as store_get, au as activeAddress, av as sharedStakingSkipPaginationEnabled, G as setup_stores, aa as set_value, aw as derived_safe_equal, ax as iota_accounts } from "./index-BxEuZFuQ.js";
import { J as JsonToggleView } from "./JsonToggleView-Cw_Jhcn0.js";
import { u as usePageQueryParams, a as updatePageQueryParams } from "./page-query-params-ClM50FsT.js";
import { E as EpochPTBAnalyzer } from "./epoch-ptb-analyzer-D7YlKxGF.js";
import { f as fetchPoolExchangeRates, s as safeBigInt$1, g as getTokenAmount, a as getIotaAmount, b as fetchSystemState, c as getCurrentActiveValidatorsExchangeRateIds, d as getInactiveValidatorsExchangeRateIds, e as getValidatorInfo, h as fetchAllExchangeRates, i as exchangeRateCache, j as formatNanoAsIota, n as nanoToIota, k as formatNanoAsIotaFullPrecision, l as fetchEpochTimestampsForDisplay, m as action, o as setInitialExchangeRateCacheFromBinary, p as exchangeRateCacheBinary, q as mapWithConcurrency, r as fetchStakeTransactions, t as fetchReceivedStakeTransactions, u as fetchCurrentStakedObjects } from "./utils-BhccIz43.js";
...
import "./dynamic-fields-CObwz2mu.js";
...
async function computeRewardsForStakeObject(stakeObject, exchangeRateId) {
  ...
  const accumulatedAtFirst = safeBigInt$1(
    stakeObject.accumulatedRewards[stakeObject.firstEpoch] || "0"
  );
  let previousPrincipal = 0n;
  for (const epoch of epochs) {
    const principalAmount = safeBigInt$1(stakeObject.principalByEpoch[epoch] || "0");
      ...
      if (epoch >= stakeObject.firstEpoch) {
        ...
        if (unstakeAction) {
          if (!unstakeAction.totalRewards || unstakeAction.totalRewards === "0") {
            const unstakePrincipal = safeBigInt$1(unstakeAction.amount || "0");
  ...
  if (stakeObject.transferredInEpoch !== void 0) {
    ...
    const principalAtTransfer = safeBigInt$1(stakeObject.principalByEpoch[transferEpoch] || "0");
...
async function determineActionDetails(input, output, idCreated, idDeleted, digest, timestamp, targetAddress, trackedAddresses, currentEpoch, epochId, existing, coinObjects, timelockObjects, txStakeObjects, address) {
  ...
  if (idCreated) {
    ...
    const principalAmount = safeBigInt$1(input.principal);
    ...
    if (exchangeRateResult.success) {
      ...
      const totalCoinBalance = ownerCoins.reduce((sum, coin) => {
        return sum + safeBigInt$1(coin.balance);
      }, 0n);
    ...
    if (input.owner && output?.owner && input.owner !== output.owner) {
      ...
      const inputPrincipal = safeBigInt$1(input.principal);
      const outputPrincipal = safeBigInt$1(output?.principal || "0");
      ...
      const totalTimelockAmount = ownerTimelocks.reduce((sum, timelock) => {
        return sum + safeBigInt$1(timelock.lockedAmount);
      }, 0n);
      const mergedObjects = [];
      const splitObjects = [];
      ...
      txStakeObjects.forEach((otherStakeData, otherAddress) => {
        if (otherAddress !== address) {
          if (otherStakeData.idDeleted && otherStakeData.input) {
            ...
            mergedPrincipalTotal += safeBigInt$1(otherStakeData.input.principal);
  ...
  const rebased = stakeObjects.map((obj) => {
    ...
    if (actionByEpoch && baseline > 0n) {
      ...
      for (const epoch of orderedEpochs) {
        next[epoch] = actionByEpoch[epoch].map((action2) => {
          if (epoch >= startEpoch && remaining > 0n && (action2.action === "Unstaked" || action2.action === "Partial Unstake") && action2.totalRewards) {
            const original = safeBigInt(action2.totalRewards);
            const subtract = original < remaining ? original : remaining;
            remaining -= subtract;
            return { ...action2, totalRewards: (original - subtract).toString() };
          }
          return action2;
        });
      }
...
const pricesCache = {
  ...
  "13-05-2026": { "usd": 0.062283483345452105, "eur": 0.05306459355807502 },
  "14-05-2026": { "usd": 0.06041399070835223, "eur": 0.05156714715099326 },
  "15-05-2026": { "usd": 0.062341636571431464, "eur": 0.053452467295984185 },
  "16-05-2026": { "usd": 0.05799195984849628, "eur": 0.0498962822536462 },
  "17-05-2026": { "usd": 0.056512601010774315, "eur": 0.048604623213533635 },
  "18-05-2026": { "usd": 0.05487381015065583, "eur": 0.04725030145404552 },
  "19-05-2026": { "usd": 0.056089167662752334, "eur": 0.04812203793126435 },
  "20-05-2026": { "usd": 0.055817541487718454, "eur": 0.04807737882715801 },
  "21-05-2026": { "usd": 0.05566510882961356, "eur": 0.04788112267131573 },
  "22-05-2026": { "usd": 0.05697340464709854, "eur": 0.049039345289348245 },
  "23-05-2026": { "usd": 0.05792026618029359, "eur": 0.04989471825781975 },
  "24-05-2026": { "usd": 0.05800940396605068, "eur": 0.049990880074631434 },
  "25-05-2026": { "usd": 0.056220420054101376, "eur": 0.04827990414608015 },
  "26-05-2026": { "usd": 0.057401764482532446, "eur": 0.04932654165689426 },
  "27-05-2026": { "usd": 0.056354970457888114, "eur": 0.048421768556590285 },
  "28-05-2026": { "usd": 0.05512049924759081, "eur": 0.047444859486365294 },
  "29-05-2026": { "usd": 0.059713658262627506, "eur": 0.05124584352537909 },
  "30-05-2026": { "usd": 0.06499467129561283, "eur": 0.055729615907751925 },
  "31-05-2026": { "usd": 0.062180645295007005, "eur": 0.05331287692755017 },
  "01-06-2026": { "usd": 0.060695080432079454, "eur": 0.052099321751127484 },
  "02-06-2026": { "usd": 0.05759728526320925, "eur": 0.04950135324932729 },
  "03-06-2026": { "usd": 0.05275724465166513, "eur": 0.045398980711118794 },
  "04-06-2026": { "usd": 0.05051314102536883, "eur": 0.043513585586624486 },
  "05-06-2026": { "usd": 0.0476361275106828, "eur": 0.0410205173942542 },
  "06-06-2026": { "usd": 0.04440273340789634, "eur": 0.03853402413337468 },
  "07-06-2026": { "usd": 0.04483750174546764, "eur": 0.03890608315206496 },
  "08-06-2026": { "usd": 0.0468345237096248, "eur": 0.04064908816329465 },
  "09-06-2026": { "usd": 0.04708226311025991, "eur": 0.040835435523053736 },
  "10-06-2026": { "usd": 0.04530162782540774, "eur": 0.039273204305797255 },
  "11-06-2026": { "usd": 0.04444069296778947, "eur": 0.03852319249566346 },
  "12-06-2026": { "usd": 0.04636333546828933, "eur": 0.04005370278107437 },
  "13-06-2026": { "usd": 0.04649521995851736, "eur": 0.04017386933861721 },
  "14-06-2026": { "usd": 0.04645873166672715, "eur": 0.040156233046282276 },
  "15-06-2026": { "usd": 0.047617709367763765, "eur": 0.041025989859984215 },
  "16-06-2026": { "usd": 0.0495051914313209, "eur": 0.0427064949764833 },
  "17-06-2026": { "usd": 0.0481323306046917, "eur": 0.04145209257239714 },
  "18-06-2026": { "usd": 0.047425773210560906, "eur": 0.04121347117770952 },
  "19-06-2026": { "usd": 0.045794050832460194, "eur": 0.03996419339718301 },
  "20-06-2026": { "usd": 0.044893946361775565, "eur": 0.03911474864662419 },
  "21-06-2026": { "usd": 0.04509088472153389, "eur": 0.03930346966752502 },
  "22-06-2026": { "usd": 0.043835962605349686, "eur": 0.03825643361301557 },
  "23-06-2026": { "usd": 0.04315523052823211, "eur": 0.037769371447847686 },
  "24-06-2026": { "usd": 0.04175809507050905, "eur": 0.03668978979751616 },
  "25-06-2026": { "usd": 0.04013912717254289, "eur": 0.03535257639634432 },
  "26-06-2026": { "usd": 0.037734937258996216, "eur": 0.03320934849858754 },
  "27-06-2026": { "usd": 0.038374116945388455, "eur": 0.033684799854661995 },
  "28-06-2026": { "usd": 0.03741666484156597, "eur": 0.0328519065642246 },
  "29-06-2026": { "usd": 0.03552527876900797, "eur": 0.031205404870696604 },
  "01-07-2026": { "usd": 0.035126710870299976, "eur": 0.03077721615020682 },
  "30-06-2026": { "usd": 0.035101572341549266, "eur": 0.030733041257354096 },
  "02-07-2026": { "usd": 0.03746879752142056, "eur": 0.03293143854796909 },
  "03-07-2026": { "usd": 0.039264012045969764, "eur": 0.034365551695150716 },
  "04-07-2026": { "usd": 0.03951874468054938, "eur": 0.03453981755699165 },
  "05-07-2026": { "usd": 0.03926326395332978, "eur": 0.03433152315794389 }
};
const FONT_SIZE = 8;
...
async function renderSectionsToPdf(sections, onProgress) {
  const [{ jsPDF }, autoTableModule] = await Promise.all([
    __vitePreload(() => import("./jspdf.es.min-D9FNRAA-.js").then((n) => n.j), true ? __vite__mapDeps([0,1,2]) : void 0),
...
var root_18 = from_html(`<button class="amount-value svelte-toncsw" type="button"> </button> <div class="amount-popup svelte-toncsw"><div> </div> <div class="nano-amount svelte-toncsw"> </div></div>`, 1);
var root_16$1 = from_html(`<div class="table-cell rewards-cell svelte-toncsw"><div class="amount-popup-container svelte-toncsw"><!></div></div>`);
var root_20$1 = from_html(`<div class="table-cell rewards-cell svelte-toncsw"> </div> <div class="table-cell rewards-cell svelte-toncsw"> </div> <div class="table-cell rewards-cell svelte-toncsw"> </div> <div class="table-cell rewards-cell svelte-toncsw"> </div>`, 1);
var root_24 = from_html(`<button class="validator-reward-value svelte-toncsw" type="button"> </button> <div class="validator-popup svelte-toncsw"><div> </div> <div> </div> <div> </div> <div class="nano-amount svelte-toncsw"> </div> <div> </div> <div class="nano-amount svelte-toncsw"> </div></div>`, 1);
var root_22$1 = from_html(`<div class="table-cell validator-cell svelte-toncsw"><div class="validator-popup-container svelte-toncsw"><!></div></div>`);
var root_27$1 = from_html(`<span class="stake-value svelte-toncsw">-</span>`);
var root_28$1 = from_html(`<button class="stake-value svelte-toncsw" type="button"> </button>`);
var root_26$1 = from_html(`<div class="stake-cell-content svelte-toncsw"><!> <div class="stake-popup svelte-toncsw"><div> </div> <div> </div></div></div>`);
...
var root_13 = from_html(`<span class="timeframe-warning svelte-us09jc">⚠ "All time" scans the entire retained history and can take several minutes
                        — pick a narrower window if you only need recent rewards.</span>`);
var root_14 = from_html(`<label class="timeframe-date svelte-us09jc">From: <input type="date" class="svelte-us09jc"/></label> <label class="timeframe-date svelte-us09jc">To: <input type="date" class="svelte-us09jc"/></label>`, 1);
var root_15 = from_html(`<label class="timeframe-date svelte-us09jc">From epoch: <input type="number" min="0" step="1" placeholder="0" class="epoch-input svelte-us09jc"/></label> <label class="timeframe-date svelte-us09jc">To epoch: <input type="number" min="0" step="1" class="epoch-input svelte-us09jc"/></label>`, 1);
var root_19 = from_html(`<span class="timeframe-mapping svelte-us09jc"> </span>`);
var root_20 = from_html(`<span class="timeframe-mapping svelte-us09jc"> </span>`);
var root_16 = from_html(`<span class="timeframe-info svelte-us09jc"><!> <!> <!></span>`);
var root_22 = from_html(`<label class="toggle-row svelte-us09jc"><div class="toggle-switch svelte-us09jc"><input type="checkbox" class="svelte-us09jc"/> <span class="slider svelte-us09jc"></span></div> <div style="display: flex; flex-direction: column; line-height: 1.2;"><div style="display: flex; align-items: center; gap: 0.25rem;"><span class="toggle-label">Ignore previous rewards</span> <div class="tooltip-container svelte-us09jc"><span class="info-icon svelte-us09jc">ⓘ</span> <div class="tooltip svelte-us09jc">Removes rewards that accrued before the selected time frame.
...
var root_23 = from_html(`<div class="info-message svelte-us09jc"> <!></div>`);
var root_25 = from_html(`<div class="loading-message svelte-us09jc">Loading can take minutes, depending on the number of transactions/epochs.</div>`);
var root_26 = from_html(`<div class="error-message svelte-us09jc"> </div>`);
var root_27 = from_html(`<div class="error-message svelte-us09jc"> </div>`);
var root_28 = from_html(`<div class="info-message svelte-us09jc"> </div>`);
...
function StakingRewards($$anchor, $$props) {
  ...
  async function fetchTransactions() {
    ...
    try {
      ...
      const allTxsResults = await mapWithConcurrency(get(allAddresses), ADDRESS_FETCH_CONCURRENCY, async (addr) => {
        try {
  ...
  legacy_pre_effect(() => get(selectedTimeFrame), () => {
    updatePageQueryParams({
      timeFrame: get(selectedTimeFrame) === "last-3-days" ? null : get(selectedTimeFrame)
    });
  });
  legacy_pre_effect(
  ...
  legacy_pre_effect(() => get(ignorePreviousRewards), () => {
    updatePageQueryParams({
      ignorePreviousRewards: get(ignorePreviousRewards) ? true : null
    });
  });
  legacy_pre_effect(
    () => (get(selectedTimeFrame), get(customDateStart), get(customDateEnd)),
  ...
  legacy_pre_effect(
    () => (get(ignorePreviousRewards), get(selectedTimeFrame), get(timeFrameFilteredEpochs)),
    () => {
  ...
  legacy_pre_effect(
    () => (get(rebaseStartEpoch), get(stakeObjects)),
    () => {
  ...
  legacy_pre_effect(
    () => (get(rebaseStartEpoch), get(previousRewardsRemoved), formatNanoAsIota),
    () => {
  ...
  legacy_pre_effect(
    () => (get(rebaseResult), get(displayStakeObjects), get(validatorInfo), get(epoch), get(tableData)),
    () => {
  ...
  var node_9 = sibling(label_4, 2);
  {
    ...
    if_block(node_9, ($$render) => {
      if (get(selectedTimeFrame) === "all") $$render(consequent_9);
    });
  }
  var node_10 = sibling(node_9, 2);
  {
    ...
    if_block(node_10, ($$render) => {
      if (get(selectedTimeFrame) === "custom") $$render(consequent_10);
    });
  }
  var node_11 = sibling(node_10, 2);
  {
    ...
    if_block(node_11, ($$render) => {
      if (get(selectedTimeFrame) === "custom-epochs") $$render(consequent_11);
    });
  }
    ...
    var consequent_16 = ($$anchor2) => {
      ...
      var node_13 = child(span_1);
      {
        ...
        if_block(node_13, ($$render) => {
          if (get(selectedTimeFrame) === "custom-epochs" && get(customEpochRange)) $$render(consequent_12);
          else $$render(alternate_1, -1);
        });
      }
      var node_14 = sibling(node_13, 2);
      {
        ...
        if_block(node_14, ($$render) => {
          if (get(selectedTimeFrame) === "custom-epochs" && get(mappedDateRangeForEpochs)) $$render(consequent_13);
          else if (get(selectedTimeFrame) !== "custom-epochs" && get(mappedEpochRangeForDates)) $$render(consequent_14, 1);
        });
      }
      var node_15 = sibling(node_14, 2);
      {
        ...
        if_block(node_15, ($$render) => {
          if (get(tableData), untrack(() => get(tableData).epochs.length > 0)) $$render(consequent_15);
        });
      }
      append($$anchor2, span_1);
    };
  ...
  var node_16 = sibling(div_9, 2);
  {
    var consequent_17 = ($$anchor2) => {
      ...
      append($$anchor2, label_9);
    };
    if_block(node_16, ($$render) => {
      if (get(selectedTimeFrame) !== "all") $$render(consequent_17);
    });
  }
  var button_1 = sibling(node_16, 2);
  ...
  var node_17 = sibling(div, 2);
  {
    var consequent_19 = ($$anchor2) => {
      ...
      var node_18 = sibling(text_14);
      {
        ...
        if_block(node_18, ($$render) => {
          if (get(allAddresses), untrack(() => get(allAddresses).length > 3)) $$render(consequent_18);
        });
      }
      template_effect(
    ...
    if_block(node_17, ($$render) => {
      if (get(allAddresses), untrack(() => get(allAddresses).length > 1)) $$render(consequent_19);
    });
  }
  var node_19 = sibling(node_17, 2);
  {
    ...
    if_block(node_19, ($$render) => {
      if (get(loadingTxs)) $$render(consequent_20);
    });
  }
  var node_20 = sibling(node_19, 2);
  {
  ...
  var node_21 = sibling(node_20, 2);
  {
    ...
    if_block(node_21, ($$render) => {
      if (get(filteredNegativeEpochs), untrack(() => get(filteredNegativeEpochs).length > 0)) $$render(consequent_22);
    });
  }
  var node_22 = sibling(node_21, 2);
  {
    ...
    if_block(node_22, ($$render) => {
      if (get(previousRewardsNotice), get(stakeObjects), untrack(() => get(previousRewardsNotice) && get(stakeObjects).length > 0)) $$render(consequent_23);
    });
  }
  var div_16 = sibling(node_22, 2);
  var node_23 = child(div_16);
  {
    let $0 = derived_safe_equal(() => get(epoch) || 1);
    StakingRewardsTable(node_23, {
      get currentEpoch() {
        return get($0);
      },
      get stakeObjects() {
  ...
  var node_24 = sibling(div_16, 2);
  {
    ...
    if_block(node_24, ($$render) => {
      if (get(stakeObjects), untrack(() => get(stakeObjects).length > 0)) $$render(consequent_24);
    });
  }
  var details_1 = sibling(node_24, 2);
  var node_25 = sibling(child(details_1), 2);
  JsonToggleView(node_25, {
    get value() {
      return get(stakeObjects);
    }
  });
  var details_2 = sibling(details_1, 2);
  var node_26 = sibling(child(details_2), 2);
  JsonToggleView(node_26, {
    get value() {
