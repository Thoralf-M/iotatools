import { ay as nanoToIota, az as formatNumberWithUnderscores, r as delegate, p as push, a as prop, X as comment, W as first_child, i as if_block, d as append, l as pop, g as get, b as sibling, h as child, t as template_effect, V as set_attribute, c as set_text, z as set_class, q as from_html, m as user_derived, Z as text, k as delegated, e as each, w as event, B as getClient, x as bind_select_value, aA as Transaction, aB as IOTA_SYSTEM_STATE_OBJECT_ID, j as index, a5 as bind_group, A as to_array, o as state, Q as proxy, u as user_effect, s as set, a2 as untrack, C as onMount, _ as onDestroy, a8 as set_style, H as bind_value, am as bind_checked, N as TransactionView, an as get$1, aC as sharedTransactionExecution, aD as TransactionExecution, L as toBase64, aE as getActiveWallet, aF as requireMainnetTransactionConfirmation, aG as getSelectedChain, aH as sharedMultiAccountCurrency, F as setup_stores, aa as isValidIotaAddress, E as store_get, au as iota_accounts } from "./index-D1wHg-XN.js";
import { c as calculateGasFee, e as executeTransaction } from "./transaction-execution-CyzwxlQr.js";
import { m as action, g as getTokenAmount, a as getIotaAmount, i as exchangeRateCache, o as setInitialExchangeRateCacheFromBinary, p as exchangeRateCacheBinary, h as fetchAllExchangeRates } from "./utils-BMZCkSQg.js";
import { c as computeStakingRewards } from "./staking-utils-B4fZcssz.js";
import { b as bind_this } from "./this-C5CzF-m7.js";
import { C as Chart } from "./auto-sd7q3vNv.js";
import { p as plugin } from "./chartjs-plugin-zoom.esm-BAaqFnPU.js";
import "./dynamic-fields-wMEl5xOl.js";
...
var root_15 = from_html(`<div class="legend-hint svelte-w4m6sy"> <strong>two projection lines</strong>: the dashed, lighter
    ...
    var consequent_11 = ($$anchor2) => {
      ...
      template_effect(
        ($0, $1, $2, $3, $4, $5) => {
          ...
          set_text(text_24, `The protocol activates new stakes at the next epoch boundary, so switched principal
                ...
                ${get(switchTxCount) === 1 ? "transaction" : "transactions"} for the current selection).`);
        },
        [
