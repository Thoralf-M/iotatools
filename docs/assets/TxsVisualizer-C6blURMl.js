import { p as push, H as state, J as proxy, q as onMount, g as get, W as onDestroy, a as from_html, s as sibling, c as child, b as if_block, N as user_derived, t as template_effect, a5 as set_class, e as set_text, v as delegated, y as bind_value, k as append, l as pop, n as set, L as each, a4 as set_style, d as set_attribute, S as getAddressLink, M as getObjectLink, R as comment, Q as first_child, O as index, D as TransactionView, x as getSelectedNetworkConfig, an as to_array, E as delegate } from "./index-Bh46YjYG.js";
import { f as fetchRecentTransactions } from "./fetchTransactions-HwWvT61D.js";
...
var root_12 = from_html(`<div class="move-calls-table card svelte-knun4w"><h2 class="table-title svelte-knun4w">Move Function Calls</h2> <table class="fn-table svelte-knun4w"><thead class="svelte-knun4w"><tr class="svelte-knun4w"><th class="col-count svelte-knun4w">Count</th><th class="col-fn svelte-knun4w">Function</th></tr></thead><tbody class="svelte-knun4w"></tbody></table></div>`);
...
function TxsVisualizer($$anchor, $$props) {
  ...
  async function poll() {
    ...
    try {
      ...
      if (get(timeDirection) === "future") {
        ...
        if (result.txs.length > 0) {
          set(transactions, [...result.txs, ...get(
            transactions
            // Keep max
          )].slice(0, get(limit)), true);
        }
      }
    } catch (e) {
  ...
  var node_8 = sibling(node, 2);
  {
    var consequent_6 = ($$anchor2) => {
      var div_27 = root_12();
      var table = sibling(child(div_27), 2);
  ...
  var node_11 = sibling(node_8, 2);
  {
    var consequent_7 = ($$anchor2) => {
      ...
      delegated("click", div_30, closeTransactionPopup);
      delegated("keydown", div_30, (e) => e.key === "Escape" && closeTransactionPopup());
      delegated("click", div_31, (e) => e.stopPropagation());
      delegated("keydown", div_31, (e) => e.stopPropagation());
