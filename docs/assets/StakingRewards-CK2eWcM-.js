const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/jspdf.es.min-jj43qLIW.js","assets/index-DgBLkJGx.js","assets/index-hJPMGCb5.css"])))=>i.map(i=>d[i]);
import { af as block, ag as EFFECT_TRANSPARENT, ah as BranchManager, ai as effect, a3 as untrack, H as getSelectedNetworkConfig, aj as IotaClient, p as push, a as prop, C as onMount, $ as onDestroy, g as get, a0 as legacy_pre_effect, a1 as deep_read_state, a2 as legacy_pre_effect_reset, v as init, b as sibling, h as child, E as bind_this, k as delegated, d as append, l as pop, y as mutable_source, s as set, D as mutate, q as from_html, r as delegate, o as state, R as proxy, u as user_effect, ak as attribute_effect, i as if_block, e as each, Y as comment, X as first_child, t as template_effect, a9 as set_style, m as user_derived, al as STYLE, am as rest_props, an as __vitePreload, A as set_class, W as set_attribute, c as set_text, a6 as bind_group, ao as bind_checked, J as bind_value, j as index, _ as text, ap as get$1, aq as sharedStakingCurrency, x as bind_select_value, a8 as copyToClipboard, w as event, ar as noop, as as NANOS_PER_IOTA, B as to_array, ab as isValidIotaAddress, at as store_set, au as sharedStakingSkipPaginationSenders, F as store_get, av as activeAddress, aw as sharedStakingSkipPaginationEnabled, G as setup_stores, aa as set_value, ax as derived_safe_equal, ay as iota_accounts } from "./index-DgBLkJGx.js";
import { J as JsonToggleView } from "./JsonToggleView-DAE7m4Ln.js";
import { u as usePageQueryParams, a as updatePageQueryParams } from "./page-query-params-o15qWXjW.js";
import { E as EpochPTBAnalyzer } from "./epoch-ptb-analyzer-DDf6LUPe.js";
import { f as fetchPoolExchangeRates, s as safeBigInt$1, g as getTokenAmount, a as getIotaAmount, b as fetchSystemState, c as getCurrentActiveValidatorsExchangeRateIds, d as getInactiveValidatorsExchangeRateIds, e as getValidatorInfo, h as fetchAllExchangeRates, i as exchangeRateCache, j as formatNanoAsIota, n as nanoToIota, k as formatNanoAsIotaFullPrecision, l as fetchEpochTimestampsForDisplay, m as action, o as setInitialExchangeRateCacheFromBinary, p as exchangeRateCacheBinary, q as fetchCurrentStakedObjects } from "./utils-Myf1xsRM.js";
...
import "./dynamic-fields-DQyY43gH.js";
...
async function renderSectionsToPdf(sections, onProgress) {
  const [{ jsPDF }, autoTableModule] = await Promise.all([
    __vitePreload(() => import("./jspdf.es.min-jj43qLIW.js").then((n) => n.j), true ? __vite__mapDeps([0,1,2]) : void 0),
