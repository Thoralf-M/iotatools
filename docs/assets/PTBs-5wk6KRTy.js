import { C as getDefaultExportFromCjs, p as push, D as prop, r as onMount, g as get, m as mutable_source, E as onDestroy, F as legacy_pre_effect, n as set$1, G as deep_read_state, H as legacy_pre_effect_reset, i as init, f as from_html, s as sibling, c as child, I as each$1, t as template_effect, e as set_text, J as untrack, k as append, K as index$1, L as init_select, b as if_block, M as select_option, h as event, l as pop, q as mutate, x as bind_value, N as bind_group, O as first_child, w as getSelectedNetworkConfig, d as set_attribute, P as text, Q as comment, R as set_style, S as set_class } from "/iota-utils/assets/index-DnAm28wB.js";
import { b as bind_this } from "/iota-utils/assets/this-B6BZWJLg.js";
import { g as getTransactionLink, a as getObjectLink, b as getAddressLink, T as TransactionView } from "/iota-utils/assets/TransactionView-CjgdhLhj.js";
import { E as EpochPTBAnalyzer } from "/iota-utils/assets/index-DIUgIYUc.js";
import "/iota-utils/assets/transaction-view-BVARFeKc.js";
import "/iota-utils/assets/client-Czg8n72w.js";
import "/iota-utils/assets/iota-nano-conversion-bLekXApH.js";
...
var root_4 = from_html(`<span class="checkpoint-count svelte-2uiiyd"> </span>`);
...
var root_8 = from_html(`<span class="checkpoint-count svelte-2uiiyd"> </span>`);
var root_5 = from_html(`<input id="start-checkpoint" type="number" placeholder="Start" min="0" style="width: 8rem;"/> <span class="range-separator svelte-2uiiyd">to</span> <input id="end-checkpoint" type="number" placeholder="End" min="0" style="width: 8rem;"/> <button class="fetch-current-epoch-btn" title="Fetch current epoch range"><!></button> <!>`, 1);
...
var root_18 = from_html(`<div class="progress-section svelte-2uiiyd"><div class="progress-label svelte-2uiiyd"><span> </span> <span class="progress-percentage svelte-2uiiyd"> </span></div> <div class="progress-bar svelte-2uiiyd"><div class="progress-fill svelte-2uiiyd"></div></div></div>`);
var root_17 = from_html(`<div class="progress-info svelte-2uiiyd"><div class="progress-header svelte-2uiiyd"><p class="svelte-2uiiyd"><strong>Progress:</strong> </p> <button class="stop-btn svelte-2uiiyd" title="Stop fetching data"> </button></div> <!></div>`);
...
var root_24 = from_html(`<div class="transaction-id-item svelte-2uiiyd"><a target="_blank" rel="noopener noreferrer" class="tx-id link-style svelte-2uiiyd"> </a> <button class="copy-btn" style="padding: 4px 8px; align-self: center;" title="Copy transaction ID">📋</button></div>`);
var root_23 = from_html(`<div class="function-item svelte-2uiiyd"><div class="function-header svelte-2uiiyd"><div class="function-signature svelte-2uiiyd"><div class="function-parts svelte-2uiiyd"><a target="_blank" rel="noopener noreferrer" class="package-id link-style svelte-2uiiyd"> </a><span class="separator svelte-2uiiyd">::</span><span class="module svelte-2uiiyd"> </span><span class="separator svelte-2uiiyd">::</span><span class="function-name svelte-2uiiyd"> </span> <button class="copy-btn svelte-2uiiyd" style="padding: 4px 8px; font-size: 13px;" title="Copy full function signature">📋</button></div> <div class="function-actions svelte-2uiiyd"><details class="svelte-2uiiyd"><summary class="svelte-2uiiyd">Txs</summary></details></div></div> <div class="function-stats svelte-2uiiyd"><div class="call-count svelte-2uiiyd"><span class="count-label">Calls:</span> <span class="count-value"> </span></div> <div class="tx-count svelte-2uiiyd"><span class="count-label">Txs:</span> <span class="count-value"> </span></div></div></div> <div class="transaction-ids-section svelte-2uiiyd"><div class="transaction-ids-list svelte-2uiiyd"></div></div></div>`);
var root_25 = from_html(`<div class="address-item svelte-2uiiyd"><div class="address-header svelte-2uiiyd"><div class="address-left svelte-2uiiyd"><div class="address-info svelte-2uiiyd"><a target="_blank" rel="noopener noreferrer" class="link-style svelte-2uiiyd"> </a></div> <button class="copy-btn" style="padding: 4px 8px; align-self: center;" title="Copy address">📋</button></div> <div class="address-stats svelte-2uiiyd"><div class="tx-count svelte-2uiiyd"><span class="count-label">TXs:</span> <span class="count-value"> </span></div></div></div></div>`);
var root_26 = from_html(`<div class="address-item svelte-2uiiyd"><div class="address-header svelte-2uiiyd"><div class="address-left svelte-2uiiyd"><div class="address-info svelte-2uiiyd"><a target="_blank" rel="noopener noreferrer" class="link-style svelte-2uiiyd"> </a></div> <button class="copy-btn" style="padding: 4px 8px; align-self: center;" title="Copy address">📋</button></div> <div class="address-stats svelte-2uiiyd"><div class="call-count svelte-2uiiyd"><span class="count-label">Calls:</span> <span class="count-value"> </span></div></div></div></div>`);
var root_29 = from_html(`<span class="module-name svelte-2uiiyd"> </span>`);
var root_28 = from_html(`<div class="modules-row svelte-2uiiyd"><span class="modules-label svelte-2uiiyd">Modules:</span> <div class="modules-list svelte-2uiiyd"></div></div>`);
var root_27 = from_html(`<div class="package-item svelte-2uiiyd"><div class="package-left svelte-2uiiyd"><div class="package-header svelte-2uiiyd"><div class="package-info svelte-2uiiyd"><div class="package-id-row svelte-2uiiyd"><span class="package-label svelte-2uiiyd">Package:</span> <a target="_blank" rel="noopener noreferrer" class="package-id link-style svelte-2uiiyd"> </a> <button class="copy-btn" style="padding: 4px 8px; align-self: center;" title="Copy package ID">📋</button></div> <!> <div class="sender-row svelte-2uiiyd"><span class="sender-label svelte-2uiiyd">Sender:</span> <a target="_blank" rel="noopener noreferrer" class="sender-address link-style svelte-2uiiyd"> </a> <button class="copy-btn" style="padding: 4px 8px; align-self: center;" title="Copy sender address">📋</button></div></div></div></div> <div class="package-meta svelte-2uiiyd"><div class="version-info"><span class="version-label"> </span></div> <a target="_blank" rel="noopener noreferrer" class="copy-btn tx-btn link-style svelte-2uiiyd">TX</a></div></div>`);
var root_32 = from_html(`<div class="transaction-id-item svelte-2uiiyd"><a target="_blank" rel="noopener noreferrer" class="tx-id link-style svelte-2uiiyd"> </a> <button class="copy-btn" style="padding: 4px 8px; align-self: center;" title="Copy transaction ID">📋</button></div>`);
var root_31 = from_html(`<div class="function-item svelte-2uiiyd"><div class="function-header svelte-2uiiyd"><div class="function-signature svelte-2uiiyd"><div class="address-left svelte-2uiiyd"><div class="address-info svelte-2uiiyd"><span> </span></div> <button class="copy-btn" style="padding: 4px 8px; align-self: center;" title="Copy command type">📋</button></div> <div class="function-actions svelte-2uiiyd"><details class="svelte-2uiiyd"><summary class="svelte-2uiiyd">Txs</summary></details></div> <div class="address-stats svelte-2uiiyd"><div class="call-count svelte-2uiiyd"><span class="count-label">Count:</span> <span class="count-value"> </span></div></div></div></div> <div class="transaction-ids-section svelte-2uiiyd"><div class="transaction-ids-list svelte-2uiiyd"></div></div></div>`);
var root_34 = from_html(`<button class="clear-checkpoint-btn" title="Clear checkpoint selection">✕</button>`);
var root_35 = from_html(`<div class="checkpoint-loading svelte-2uiiyd"><p> </p></div>`);
var root_39 = from_html(`<span class="transaction-digest svelte-2uiiyd"> </span>`);
var root_41 = from_html(`<span class="transaction-digest svelte-2uiiyd"> </span>`);
var root_42 = from_html(`<span> </span>`);
var root_38 = from_html(`<details class="transaction-details svelte-2uiiyd"><summary class="transaction-summary svelte-2uiiyd"><span class="transaction-number svelte-2uiiyd"></span> <!> <!></summary> <div class="transaction-content svelte-2uiiyd"><!></div></details>`);
var root_37 = from_html(`<div class="checkpoint-transactions"><div class="transaction-list svelte-2uiiyd"></div></div>`);
var root_44 = from_html(`<div class="no-transactions svelte-2uiiyd"><p> </p></div>`);
var root_45 = from_html(`<div class="checkpoint-placeholder svelte-2uiiyd"><p>Click on a data point in the chart above or enter a checkpoint
                                number to inspect its transactions</p></div>`);
var root_33 = from_html(`<!> <div class="checkpoint-inspector svelte-2uiiyd"><h4 class="svelte-2uiiyd">Checkpoint Inspector</h4> <div class="checkpoint-input-section svelte-2uiiyd"><label for="checkpoint-input" class="svelte-2uiiyd">Checkpoint Number:</label> <div class="checkpoint-input-container svelte-2uiiyd"><button class="svelte-2uiiyd">&lt;</button> <input id="checkpoint-input" type="number" placeholder="Enter checkpoint number or click on chart" min="0" style="width: 8rem;" class="svelte-2uiiyd"/> <button class="svelte-2uiiyd">&gt;</button></div> <!> <div class="checkpoint-filter-row" style="margin-top: 10px; display: flex; align-items: center; gap: 8px;"><input id="checkpoint-filter-input" type="text" placeholder="Filter transactions by substring (JSON)" style="width: 18rem; font-size: 12px;" class="svelte-2uiiyd"/> <button class="example-btn svelte-2uiiyd" title="Insert example substring">Example</button> <button class="fetch-current-epoch-btn" title="Filter transactions by substring">Filter</button></div> <h5> </h5></div> <!></div>`, 1);
var root_19 = from_html(`<div class="results"><!> <!> <div class="summary-cards svelte-2uiiyd"><div class="summary-card svelte-2uiiyd"><h4 class="svelte-2uiiyd">Total PTBs</h4> <div class="metric svelte-2uiiyd"> </div> </div> <div class="summary-card svelte-2uiiyd"><h4 class="svelte-2uiiyd">Unique Senders</h4> <div class="metric svelte-2uiiyd"> </div></div> <div class="summary-card svelte-2uiiyd"><h4 class="svelte-2uiiyd">Called Functions</h4> <div class="metric svelte-2uiiyd"> </div></div> <div class="summary-card svelte-2uiiyd"><h4 class="svelte-2uiiyd">Published Packages</h4> <div class="metric svelte-2uiiyd"> </div></div></div> <div class="details-section svelte-2uiiyd"><details class="svelte-2uiiyd"><summary class="svelte-2uiiyd"> </summary> <div class="function-list svelte-2uiiyd"></div></details> <details class="svelte-2uiiyd"><summary class="svelte-2uiiyd"> </summary> <div class="address-list svelte-2uiiyd"></div></details> <details class="svelte-2uiiyd"><summary class="svelte-2uiiyd"> </summary> <div class="address-list svelte-2uiiyd"></div></details> <details class="svelte-2uiiyd"><summary class="svelte-2uiiyd"> </summary> <div class="package-list svelte-2uiiyd"></div></details> <details class="svelte-2uiiyd"><summary class="svelte-2uiiyd"> </summary> <div class="command-type-list"><!></div></details></div> <!></div>`);
var root = from_html(`<div class="epoch-transaction-blocks svelte-2uiiyd"><p style="margin-top:0;">Query programmable transaction blocks data for a specific epoch or checkpoint range</p> <div class="input-section svelte-2uiiyd"><div class="filter-section svelte-2uiiyd"><div class="filter-row svelte-2uiiyd"><div class="filter-group svelte-2uiiyd"><label for="input-object-filter" class="svelte-2uiiyd">Input Object:</label> <div class="input-with-button svelte-2uiiyd"><input id="input-object-filter" type="text" placeholder="0x... object ID" class="wide-input svelte-2uiiyd"/> <button class="example-btn svelte-2uiiyd" title="Insert example object ID">Example</button></div></div> <div class="filter-group svelte-2uiiyd"><label for="function-filter" class="svelte-2uiiyd">Function:</label> <div class="input-with-button svelte-2uiiyd"><input id="function-filter" type="text" placeholder="package::module::function" class="wide-input svelte-2uiiyd"/> <button class="example-btn svelte-2uiiyd" title="Insert example function">Example</button></div></div></div></div> <div class="input-row-single svelte-2uiiyd"><div class="mode-selection-column svelte-2uiiyd"><label class="mode-option-stacked svelte-2uiiyd"><span class="mode-label-stacked svelte-2uiiyd">Epoch Number</span> <input type="radio" class="svelte-2uiiyd"/></label> <label class="mode-option-stacked svelte-2uiiyd"><span class="mode-label-stacked svelte-2uiiyd">Checkpoint Range</span> <input type="radio" class="svelte-2uiiyd"/></label></div> <div class="input-controls svelte-2uiiyd"><!></div></div> <div class="button-row svelte-2uiiyd"><button> </button> <div class="input-group svelte-2uiiyd"><label for="transaction-limit">Limit to:</label> <input id="transaction-limit" type="number" placeholder="Max transactions" min="1" style="width: 6rem;"/></div> <button> </button></div></div> <!> <!> <!></div>`);
function PTBs($$anchor, $$props) {
  ...
  function filterCheckpointTransactions() {
    if (!get(checkpointFilterSubstring)) {
      set$1(filteredCheckpointTransactions, []);
      return;
    }
    ...
    set$1(filteredCheckpointTransactions, allTxs.filter((tx) => {
      try {
  ...
  function fetchCheckpointTransactions(checkpoint) {
    ...
    try {
      ...
      set$1(filteredCheckpointTransactions, []);
      set$1(checkpointFilterSubstring, "");
    } catch (err) {
  ...
  function hasPreviousCheckpoint() {
    if (!get(selectedCheckpoint)) return false;
    const current = parseInt(get(selectedCheckpoint));
    return get(displayData).checkpointData.some((cp) => cp.transactionCount > 0 && cp.sequenceNumber < current);
  }
  ...
  function previousCheckpoint() {
    if (!get(selectedCheckpoint)) return;
    const current = parseInt(get(selectedCheckpoint));
    const checkpointsWithTxs = get(displayData).checkpointData.filter((cp) => cp.transactionCount > 0).map((cp) => cp.sequenceNumber).sort((a, b) => a - b);
    const lower = checkpointsWithTxs.filter((num) => num < current).pop();
    if (lower !== void 0) {
      set$1(selectedCheckpoint, lower.toString());
      fetchCheckpointTransactions(get(selectedCheckpoint));
    }
  }
  function nextCheckpoint() {
    ...
    if (higher !== void 0) {
      set$1(selectedCheckpoint, higher.toString());
      fetchCheckpointTransactions(get(selectedCheckpoint));
    }
  }
    ...
    var consequent_24 = ($$anchor2) => {
      ...
      each$1(
        ...
        ($$anchor3, func) => {
          ...
          var a_1 = child(div_37);
          var text_28 = child(a_1);
          ...
          each$1(div_43, 5, () => (get(func), untrack(() => get(func).transactionIds)), index$1, ($$anchor4, txId) => {
            var div_44 = root_24();
            var a_2 = child(div_44);
            var text_33 = child(a_2);
            var button_8 = sibling(a_2, 2);
            template_effect(
              ($0, $1) => {
                set_attribute(a_2, "href", $0);
                set_attribute(a_2, "title", get(txId));
                set_text(text_33, $1);
              },
              [
          ...
          template_effect(
            ($0, $1, $2) => {
              ...
              set_attribute(a_1, "title", (get(func), untrack(() => get(func).package)));
      ...
      each$1(
        ...
        ($$anchor3, sender) => {
          ...
          var a_3 = child(div_49);
          var text_35 = child(a_3);
      ...
      each$1(
        ...
        ($$anchor3, pkg) => {
          ...
          var a_4 = child(div_56);
          var text_38 = child(a_4);
      ...
      each$1(
        ...
        ($$anchor3, pkg) => {
          ...
          var a_5 = sibling(child(div_64), 2);
          var text_41 = child(a_5);
          var button_11 = sibling(a_5, 2);
          ...
          var a_6 = sibling(child(div_67), 2);
          var text_43 = child(a_6);
          var button_12 = sibling(a_6, 2);
          var div_68 = sibling(div_61, 2);
          var div_69 = child(div_68);
          var span_11 = child(div_69);
          var text_44 = child(span_11);
          var a_7 = sibling(div_69, 2);
          template_effect(
            ($0, $1, $2, $3) => {
              ...
              set_attribute(a_7, "href", $2);
              set_attribute(a_7, "title", `View transaction: ${$3 ?? ""}`);
            },
            [
          ...
          each$1(
            ...
            ($$anchor4, cmd) => {
              ...
              each$1(div_80, 5, () => (get(cmd), untrack(() => get(cmd).digests)), index$1, ($$anchor5, txId) => {
                var div_81 = root_32();
                var a_8 = child(div_81);
                var text_48 = child(a_8);
                var button_14 = sibling(a_8, 2);
                template_effect(
                  ($0, $1) => {
                    set_attribute(a_8, "href", $0);
                    set_attribute(a_8, "title", get(txId));
                    set_text(text_48, $1);
                  },
                  [
                    () => (deep_read_state(getTransactionLink), deep_read_state(getSelectedNetworkConfig), get(txId), untrack(() => getTransactionLink(getSelectedNetworkConfig(), get(txId)))),
        ...
        var consequent_23 = ($$anchor3) => {
            ...
            var alternate_10 = ($$anchor4) => {
              ...
              var node_22 = first_child(fragment_6);
              {
                    ...
                    ($$anchor6, tx, index2) => {
                      ...
                      var node_25 = sibling(node_23, 2);
                      {
                        var consequent_20 = ($$anchor7) => {
                          ...
                          template_effect(() => {
                            classes = set_class(span_17, 1, "transaction-status svelte-2uiiyd", null, classes, {
                ...
                if_block(
                  node_22,
                  ($$render) => {
                    if (get(selectedCheckpoint), get(filteredCheckpointTransactions), get(checkpointTransactions), untrack(() => get(selectedCheckpoint) && (get(filteredCheckpointTransactions).length > 0 || get(checkpointTransactions).length > 0))) $$render(consequent_21);
          ...
          template_effect(
            ($0, $1) => {
              ...
              set_text(text_49, `Transactions: ${(get(filteredCheckpointTransactions), get(checkpointFilterSubstring), get(checkpointTransactions), untrack(() => get(filteredCheckpointTransactions).length > 0 || get(checkpointFilterSubstring) ? get(filteredCheckpointTransactions).length : get(checkpointTransactions).length)) ?? ""}`);
            },
            [
              () => (get(selectedCheckpoint), untrack(() => !get(selectedCheckpoint) || !hasPreviousCheckpoint())),
              () => (get(selectedCheckpoint), untrack(() => !get(selectedCheckpoint) || !hasNextCheckpoint()))
            ]
          );
          ...
          bind_value(input_9, () => get(checkpointFilterSubstring), ($$value) => set$1(checkpointFilterSubstring, $$value));
          event("click", button_18, () => set$1(checkpointFilterSubstring, "MoveCall"));
