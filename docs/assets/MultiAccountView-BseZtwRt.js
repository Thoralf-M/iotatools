import { ay as nanoToIota, az as formatNumberWithUnderscores, r as delegate, p as push, a as prop, X as comment, W as first_child, i as if_block, d as append, l as pop, g as get, b as sibling, h as child, t as template_effect, V as set_attribute, c as set_text, z as set_class, q as from_html, m as user_derived, Z as text, k as delegated, u as user_effect, s as set, o as state, H as bind_value, aA as iotaToNano, e as each, w as event, B as getClient, x as bind_select_value, aB as Transaction, aC as IOTA_SYSTEM_STATE_OBJECT_ID, j as index, a5 as bind_group, A as to_array, Q as proxy, a2 as untrack, C as onMount, _ as onDestroy, a8 as set_style, am as bind_checked, N as TransactionView, an as get$1, aD as sharedTransactionExecution, aE as TransactionExecution, L as toBase64, aF as getActiveWallet, aG as requireMainnetTransactionConfirmation, aH as getSelectedChain, aI as sharedMultiAccountCurrency, E as store_get, au as iota_accounts, F as setup_stores, aa as isValidIotaAddress } from "./index-BA3P4jrf.js";
import { u as usePageQueryParams, a as updatePageQueryParams } from "./page-query-params-NAr1QPpD.js";
import { c as calculateGasFee, e as executeTransaction } from "./transaction-execution-PyoxdR1g.js";
import { m as action, g as getTokenAmount, a as getIotaAmount, i as exchangeRateCache, o as setInitialExchangeRateCacheFromBinary, p as exchangeRateCacheBinary, h as fetchAllExchangeRates } from "./utils-D1BKWAv9.js";
import { c as computeStakingRewards } from "./staking-utils-Bma6pmR2.js";
import { b as bind_this } from "./this-228TeyyA.js";
import { C as Chart } from "./auto-sd7q3vNv.js";
import { p as plugin } from "./chartjs-plugin-zoom.esm-BAaqFnPU.js";
import "./dynamic-fields-_Zm25KCO.js";
...
var root_8$1 = from_html(`<button class="optimize svelte-1nc09ne" title="Show better alternatives">Optimize</button>`);
...
var root_10$3 = from_html(`<div style="position: absolute; left: 0; top: 0; height: 1.2rem; display: flex; align-items: center; font-size: 0.7rem; color: #f59e0b; pointer-events: none;"> </div>`);
...
delegate(["click"]);
var root_1$5 = from_html(`<div class="stake-row svelte-csbsq3"><span class="stake-label svelte-csbsq3" title="Liquid IOTA available to stake"> </span> <input class="stake-input svelte-csbsq3" type="text" inputmode="decimal" aria-label="Stake amount in IOTA"/> <button class="stake-btn svelte-csbsq3"> </button></div>`);
...
var root_10$2 = from_html(`<div style="text-align: center; color: var(--text-muted); padding: 1rem; font-size: 0.8rem;">No objects match filter</div>`);
...
var root_8 = from_html(`<div class="object-list svelte-csbsq3"><!> <!> <!></div>`);
...
function AccountCard($$anchor, $$props) {
  push($$props, true);
  let typeFilter = prop($$props, "typeFilter", 3, ""), currentPrice = prop($$props, "currentPrice", 3, null), selectedCurrency = prop($$props, "selectedCurrency", 3, "USD");
  ...
  var node = sibling(div_1, 2);
  {
    var consequent = ($$anchor2) => {
      ...
      template_effect(
        ...
        [
          () => formatNumberWithUnderscores(nanoToIota(get(liquidIotaNano).toString())),
          () => get(stakeAmountValid) && get(stakeAmountNano) !== null ? ` ${formatNumberWithUnderscores(nanoToIota(get(stakeAmountNano).toString()))} IOTA` : ""
        ]
      );
...
var root_10$1 = from_html(`<span class="stake-group stake-row-item svelte-w4m6sy"><button type="button"> </button> <!></span>`);
...
function StakingTrendChart($$anchor, $$props) {
  ...
  var node_8 = sibling(div_9, 2);
  {
    var consequent_10 = ($$anchor2) => {
      ...
      var strong = sibling(child(div_11), 2);
      var text_13 = child(strong);
      var strong_1 = sibling(strong, 2);
      var text_14 = child(strong_1);
      var node_9 = sibling(strong_1, 2);
      {
        var consequent_9 = ($$anchor3) => {
          var fragment_4 = root_18();
          var strong_2 = sibling(first_child(fragment_4));
          var text_15 = child(strong_2);
          var span_4 = sibling(strong_2, 2);
          var text_16 = child(span_4);
          template_effect(
            ($0, $1) => {
              set_text(text_15, get(switchTarget).name);
              set_text(text_16, `APR ${$0 ?? ""} · APY ${$1 ?? ""}${get(pendingYearlyText) ? ` · ≈ ${get(pendingYearlyText)}` : ""}`);
            },
            [
      ...
      var button_10 = child(div_12);
      var button_11 = sibling(button_10, 2);
      var text_17 = child(button_11);
      template_effect(
        ($0) => {
          set_text(text_13, `${$0 ?? ""} IOTA`);
          set_text(text_14, pendingNewStake().accountLabel);
          button_11.disabled = !get(switchTarget) || !$$props.onStakeNew;
          set_attribute(button_11, "title", get(switchTarget) ? `Stake to ${get(switchTarget).name}` : "Pick a target validator first");
          set_text(text_17, `Stake${get(switchTarget) ? ` → ${get(switchTarget).name}` : ""}`);
        },
        [() => nanoToIota(pendingNewStake().amountNano.toString())]
      );
      delegated("click", button_10, handleCancelNewStake);
      delegated("click", button_11, handleConfirmNewStake);
      append($$anchor2, div_10);
    };
    if_block(node_8, ($$render) => {
      if (pendingNewStake()) $$render(consequent_10);
    });
  }
  var div_13 = sibling(node_8, 2);
  var canvas_1 = child(div_13);
  ...
  var node_10 = sibling(div_13, 2);
  {
    var consequent_13 = ($$anchor2) => {
      ...
      var text_18 = child(div_15);
      var div_16 = sibling(div_15, 2);
      var div_17 = child(div_16);
      var div_18 = sibling(child(div_17), 2);
      var text_19 = child(div_18);
      var div_19 = sibling(div_18, 2);
      var text_20 = child(div_19);
      var div_20 = sibling(div_17, 2);
      var div_21 = child(div_20);
      var node_11 = sibling(child(div_21));
      {
        var consequent_11 = ($$anchor3) => {
          var span_6 = root_21();
          var text_21 = child(span_6);
          template_effect(
            ($0) => set_text(text_21, `${get(switchTarget).name ?? ""} · effective commission
                                ${$0 ?? ""}`),
            [
        ...
        if_block(node_11, ($$render) => {
          if (get(switchTarget)) $$render(consequent_11);
        });
      }
      ...
      var node_12 = child(div_27);
      {
        ...
        var alternate_3 = ($$anchor3) => {
          var text_26 = text();
          template_effect(($0) => set_text(text_26, `≈ ${$0 ?? ""} days`), [() => Math.ceil(get(projectionBreakeven))]);
          append($$anchor3, text_26);
        };
        if_block(node_12, ($$render) => {
          if (get(projectionBreakeven) === null) $$render(consequent_12);
          else $$render(alternate_3, -1);
        });
      }
      var div_28 = sibling(div_27, 2);
      var text_27 = child(div_28);
      var div_29 = sibling(div_16, 2);
      var button_12 = child(div_29);
      var text_28 = child(button_12);
      var div_30 = sibling(div_29, 2);
      var text_29 = child(div_30);
      template_effect(
        ($0, $1, $2, $3, $4, $5) => {
          set_text(text_18, `Numbers below are derived from the selected timeframe (${get(windowDays) ?? ""} epochs ≈
          ...
          set_text(text_19, $0);
          set_text(text_20, `APY ${$1 ?? ""} · ${$2 ?? ""}`);
          set_text(text_22, $3);
          set_text(text_23, $4);
          classes_5 = set_class(div_25, 1, "value svelte-w4m6sy", null, classes_5, { highlight: get(switchTargetApr) > get(combinedOldApr) });
          set_text(text_24, $5);
          set_text(text_27, `${ACTIVATION_DELAY_DAYS} epoch activation delay · based on
                        ${get(windowDays) ?? ""}-day window`);
          button_12.disabled = !get(switchTarget) || get(projectionBreakeven) === null || get(selectedStakeRefs).length === 0 || !$$props.onSwitch;
          set_attribute(button_12, "title", !get(switchTarget) ? "Pick a switch target first." : get(projectionBreakeven) === null ? "Switching to this validator would not be profitable in the chosen window." : `Build one PTB per sending account: ${get(switchTxCount)} transaction(s) covering ${get(selectedStakeRefs).length} stake(s), all re-staked to ${get(switchTarget).name}.`);
          set_text(text_28, `Switch ${get(selectedStakeRefs).length === 1 ? "1 stake" : `${get(selectedStakeRefs).length} stakes`} in ${get(switchTxCount) === 1 ? "1 transaction" : `${get(switchTxCount)} transactions`}`);
          set_text(text_29, `The protocol activates new stakes at the next epoch boundary, so switched principal
      ...
      delegated("click", button_12, handleSwitch);
      append($$anchor2, div_14);
    };
    if_block(node_10, ($$render) => {
      if (get(mode) === "my-stake" && get(selectedStakeRefs).length > 0) $$render(consequent_13);
    });
  }
...
function MultiAccountView($$anchor, $$props) {
  ...
  async function executeStake(accountAddress, amountNano, target) {
    if (amountNano <= 0n) {
      set(
        transactionResults,
        [
          { error: "Stake amount must be > 0.", sender: accountAddress }
        ],
        true
      );
      return;
    ...
    try {
      ...
      set(transactionResults, [result], true);
      set(pendingNewStake, null);
    } catch (err) {
      set(transactionResults, [{ error: err.toString(), sender: accountAddress }], true);
      console.error(err);
    }
  }
  ...
  var node_5 = sibling(node_4, 2);
  {
    var consequent_2 = ($$anchor2) => {
      ...
      var node_6 = sibling(label, 4);
      each(node_6, 17, () => get(extendedAccounts), (a) => a.id, ($$anchor3, a) => {
  ...
  each(node_7, 17, () => get(visibleAccounts), (account) => account.id, ($$anchor2, account) => {
    {
  ...
  var node_8 = sibling(node_7, 2);
  {
    var consequent_5 = ($$anchor2) => {
      var div_4 = root_6();
      var node_9 = sibling(child(div_4));
      {
        var consequent_3 = ($$anchor3) => {
  ...
  var node_10 = sibling(div_3, 2);
  {
    var consequent_7 = ($$anchor2) => {
      ...
      var node_11 = sibling(first_child(fragment_1), 2);
      {
        let $0 = user_derived(() => get(validators).length || void 0);
        StakingControls(node_11, {
          get loading() {
