import { aT as getContext, aU as setContext, p as push, r as prop, i as init, I as comment, G as first_child, b as if_block, N as store_get, k as append, l as pop, Q as setup_stores, f as from_html, c as child, t as template_effect, L as set_class, e as event, aV as store_set, U as writable, u as onMount, w as legacy_pre_effect, j as set, m as mutable_source, x as deep_read_state, y as legacy_pre_effect_reset, s as sibling, z as each, A as index, g as get, C as untrack, a6 as derived_safe_equal, d as set_text, ae as clsx, as as to_array, aW as component, aX as spread_props, aY as readable, a8 as iotaBcs, at as TransactionDataBuilder } from "/iota-utils/assets/index-BgEVLtK2.js";
...
function getTransactionData(data) {
  ...
  if (data && data.effects) {
    ...
    const normalized = {
      ...
      sender: ((_H = (_G = data == null ? void 0 : data.transaction) == null ? void 0 : _G.data) == null ? void 0 : _H.sender) || data.sender || ((_I = data.input) == null ? void 0 : _I.sender),
      objectChanges,
      effects: {
        // Selectively include effects properties, excluding created/mutated to avoid conflicts
        transactionDigest: (_J = data.effects) == null ? void 0 : _J.transactionDigest,
        status: (_K = data.effects) == null ? void 0 : _K.status,
        executedEpoch: (_L = data.effects) == null ? void 0 : _L.executedEpoch,
        gasUsed: (_M = data.effects) == null ? void 0 : _M.gasUsed,
        modifiedAtVersions: (_N = data.effects) == null ? void 0 : _N.modifiedAtVersions,
        sharedObjects: (_O = data.effects) == null ? void 0 : _O.sharedObjects,
        dependencies: (_P = data.effects) == null ? void 0 : _P.dependencies,
        messageVersion: (_Q = data.effects) == null ? void 0 : _Q.messageVersion,
        gasObject: (_R = data.effects) == null ? void 0 : _R.gasObject,
        eventsDigest: (_S = data.effects) == null ? void 0 : _S.eventsDigest,
        checkpoint: data.effects.checkpoint || {
          sequenceNumber: (_T = data.effects) == null ? void 0 : _T.executedEpoch,
          timestamp: null
        },
