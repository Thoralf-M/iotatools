import { w as getSelectedNetworkConfig, af as Transaction, o as getClient, at as toHex, aZ as IOTA_CLOCK_OBJECT_ID, p as push, i as init, f as from_html, s as sibling, c as child, g as get, m as mutable_source, n as set, b as if_block, x as bind_value, k as append, l as pop, v as setup_stores, r as store_get, H as each, K as comment, J as first_child, t as template_effect, e as set_text, I as index, ab as activeAddress, B as delegate } from "./index-BCMJXB-v.js";
...
function IotaNames($$anchor, $$props) {
  ...
  let localIotaNamesPackageId = mutable_source(IOTA_NAMES_PACKAGE_ID);
  ...
  button.__click = () => {
    set(localIotaNamesPackageId, MAINNET_PACKAGE_ID);
    setMainnetPackageId();
  };
  var button_1 = sibling(button, 2);
  button_1.__click = () => {
    set(localIotaNamesPackageId, TESTNET_PACKAGE_ID);
    setTestnetPackageId();
  };
  var button_2 = sibling(button_1, 2);
  button_2.__click = () => {
    set(localIotaNamesPackageId, DEVNET_PACKAGE_ID);
    setDevnetPackageId();
  };
  ...
  var node = sibling(span_2, 6);
  {
    var consequent_1 = ($$anchor2) => {
      ...
      each(
        ...
        1,
        () => [
          ["Payments", PAYMENTS_PACKAGE_ID],
          ["Subname", SUBNAME_PACKAGE_ID],
          ["Subname Proxy", SUBNAME_PROXY_PACKAGE_ID],
          ["Auction", AUCTION_PACKAGE_ID],
          ["Coupons", COUPONS_PACKAGE_ID]
        ],
        index,
        ($$anchor3, item) => {
      ...
      template_effect(() => set_text(text, `IotaNames Object ID: ${IOTA_NAMES_OBJECT_ID ?? ""} `));
  ...
  var node_3 = sibling(node, 2);
  {
    var consequent_2 = ($$anchor2) => {
      var button_3 = root_4();
      button_3.__click = handleCancelFetch;
      append($$anchor2, button_3);
    };
    var alternate = ($$anchor2) => {
      var button_4 = root_5();
      button_4.__click = handleListRegisteredNames;
  ...
  button_5.__click = handleGetReverseRegisteredAddresses;
  var button_6 = sibling(button_5, 2);
  button_6.__click = handleToggleIotaNamesIds;
  var button_7 = sibling(button_6, 2);
  button_7.__click = handleGetDynamicFields;
  var button_8 = sibling(button_7, 4);
  button_8.__click = handleGetRegistryEntry;
  var button_9 = sibling(button_8, 2);
  button_9.__click = handleResolveName;
  var button_10 = sibling(button_9, 2);
  button_10.__click = handleResolveAddress;
  var button_11 = sibling(button_10, 4);
  button_11.__click = handleRegisterName;
  var button_12 = sibling(button_11, 2);
  button_12.__click = handleSetTargetAddress;
  var button_13 = sibling(button_12, 2);
  button_13.__click = handleSetReverseLookup;
  var span_3 = sibling(button_13, 4);
  var input_3 = sibling(child(span_3));
  var button_14 = sibling(span_3, 2);
  button_14.__click = handleStartAuctionAndPlaceBid;
  var button_15 = sibling(button_14, 2);
  button_15.__click = handlePlaceBid;
  var button_16 = sibling(button_15, 2);
  button_16.__click = handleClaim;
  var button_17 = sibling(button_16, 2);
  button_17.__click = handleListAuctions;
  var node_4 = sibling(button_17, 2);
