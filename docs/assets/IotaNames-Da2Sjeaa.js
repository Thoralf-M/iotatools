import { p as push, i as init, f as from_html, s as sibling, c as child, n as set, m as mutable_source, b as if_block, g as get, x as bind_value, k as append, l as pop, v as setup_stores, ai as Transaction, o as getClient, al as toHEX, $ as isValidIotaAddress, w as getSelectedNetworkConfig, b2 as IOTA_CLOCK_OBJECT_ID, u as store_get, H as each, K as comment, J as first_child, t as template_effect, e as set_text, I as index, ab as activeAddress, B as delegate } from "./index-XL7x2wrT.js";
...
var root = from_html(`<main><span>IotaNames package id (default for testnet): <input placeholder="package id 0x..." size="67"/> <button class="svelte-1jz9w8h">Testnet</button> <button class="svelte-1jz9w8h">Devnet</button> <button class="svelte-1jz9w8h">Mainnet</button></span> <br/> <br/> <span>address: <input placeholder="address 0x..." size="67"/></span> <span>name: <input placeholder="name.iota"/></span> <br/> <br/> <!> General information: <button class="svelte-1jz9w8h">list registered names</button> <button class="svelte-1jz9w8h">get reverse registered addresses</button> <button class="svelte-1jz9w8h">show package ids</button> <button class="svelte-1jz9w8h">get dynamic fields</button> <hr/> Resolver: <button class="svelte-1jz9w8h">get registry entry (by name)</button> <button class="svelte-1jz9w8h">resolve name (by address)</button> <button class="svelte-1jz9w8h">resolve address (by name)</button> <hr/> Tx actions: <button class="svelte-1jz9w8h">register name</button> <button class="svelte-1jz9w8h">set target address</button> <button class="svelte-1jz9w8h">set reverse lookup</button> <hr/> Auction: <span>bid price: <input type="number" placeholder="0" style="width: 14rem;"/></span> <button class="svelte-1jz9w8h">start auction and place bid</button> <button class="svelte-1jz9w8h">place bid</button> <button class="svelte-1jz9w8h">claim</button> <button class="svelte-1jz9w8h">list auctions</button> <!></main>`);
function IotaNames($$anchor, $$props) {
  ...
  let IOTA_NAMES_PACKAGE_ID = mutable_source(TESTNET_PACKAGE_ID);
  ...
  const getRegistryEntry = async () => {
    try {
      let client = getClient();
      let result = await client.iotaNamesLookup({ name: get(nameName) });
      console.log(result);
      set(value, result || "No registry entry found");
    } catch (err) {
      set(value, err.toString());
      console.error(err);
    }
  ...
  button.__click = () => {
    set(IOTA_NAMES_PACKAGE_ID, TESTNET_PACKAGE_ID);
    set(IOTA_NAMES_OBJECT_ID, "");
    set(PAYMENTS_PACKAGE_ID, "");
    set(SUBNAME_PACKAGE_ID, "");
    set(SUBNAME_PROXY_PACKAGE_ID, "");
  ...
  button_1.__click = () => {
    set(IOTA_NAMES_PACKAGE_ID, DEVNET_PACKAGE_ID);
    set(IOTA_NAMES_OBJECT_ID, "");
    set(PAYMENTS_PACKAGE_ID, "");
    set(SUBNAME_PACKAGE_ID, "");
    set(SUBNAME_PROXY_PACKAGE_ID, "");
  ...
  button_2.__click = () => {
    set(IOTA_NAMES_PACKAGE_ID, MAINNET_PACKAGE_ID);
    set(IOTA_NAMES_OBJECT_ID, "");
    set(PAYMENTS_PACKAGE_ID, "");
    set(SUBNAME_PACKAGE_ID, "");
    set(SUBNAME_PROXY_PACKAGE_ID, "");
  ...
  button_3.__click = listRegisteredNames;
  var button_4 = sibling(button_3, 2);
  button_4.__click = getReverseRegisteredAddresses;
  var button_5 = sibling(button_4, 2);
  button_5.__click = toggleIotaNamesIds;
  var button_6 = sibling(button_5, 2);
  button_6.__click = getDynamicFields;
  var button_7 = sibling(button_6, 4);
  button_7.__click = getRegistryEntry;
  var button_8 = sibling(button_7, 2);
  button_8.__click = resolveName;
  var button_9 = sibling(button_8, 2);
  button_9.__click = resolveAddress;
  var button_10 = sibling(button_9, 4);
  button_10.__click = registerName;
  var button_11 = sibling(button_10, 2);
  button_11.__click = setTargetAddress;
  var button_12 = sibling(button_11, 2);
  button_12.__click = setReverseLookup;
  var span_3 = sibling(button_12, 4);
  var input_3 = sibling(child(span_3));
  var button_13 = sibling(span_3, 2);
  button_13.__click = startAuctionAndPlaceBid;
  var button_14 = sibling(button_13, 2);
  button_14.__click = placeBid;
  var button_15 = sibling(button_14, 2);
  button_15.__click = claim;
  var button_16 = sibling(button_15, 2);
  button_16.__click = listAuctions;
  var node_3 = sibling(button_16, 2);
