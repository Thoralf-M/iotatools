import { ax as formatNumberWithUnderscores, ay as nanoToIota, r as delegate, p as push, a as prop, X as comment, W as first_child, i as if_block, d as append, l as pop, g as get, b as sibling, h as child, t as template_effect, V as set_attribute, c as set_text, z as set_class, q as from_html, m as user_derived, Z as text, k as delegated, e as each, w as event, B as getClient, x as bind_select_value, az as Transaction, aA as IOTA_SYSTEM_STATE_OBJECT_ID, j as index, a5 as bind_group, A as to_array, o as state, Q as proxy, u as user_effect, s as set, a2 as untrack, C as onMount, _ as onDestroy, a8 as set_style, H as bind_value, am as bind_checked, N as TransactionView, ap as get$1, aB as sharedTransactionExecution, aC as TransactionExecution, L as toBase64, aD as getActiveWallet, aE as requireMainnetTransactionConfirmation, aF as getSelectedChain, F as setup_stores, aa as isValidIotaAddress, E as store_get, at as iota_accounts } from "./index-BrIr3B5H.js";
import { c as calculateGasFee, e as executeTransaction } from "./transaction-execution-D4LvztTr.js";
import { m as action, g as getTokenAmount, a as getIotaAmount, i as exchangeRateCache, o as setInitialExchangeRateCacheFromBinary, p as exchangeRateCacheBinary, h as fetchAllExchangeRates } from "./utils-CjQRPdND.js";
import { c as computeStakingRewards } from "./staking-utils-Bw6UuNAq.js";
import { b as bind_this } from "./this-CCjd1uAa.js";
import { C as Chart } from "./auto-sd7q3vNv.js";
import { p as plugin } from "./chartjs-plugin-zoom.esm-BAaqFnPU.js";
import "./dynamic-fields-il5Pkz7r.js";
...
function objectDisplayAmount(item) {
...
var root_1$6 = from_html(`<div class="object-item svelte-1nc09ne" style="border-color: rgba(248, 113, 113, 0.3);"><div class="object-header svelte-1nc09ne"><span class="object-type svelte-1nc09ne"><!></span> <span class="object-amount svelte-1nc09ne"> </span></div> <details class="object-details svelte-1nc09ne"><summary class="svelte-1nc09ne">Data</summary> <pre class="svelte-1nc09ne"> </pre></details></div>`);
var root_8 = from_html(`<button class="optimize svelte-1nc09ne" title="Show better alternatives">Optimize</button>`);
var root_9$2 = from_html(`<button class="optimize quiet svelte-1nc09ne" title="Compare alternatives">Compare</button>`);
var root_7$2 = from_html(`<div><span class="validator svelte-1nc09ne"> </span> <span class="metric svelte-1nc09ne"> </span> <!></div>`);
...
function ObjectItem($$anchor, $$props) {
  push($$props, true);
  let variant = prop($$props, "variant", 3, "standard"), currentPrice = prop($$props, "currentPrice", 3, null), selectedCurrency = prop($$props, "selectedCurrency", 3, "USD");
  let isForeign = user_derived(() => variant() === "standard" && $$props.accountAddress !== $$props.item.currentOwner);
  let amountDisplay = user_derived(() => objectDisplayAmount($$props.item));
...
delegate(["click"]);
var root_4$3 = from_html(`<div style="text-align: center; color: var(--text-muted); padding: 1rem; font-size: 0.8rem;">No stakes</div>`);
var root_5$2 = from_html(`<div style="margin-top: 0.5rem; border-top: 1px solid var(--border-color); padding-top: 0.5rem;"><div style="font-size: 0.8rem; color: #f87171; margin-bottom: 0.25rem;" title="Timelocked stakes are intentionally excluded from optimization. Unlock them first to switch validator.">Timelocked (no optimization)</div> <!></div>`);
var root_2$4 = from_html(`<div class="object-list svelte-csbsq3"><!> <!> <!></div>`);
var root_9$1 = from_html(`<div style="text-align: center; color: var(--text-muted); padding: 1rem; font-size: 0.8rem;">No objects</div>`);
var root_10$1 = from_html(`<div style="margin-top: 0.5rem; border-top: 1px solid var(--border-color); padding-top: 0.5rem;"><div style="font-size: 0.8rem; color: #f87171; margin-bottom: 0.25rem;">Timelocked</div> <!></div>`);
var root_7$1 = from_html(`<div class="object-list svelte-csbsq3"><!> <!> <!></div>`);
var root$6 = from_html(`<div class="account-card svelte-csbsq3"><div class="account-header svelte-csbsq3"><div style="display: flex; flex-direction: column;"><div style="display: flex; align-items: center; gap: 0.5rem;"><span class="account-title svelte-csbsq3"> </span> <button style="font-size: 0.7rem; padding: 0.1rem 0.3rem; width: fit-content; background: var(--secondary-color); border-radius: 3px;">Copy Address</button></div> <div class="account-buttons svelte-csbsq3" style="display: flex; gap: 0.5rem; margin-top: 0.2rem;"><button style="font-size: 0.7rem; padding: 0.1rem 0.3rem; width: fit-content; border-radius: 3px;"> </button></div></div> <div style="text-align: right; display: flex; flex-direction: column; align-items: flex-end; gap: 0.2rem;"><button class="danger svelte-csbsq3" style="font-size: 0.7rem; padding: 0.1rem 0.3rem; width: fit-content; border-radius: 3px;">Remove</button> <div class="account-balance svelte-csbsq3"> <span style="font-size: 0.8em; color: var(--text-muted);">IOTA</span></div></div></div> <!></div>`);
function AccountCard($$anchor, $$props) {
  ...
  let stakeOnlyObjects = user_derived(() => $$props.account.objects.filter(isStakeObject));
  let stakeOnlyTimelocked = user_derived(() => $$props.account.timelockedObjects.filter(isStakeObject));
  var div = root$6();
  var div_1 = child(div);
  ...
  var node = sibling(div_1, 2);
  {
    var consequent_5 = ($$anchor2) => {
      ...
      var node_1 = first_child(fragment);
      {
        var consequent_2 = ($$anchor3) => {
          ...
          each(node_2, 17, () => get(stakeOnlyObjects), (item) => item.id, ($$anchor4, item) => {
            {
          ...
          var node_3 = sibling(node_2, 2);
          {
            ...
            if_block(node_3, ($$render) => {
              if (get(stakeOnlyObjects).length === 0 && get(stakeOnlyTimelocked).length === 0) $$render(consequent);
            });
          }
          var node_4 = sibling(node_3, 2);
          {
            var consequent_1 = ($$anchor4) => {
              ...
              each(node_5, 17, () => get(stakeOnlyTimelocked), (item) => item.id, ($$anchor5, item) => {
                ObjectItem($$anchor5, {
                  get item() {
                    return get(item);
                  },
            ...
            if_block(node_4, ($$render) => {
              if (get(stakeOnlyTimelocked).length !== 0) $$render(consequent_1);
            });
          }
        ...
        var alternate = ($$anchor3) => {
          ...
          each(node_6, 17, () => $$props.account.objects, (item) => item.id, ($$anchor4, item) => {
            ObjectItem($$anchor4, {
              get item() {
                return get(item);
              },
          ...
          var node_7 = sibling(node_6, 2);
          {
            ...
            if_block(node_7, ($$render) => {
              if ($$props.account.objects.length === 0 && $$props.account.timelockedObjects.length === 0) $$render(consequent_3);
            });
          }
          var node_8 = sibling(node_7, 2);
          {
            var consequent_4 = ($$anchor4) => {
              ...
              each(node_9, 17, () => $$props.account.timelockedObjects, (item) => item.id, ($$anchor5, item) => {
                ObjectItem($$anchor5, {
                  get item() {
                    return get(item);
                  },
            ...
            if_block(node_8, ($$render) => {
              if ($$props.account.timelockedObjects.length !== 0) $$render(consequent_4);
            });
          }
          action(div_10, ($$node, $$action_arg) => dragHandleZone?.($$node, $$action_arg), () => ({ items: $$props.account.objects, flipDurationMs: 200 }));
          event("consider", div_10, function(...$$args) {
            $$props.onDnd?.apply(this, $$args);
          });
          event("finalize", div_10, function(...$$args) {
            $$props.onDnd?.apply(this, $$args);
          });
          append($$anchor3, div_10);
        };
        if_block(node_1, ($$render) => {
          if ($$props.stakingMode) $$render(consequent_2);
          else $$render(alternate, -1);
        });
      }
    ...
    if_block(node, ($$render) => {
      if (!$$props.account.isCollapsed) $$render(consequent_5);
    });
  }
  template_effect(
    ($0) => {
      ...
      set_text(text_1, `${$$props.account.isCollapsed ? "▶ Expand" : "▼ Collapse"} (${get(objectCount) ?? ""})`);
      set_text(text_2, `${$0 ?? ""} `);
    },
    [
      () => formatNumberWithUnderscores(nanoToIota(get(totalBalance).toString()))
    ]
  );
...
var root_1$5 = from_html(`<tr class="total-row" style="background: rgba(16, 185, 129, 0.1);"><td class="svelte-70k3q2"><strong>Total</strong></td><td class="svelte-70k3q2"><strong> </strong></td><td class="svelte-70k3q2"><strong> </strong></td></tr> <tr><td class="svelte-70k3q2">IOTA Coins</td><td class="svelte-70k3q2"> </td><td class="svelte-70k3q2"> </td></tr>`, 1);
var root$5 = from_html(`<div class="summary-section"><div class="summary-header svelte-70k3q2"><h3 class="svelte-70k3q2">Balance Breakdown</h3> <div class="price-controls svelte-70k3q2"><select class="svelte-70k3q2"><option>USD</option><option>EUR</option></select> <button class="svelte-70k3q2">Fetch Price</button></div></div> <div class="table-wrapper"><table class="summary-table svelte-70k3q2"><thead><tr><th class="svelte-70k3q2">Category</th><th class="svelte-70k3q2">Amount (IOTA)</th><th class="svelte-70k3q2"> </th></tr></thead><tbody><!><tr><td class="svelte-70k3q2">Staked</td><td class="svelte-70k3q2"> </td><td class="svelte-70k3q2"> </td></tr><tr><td class="svelte-70k3q2">Staking Rewards</td><td class="svelte-70k3q2"> </td><td class="svelte-70k3q2"> </td></tr></tbody></table></div></div>`);
function BalanceSummary($$anchor, $$props) {
  push($$props, true);
  let selectedCurrency = prop($$props, "selectedCurrency", 15), currentPrice = prop($$props, "currentPrice", 15);
  ...
  var node = child(tbody);
  {
    var consequent = ($$anchor2) => {
      ...
      template_effect(
        ...
        [
          ...
          () => formatNumberWithUnderscores(nanoToIota(get(totalIotaCoins).toString())),
    ...
    if_block(node, ($$render) => {
      if (!$$props.stakingMode) $$render(consequent);
    });
  }
  var tr_3 = sibling(node);
  ...
  template_effect(
    ($0, $1, $2, $3) => {
      set_text(text2, `Value (${selectedCurrency() ?? ""})`);
      set_text(text_5, $0);
      set_text(text_6, $1);
      set_text(text_7, $2);
      set_text(text_8, $3);
    ...
    [
      () => formatNumberWithUnderscores(nanoToIota(get(totalStaked).toString())),
      () => fiat(get(totalStaked)),
      () => formatNumberWithUnderscores(nanoToIota(get(totalRewards).toString())),
...
var root_2$3 = from_html(`<span class="status svelte-e9ngkt">Loading staking data…</span>`);
var root_3$2 = from_html(`<span class="status svelte-e9ngkt"> </span>`);
var root_4$2 = from_html(`<span class="status error svelte-e9ngkt"> </span>`);
...
var root_6$1 = from_html(`<option> </option>`);
...
var root_10 = from_html(`<span class="stake-group stake-row-item svelte-w4m6sy"><button type="button"> </button> <!></span>`);
var root_12 = from_html(`<option> </option>`);
var root_13 = from_html(`<span class="row-hint svelte-w4m6sy"> </span>`);
...
var root_16 = from_html(`<span class="breakeven-pill svelte-w4m6sy"> </span>`);
var root_15 = from_html(`<div class="legend-hint svelte-w4m6sy"> <strong>two projection lines</strong>: the dashed,
...
function StakingTrendChart($$anchor, $$props) {
  ...
  let currentPrice = prop($$props, "currentPrice", 3, null), selectedCurrency = prop($$props, "selectedCurrency", 3, "USD"), focusStakeRequest = prop($$props, "focusStakeRequest", 15, null);
  ...
  user_effect(() => {
    ...
    if (get(switchTargetAddress)) {
      const target = $$props.validators.find((v) => v.address === get(switchTargetAddress));
      if (target) {
        const userPools = new Set($$props.userStakes.filter((s) => get(selectedStakeIds).has(s.stakeId)).map((s) => s.validator.poolId));
        if (userPools.has(target.poolId)) {
          set(switchTargetAddress, "");
          switchTargetTouched = false;
        }
      }
    }
    if (switchTargetTouched) return;
    if (get(switchTargetAddress)) return;
    ...
    if (better) set(switchTargetAddress, better.v.address, true);
  });
  ...
  let targetCandidates = user_derived(() => {
    const myPools = new Set($$props.userStakes.filter((s) => get(selectedStakeIds).has(s.stakeId)).map((s) => s.validator.poolId));
    return $$props.validators.filter((v) => v.isCommittee && !myPools.has(v.poolId)).sort((a, b) => ($$props.aprByPool.get(b.poolId) ?? 0) - ($$props.aprByPool.get(a.poolId) ?? 0));
  });
  let targetIndex = user_derived(() => get(targetCandidates).findIndex((v) => v.address === get(switchTargetAddress)));
  function prevTarget() {
    ...
    set(switchTargetAddress, get(targetCandidates)[wrapped].address, true);
  ...
  let switchTarget = user_derived(() => get(switchTargetAddress) ? $$props.validators.find((v) => v.address === get(switchTargetAddress)) ?? null : null);
  ...
  function buildMyStakeDatasets() {
    ...
    const target = get(switchTargetAddress) ? $$props.validators.find((v) => v.address === get(switchTargetAddress)) : null;
  ...
  function chartOptions() {
    ...
    const principalIota = isStakeMode ? $$props.userStakes.filter((s) => get(selectedStakeIds).has(s.stakeId)).reduce((sum, s) => sum + Number(s.principal) / 1e9, 0) : 0;
  ...
  var node_1 = child(div_2);
  {
    ...
    var consequent_6 = ($$anchor2) => {
      ...
      each(div_6, 21, () => get(stakeGroups), (g) => g.validator.address, ($$anchor3, g) => {
        ...
        var node_2 = first_child(fragment_3);
        {
          var consequent_4 = ($$anchor4) => {
            ...
            template_effect(
              ($0, $1, $2, $3, $4, $5) => {
                classes_2 = set_class(button_4, 1, "chip stake-row-item svelte-w4m6sy", null, classes_2, $0);
                set_style(button_4, `--commission-tint: ${$1 ?? ""}`);
                set_attribute(button_4, "title", `${get(g).validator.name ?? ""} — ${$2 ?? ""} · effective commission ${$3 ?? ""} · click to toggle`);
                set_text(text_5, `${get(g).validator.name ?? ""} · ${$4 ?? ""} · ${$5 ?? ""}`);
              },
              [
            ...
            delegated("click", button_4, () => toggleStake(get(s).stakeId));
          ...
          var alternate_1 = ($$anchor4) => {
            ...
            each(node_3, 17, () => get(g).stakes, (s) => s.stakeId, ($$anchor5, s) => {
              var button_6 = root_11();
              let classes_4;
              var text_7 = child(button_6);
              template_effect(
                ($0, $1, $2) => {
                  classes_4 = set_class(button_6, 1, "chip stake-sub-chip svelte-w4m6sy", null, classes_4, $0);
                  set_attribute(button_6, "title", `Click to toggle this single stake (${$1 ?? ""} IOTA)`);
                  set_text(text_7, $2);
                },
                [
                  () => ({ selected: get(selectedStakeIds).has(get(s).stakeId) }),
              ...
              delegated("click", button_6, () => toggleStake(get(s).stakeId));
              append($$anchor5, button_6);
            });
            template_effect(
              ($0, $1, $2, $3, $4) => {
                classes_3 = set_class(button_5, 1, "chip group-toggle svelte-w4m6sy", null, classes_3, {
                  all: get(state2) === "all",
                  partial: get(state2) === "partial"
                });
                set_style(button_5, `--commission-tint: ${$0 ?? ""}`);
                set_attribute(button_5, "title", `Toggle all ${get(g).stakes.length ?? ""} stakes at ${get(g).validator.name ?? ""} (${$1 ?? ""} total · effective commission ${$2 ?? ""})`);
                set_text(text_6, `${get(g).validator.name ?? ""} · ${get(g).stakes.length ?? ""} stakes · ${$3 ?? ""} · ${$4 ?? ""}`);
              },
              [
                () => commissionTint(get(g).validator),
            ...
            delegated("click", button_5, () => toggleGroup(get(g)));
            append($$anchor4, span_1);
          };
          if_block(node_2, ($$render) => {
            if (get(g).stakes.length === 1) $$render(consequent_4);
            else $$render(alternate_1, -1);
          });
        }
      ...
      var button_7 = sibling(child(div_7), 2);
      var select_1 = sibling(button_7, 2);
      var option_1 = child(select_1);
      option_1.value = option_1.__value = "";
      var node_4 = sibling(option_1);
      each(node_4, 17, () => get(targetCandidates), (v) => v.address, ($$anchor3, v) => {
        ...
        var text_8 = child(option_2);
        var option_2_value = {};
        template_effect(
          ($0, $1, $2) => {
            set_text(text_8, `${get(v).name ?? ""} — ${$0 ?? ""}% APR / ${$1 ?? ""}% APY · ${$2 ?? ""}`);
          ...
          [
            ...
            () => get(candidateBe) === null ? "no breakeven" : `≈ ${Math.ceil(get(candidateBe))} days breakeven`
          ]
        );
        append($$anchor3, option_2);
      });
      var button_8 = sibling(select_1, 2);
      var node_5 = sibling(button_8, 2);
      {
        var consequent_5 = ($$anchor3) => {
          var span_2 = root_13();
          var text_9 = child(span_2);
          template_effect(() => set_text(text_9, `${get(targetIndex) + 1} / ${get(targetCandidates).length ?? ""}`));
          append($$anchor3, span_2);
        };
        if_block(node_5, ($$render) => {
          if (get(targetIndex) >= 0) $$render(consequent_5);
        });
      }
      ...
      each(select_2, 21, () => PROJECTION_HORIZON_OPTIONS, (opt) => opt.value, ($$anchor3, opt) => {
        ...
        var text_10 = child(option_3);
        var option_3_value = {};
        template_effect(() => {
          set_text(text_10, get(opt).label);
      ...
      template_effect(() => {
        button_2.disabled = get(selectedStakeIds).size === $$props.userStakes.length;
        button_3.disabled = get(selectedStakeIds).size === 0;
        button_7.disabled = get(targetCandidates).length === 0;
        button_8.disabled = get(targetCandidates).length === 0;
      });
      delegated("click", button_2, selectAllStakes);
      delegated("click", button_3, selectNoneStakes);
      delegated("click", button_7, prevTarget);
      delegated("change", select_1, onTargetSelectChange);
      bind_select_value(select_1, () => get(switchTargetAddress), ($$value) => set(switchTargetAddress, $$value));
      delegated("click", button_8, nextTarget);
    ...
    if_block(node_1, ($$render) => {
      ...
      else if ($$props.userStakes.length > 0) $$render(consequent_6, 1);
    });
  }
  var node_6 = sibling(div_2, 2);
  {
    var consequent_8 = ($$anchor2) => {
      ...
      var node_7 = sibling(text_11, 9);
      {
        var consequent_7 = ($$anchor3) => {
          var span_3 = root_16();
          var text_12 = child(span_3);
          template_effect(() => set_text(text_12, `Breakeven at day +${get(breakevenInfo).days ?? ""} (epoch ${get(breakevenInfo).epoch ?? ""})`));
          append($$anchor3, span_3);
        };
        if_block(node_7, ($$render) => {
          if (get(breakevenInfo)) $$render(consequent_7);
        });
      }
      template_effect(() => set_text(text_11, `Solid blue = realized return on your selected stake${get(selectedStakeIds).size > 1 ? "s (principal-weighted)" : ""}. Each scenario gets `));
      append($$anchor2, div_8);
    };
    if_block(node_6, ($$render) => {
      if (get(mode) === "my-stake") $$render(consequent_8);
    });
  }
  var div_9 = sibling(node_6, 2);
  var button_9 = sibling(child(div_9), 2);
  var div_10 = sibling(div_9, 2);
  var canvas_1 = child(div_10);
  ...
  var node_8 = sibling(div_10, 2);
  {
    var consequent_11 = ($$anchor2) => {
      ...
      var text_13 = child(div_12);
      var div_13 = sibling(div_12, 2);
      var div_14 = child(div_13);
      var div_15 = sibling(child(div_14), 2);
      var text_14 = child(div_15);
      var div_16 = sibling(div_15, 2);
      var text_15 = child(div_16);
      var div_17 = sibling(div_14, 2);
      var div_18 = child(div_17);
      var node_9 = sibling(child(div_18));
      {
        var consequent_9 = ($$anchor3) => {
          var span_4 = root_18();
          var text_16 = child(span_4);
          template_effect(
            ($0) => set_text(text_16, `${get(switchTarget).name ?? ""} · effective commission
                                ${$0 ?? ""}`),
            [
        ...
        if_block(node_9, ($$render) => {
          if (get(switchTarget)) $$render(consequent_9);
        });
      }
      ...
      var node_10 = child(div_24);
      {
        ...
        var alternate_2 = ($$anchor3) => {
          var text_21 = text();
          template_effect(($0) => set_text(text_21, `≈ ${$0 ?? ""} days`), [() => Math.ceil(get(projectionBreakeven))]);
          append($$anchor3, text_21);
        };
        if_block(node_10, ($$render) => {
          if (get(projectionBreakeven) === null) $$render(consequent_10);
          else $$render(alternate_2, -1);
        });
      }
      ...
      var button_10 = child(div_26);
      var text_23 = child(button_10);
      var div_27 = sibling(div_26, 2);
      var text_24 = child(div_27);
      template_effect(
        ($0, $1, $2, $3, $4, $5) => {
          set_text(text_13, `Numbers below are derived from the selected timeframe (${get(windowDays) ?? ""} epochs ≈
                ${get(windowDays) ?? ""} days). Shorter windows give noisier APR estimates and therefore
                noisier breakeven numbers — pick a longer window for a more stable read.`);
          set_text(text_14, $0);
          set_text(text_15, `APY ${$1 ?? ""} · ${$2 ?? ""}`);
          set_text(text_17, $3);
          set_text(text_18, $4);
          classes_5 = set_class(div_22, 1, "value svelte-w4m6sy", null, classes_5, { highlight: get(switchTargetApr) > get(combinedOldApr) });
          set_text(text_19, $5);
          set_text(text_22, `${ACTIVATION_DELAY_DAYS} epoch activation delay · based on
                        ${get(windowDays) ?? ""}-day window`);
          button_10.disabled = !get(switchTarget) || get(projectionBreakeven) === null || get(selectedStakeRefs).length === 0 || !$$props.onSwitch;
          set_attribute(button_10, "title", !get(switchTarget) ? "Pick a switch target first." : get(projectionBreakeven) === null ? "Switching to this validator would not be profitable in the chosen window." : `Build one PTB per sending account: ${get(switchTxCount)} transaction(s) covering ${get(selectedStakeRefs).length} stake(s), all re-staked to ${get(switchTarget).name}.`);
          set_text(text_23, `Switch ${get(selectedStakeRefs).length === 1 ? "1 stake" : `${get(selectedStakeRefs).length} stakes`} in ${get(switchTxCount) === 1 ? "1 transaction" : `${get(switchTxCount)} transactions`}`);
          set_text(text_24, `The protocol activates new stakes at the next epoch boundary, so switched
                ...
                from different accounts are bundled into one PTB per account (${get(switchTxCount) ?? ""}
                ${get(switchTxCount) === 1 ? "transaction" : "transactions"} for the current
                selection).`);
        },
        [
      ...
      delegated("click", button_10, handleSwitch);
      append($$anchor2, div_11);
    };
    if_block(node_8, ($$render) => {
      if (get(mode) === "my-stake" && get(selectedStakeRefs).length > 0) $$render(consequent_11);
    });
  }
  ...
  delegated("click", button_9, resetZoom);
  append($$anchor, details);
  pop();
}
delegate(["click", "change"]);
var root_1$3 = from_html(`<span class="spinner svelte-itq27l" aria-hidden="true"></span> Syncing…`, 1);
var root$2 = from_html(`<div class="toolbar svelte-itq27l"><div style="display: flex; gap: 0.5rem;" class="svelte-itq27l"><button><!></button></div> <div style="display: flex; align-items: center; gap: 0.5rem; flex-grow: 1; flex-wrap: wrap;" class="svelte-itq27l"><input type="text" placeholder="Enter external address (0x...)" class="svelte-itq27l"/> <button class="svelte-itq27l">Add Account</button></div> <label class="toggle-row svelte-itq27l" title="Hide non-staking objects and focus the view on stakes."><div class="toggle-switch svelte-itq27l"><input type="checkbox" class="svelte-itq27l"/> <span class="slider svelte-itq27l"></span></div> <span class="svelte-itq27l">Staking mode</span></label> <div style="display: flex; gap: 0.5rem;" class="svelte-itq27l"><button class="svelte-itq27l"> </button></div></div>`);
function Toolbar($$anchor, $$props) {
  push($$props, true);
  let newAccountAddress = prop($$props, "newAccountAddress", 15), stakingMode = prop($$props, "stakingMode", 15);
  var div = root$2();
  var div_1 = child(div);
  var button = child(div_1);
  let classes;
  ...
  template_effect(() => {
    ...
    button_2.disabled = $$props.numTransfers === 0;
    set_text(text_1, `Execute (${$$props.numTransfers ?? ""}) Transfer${$$props.numTransfers !== 1 ? "s" : ""}`);
  });
  delegated("click", button, function(...$$args) {
  ...
  bind_checked(input_1, stakingMode);
  delegated("click", button_2, function(...$$args) {
...
var root_1$2 = from_html(`<div class="transactions-container svelte-1klq5oc"><div class="transactions-tabs svelte-1klq5oc"><span class="transactions-label svelte-1klq5oc"> </span> <!></div> <div class="transaction-content svelte-1klq5oc"><!></div></div>`);
function TransactionResults($$anchor, $$props) {
  push($$props, true);
  let title = prop($$props, "title", 3, "Transfers");
  let currentResultIndex = state(0);
  user_effect(() => {
    if ($$props.results.length === 0) set(currentResultIndex, 0);
    else if (get(currentResultIndex) >= $$props.results.length) set(currentResultIndex, 0);
  });
  var fragment = comment();
  var node = first_child(fragment);
  {
    var consequent_1 = ($$anchor2) => {
      ...
      each(node_1, 17, () => $$props.results, index, ($$anchor3, result, i) => {
        const label = user_derived(() => get(result).sender ? $$props.getAccountDisplayName(get(result).sender) : "");
        var button = root_2$2();
        var text_1 = child(button);
        text_1.nodeValue = `${i + 1} `;
        var node_2 = sibling(text_1);
        {
          var consequent = ($$anchor4) => {
            var text_2 = text();
            template_effect(() => set_text(text_2, `(from: ${get(label) ?? ""})`));
        ...
        template_effect(() => {
          set_class(button, 1, `transaction-tab ${get(currentResultIndex) === i ? "active" : ""}`, "svelte-1klq5oc");
          set_attribute(button, "title", get(result).sender ? `From ${get(result).sender}` : "");
        });
        delegated("click", button, () => set(currentResultIndex, i, true));
      ...
      TransactionView(node_3, {
        get value() {
          return $$props.results[get(currentResultIndex)];
        }
      });
      template_effect(() => set_text(text$1, `${title() ?? ""}(${$$props.results.length ?? ""}):`));
      append($$anchor2, div);
    };
    if_block(node, ($$render) => {
      if ($$props.results.length > 0) $$render(consequent_1);
    });
  }
  append($$anchor, fragment);
  pop();
...
function prepareTransferTransactions(extendedAccounts) {
  ...
  for (const [senderAddress, perRecipient] of movements) {
    ...
    for (const [to, objects] of perRecipient) {
      const senderHasGasCoinLeft = senderAccount?.objects.some((obj) => obj.data?.content?.type === IOTA_COIN_TYPE) ?? false;
...
async function executeTransferTransactions(prepared) {
  const client = getClient();
  const executionMode = get$1(sharedTransactionExecution);
  const results = [];
...
var root_6 = from_html(`<span class="muted svelte-1hxv9w5">—</span>`);
...
var root$1 = from_html(`<details class="comparison-section svelte-1hxv9w5" open=""><summary class="svelte-1hxv9w5"><span class="chevron svelte-1hxv9w5" aria-hidden="true">▶</span> <span class="title svelte-1hxv9w5"> </span> <span class="subtitle svelte-1hxv9w5"> </span></summary> <div class="table-wrapper svelte-1hxv9w5"><table class="svelte-1hxv9w5"><thead class="svelte-1hxv9w5"><tr><th class="sortable svelte-1hxv9w5"> </th><th class="svelte-1hxv9w5">Status <span class="tooltip-container svelte-1hxv9w5"><span class="info-icon svelte-1hxv9w5">ⓘ</span> <span class="tooltip svelte-1hxv9w5"><strong>Committee</strong> validators earn rewards each epoch. <strong>Active</strong> validators are registered but not currently
                                ...
                                drop your yield to zero.</span></span></th><th class="sortable right svelte-1hxv9w5"> <span class="tooltip-container svelte-1hxv9w5"><span class="info-icon svelte-1hxv9w5">ⓘ</span> <span class="tooltip svelte-1hxv9w5">The cut the validator takes from rewards before distributing the
                                ...
                                the case, the declared rate is shown in parentheses.</span></span></th><th class="sortable right svelte-1hxv9w5"> <span class="tooltip-container svelte-1hxv9w5"><span class="info-icon svelte-1hxv9w5">ⓘ</span> <span class="tooltip svelte-1hxv9w5">If you moved your <em>worst-yielding</em> stake to this validator
                                ...
                                where the new stake earns nothing.<br/><br/> <strong>—</strong> means this validator's APR is at or below
                                even your weakest stake (so switching anything to here would lose
                                money), or that you have no stakes to compare against.</span></span></th><th class="sortable right svelte-1hxv9w5"> <span class="tooltip-container svelte-1hxv9w5"><span class="info-icon svelte-1hxv9w5">ⓘ</span> <span class="tooltip svelte-1hxv9w5"><strong>APR</strong> = Annual Percentage Rate (linear): the
                                window return projected to a full year (365 epochs ≈ 1 year on
                                mainnet).<br/><br/> <strong>APY</strong> = Annual Percentage Yield (compounded):
                                ...
                                grows. APY ≥ APR.<br/><br/> <strong>Net</strong> = after commission. The exchange rate
                                ...
                                applied on top.</span></span></th><th class="sortable right svelte-1hxv9w5"> <span class="tooltip-container svelte-1hxv9w5"><span class="info-icon svelte-1hxv9w5">ⓘ</span> <span class="tooltip svelte-1hxv9w5">Total IOTA delegated to this validator's staking pool right now.
...
function MultiAccountView($$anchor, $$props) {
  ...
  let selectedTimeFrame = state("last-7-days");
  ...
  user_effect(() => {
    untrack(() => {
      if (get(extendedAccounts).length === 0 && !syncInFlight) syncReset();
    });
  });
  user_effect(() => {
    untrack(() => {
  ...
  async function executeTransfers() {
    try {
      ...
      set(transactionResults, await executeTransferTransactions(prepared), true);
    } catch (err) {
  ...
  async function executeSwitch(stakes, newValidator) {
    ...
    try {
      ...
      set(transactionResults, results, true);
    } catch (err) {
      set(transactionResults, [{ error: err.toString() }], true);
      console.error(err);
    }
  ...
  var node_3 = sibling(node_2, 2);
  {
    var consequent_3 = ($$anchor2) => {
      ...
      BalanceSummary(node_4, {
        get accounts() {
          return get(extendedAccounts);
        },
        get stakingMode() {
          return get(stakingMode);
        },
      ...
      var node_6 = sibling(node_5, 2);
      {
        var consequent_2 = ($$anchor3) => {
          ...
          var node_8 = sibling(node_7, 2);
          ValidatorComparisonTable(node_8, {
            get validators() {
              return get(validators);
            },
            get timeFrame() {
        ...
        if_block(node_6, ($$render) => {
          if (get(validators).length > 0) $$render(consequent_2);
        });
      }
      append($$anchor2, fragment);
    };
    if_block(node_3, ($$render) => {
      if (get(stakingMode)) $$render(consequent_3);
    });
  }
  var node_9 = sibling(node_3, 2);
  {
    let $0 = user_derived(() => get(stakingMode) ? "Staking / transfer transactions" : "Transfers");
    TransactionResults(node_9, {
      get results() {
        return get(transactionResults);
      },
