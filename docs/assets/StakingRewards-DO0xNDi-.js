...
async function renderSectionsToPdf(sections) {
  const [{ jsPDF }, autoTableModule] = await Promise.all([
    __vitePreload(() => import("./jspdf.es.min-CmW6f7yw.js").then((n) => n.j), true ? __vite__mapDeps([0,1,2]) : void 0),
