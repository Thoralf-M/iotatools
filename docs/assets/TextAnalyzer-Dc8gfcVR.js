import { p as push, f as from_html, s as sibling, c as child, g as get, V as state, n as set, b as if_block, a0 as user_derived, t as template_effect, e as set_text, R as set_style, x as bind_value, k as append, l as pop, O as first_child, B as delegate } from "/iota-utils/assets/index-DnAm28wB.js";
...
var root_7 = from_html(`<div class="metric-box svelte-1eo1h63"><h3 class="metric-title svelte-1eo1h63">Numbers Found</h3> <div class="metric-content svelte-1eo1h63" style="word-break: break-all;"> </div></div>`);
var root = from_html(`<main class="svelte-1eo1h63"><div class="text-input-container svelte-1eo1h63"><textarea id="textInput" placeholder="Paste your text here for analysis..." class="text-input svelte-1eo1h63"></textarea> <div class="controls svelte-1eo1h63"><label for="limitInput">Show first</label> <input id="limitInput" type="number" min="0" max="10000" class="limit-input svelte-1eo1h63"/> <span>chars:</span> <button class="repeat-button svelte-1eo1h63">Repeat to limit</button> <div class="preview-text svelte-1eo1h63"><span class="highlighted-text svelte-1eo1h63"> </span><!></div> <!> <!></div></div> <div class="metrics-grid svelte-1eo1h63"><div class="metric-box svelte-1eo1h63"><h3 class="metric-title svelte-1eo1h63">Basic Metrics</h3> <div class="metric-content svelte-1eo1h63"><div>Total Characters: <strong> </strong></div> <div>Characters (no spaces): <strong> </strong></div> <div>Lines: <strong> </strong></div> <div>Words: <strong> </strong></div> <div>Paragraphs: <strong> </strong></div> <div>Unique Words: <strong> </strong></div> <div>Reading Time: <strong> </strong></div></div></div> <div class="metric-box svelte-1eo1h63"><h3 class="metric-title svelte-1eo1h63">Character Analysis</h3> <div class="metric-content svelte-1eo1h63"><div>Uppercase: <strong> </strong></div> <div>Lowercase: <strong> </strong></div> <div>Digits: <strong> </strong></div> <div>Whitespace: <strong> </strong></div> <div>Special Characters: <strong> </strong></div> <div>Commas: <strong> </strong></div></div></div> <div class="metric-box svelte-1eo1h63"><h3 class="metric-title svelte-1eo1h63">Numbers & Patterns</h3> <div class="metric-content svelte-1eo1h63"><div>Number Count: <strong> </strong></div> <!></div></div> <div class="metric-box svelte-1eo1h63"><h3 class="metric-title svelte-1eo1h63">Structure Analysis</h3> <div class="metric-content svelte-1eo1h63"><div>Parentheses pairs: <strong> </strong></div> <div>Square brackets pairs: <strong> </strong></div> <div>Curly braces pairs: <strong> </strong></div> <div>Single quote pairs: <strong> </strong></div> <div>Double quote pairs: <strong> </strong></div> <div>Backtick pairs: <strong> </strong></div></div></div> <div class="metric-box svelte-1eo1h63"><h3 class="metric-title svelte-1eo1h63">Averages & Extremes</h3> <div class="metric-content svelte-1eo1h63"><div>Avg words/line: <strong> </strong></div> <div>Avg chars/word: <strong> </strong></div> <!></div></div> <div class="metric-box svelte-1eo1h63"><h3 class="metric-title svelte-1eo1h63">Format Detection</h3> <div class="metric-content svelte-1eo1h63"><div>Valid JSON: <strong> </strong></div> <div>Valid Base64: <strong> </strong></div> <div>Valid Hex: <strong> </strong></div> <div>Valid Bytes: <strong> </strong></div></div></div></div> <!></main>`);
