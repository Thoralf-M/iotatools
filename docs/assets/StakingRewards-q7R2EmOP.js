const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/jspdf.es.min-Cm3Uvyfo.js","assets/index-CEjx4nPM.js","assets/index-2HiTQFdT.css"])))=>i.map(i=>d[i]);
import { ae as block, af as EFFECT_TRANSPARENT, ag as BranchManager, ah as effect, a2 as untrack, p as push, a as prop, C as onMount, _ as onDestroy, g as get, $ as legacy_pre_effect, a0 as deep_read_state, a1 as legacy_pre_effect_reset, v as init, b as sibling, h as child, k as delegated, d as append, l as pop, y as mutable_source, s as set, D as mutate, q as from_html, r as delegate, o as state, Q as proxy, u as user_effect, ai as attribute_effect, i as if_block, e as each, X as comment, W as first_child, t as template_effect, a8 as set_style, m as user_derived, aj as STYLE, ak as rest_props, al as __vitePreload, z as set_class, V as set_attribute, c as set_text, a5 as bind_group, am as bind_checked, H as bind_value, j as index, x as bind_select_value, a7 as copyToClipboard, w as event, G as getSelectedNetworkConfig, Z as text, an as noop, ao as NANOS_PER_IOTA, A as to_array, ap as get$1, aa as isValidIotaAddress, E as store_get, aq as activeAddress, F as setup_stores, ar as store_set, a9 as set_value, as as derived_safe_equal, at as iota_accounts } from "./index-CEjx4nPM.js";
...
async function renderSectionsToPdf(sections) {
  const [{ jsPDF }, autoTableModule] = await Promise.all([
    __vitePreload(() => import("./jspdf.es.min-Cm3Uvyfo.js").then((n) => n.j), true ? __vite__mapDeps([0,1,2]) : void 0),
