import { J as fromBase64, aB as Transaction, bj as IOTA_CLOCK_OBJECT_ID, K as iotaBcs, ad as writable, bg as Ed25519Keypair, bq as keypairFromBech32PrivateKey, p as push, o as state, Q as proxy, C as onMount, b3 as sharedClientConfig, B as getClient, g as get, s as set, u as user_effect, _ as onDestroy, b as sibling, h as child, i as if_block, t as template_effect, G as getSelectedNetworkConfig, c as set_text, V as set_attribute, k as delegated, H as bind_value, d as append, l as pop, E as store_get, F as setup_stores, z as set_class, W as first_child, q as from_html, L as toBase64, a8 as set_style, X as comment, e as each, bu as store_mutate, a2 as untrack, r as delegate, m as user_derived, ap as noop } from "./index-BA3P4jrf.js";
import { b as bind_this } from "./this-228TeyyA.js";
import { a as requestIotaFromFaucetV0 } from "./faucet-JrOhy6oz.js";
import { u as usePageQueryParams, a as updatePageQueryParams, g as getCurrentPageQueryParams } from "./page-query-params-NAr1QPpD.js";
...
async function listAppIds(client, registryId) {
  ...
  do {
    ...
    const indexEntries = page.data.filter(
      (f) => String(f.name?.type ?? "").endsWith("::registry::IndexKey")
    );
...
var root_5 = from_html(`<p>Loading app bytes...</p>`);
var root_7 = from_html(`<button class="maximize-exit-btn svelte-1r06gu" title="Exit fullscreen (Esc)">✕</button>`);
var root_6 = from_html(`<!> <iframe sandbox="allow-scripts" referrerpolicy="no-referrer"></iframe>`, 1);
var root_4 = from_html(`<section class="panel viewer svelte-1r06gu"><div class="viewer-header svelte-1r06gu"><div><h3 class="svelte-1r06gu"> </h3> <p class="muted svelte-1r06gu"> </p> <p class="app-meta"><span> </span> <span> </span> <span> </span> <span> </span> <span> </span> <span>by <code class="address-code svelte-1r06gu"> </code></span></p></div> <div class="viewer-actions svelte-1r06gu"><button class="svelte-1r06gu">Copy share link</button> <button class="svelte-1r06gu"> </button> <button class="svelte-1r06gu">← Back to list</button></div></div> <!></section>`);
var root_8 = from_html(`<section class="panel update-panel svelte-1r06gu"><h3 class="svelte-1r06gu"> </h3> <p class="muted svelte-1r06gu"> <code> </code>) stays the same, so existing share links keep working.</p> <label class="svelte-1r06gu">Name <input class="svelte-1r06gu"/></label> <label class="svelte-1r06gu">Description <textarea rows="2" class="svelte-1r06gu"></textarea></label> <label class="svelte-1r06gu">Content type <input class="svelte-1r06gu"/></label> <label class="svelte-1r06gu">Replace HTML from file (optional) <input type="file" accept=".html,.htm,text/html" class="svelte-1r06gu"/></label> <label class="svelte-1r06gu">HTML payload <textarea rows="12" spellcheck="false" class="svelte-1r06gu"></textarea></label> <div class="kv svelte-1r06gu"><button class="svelte-1r06gu"> </button> <button class="svelte-1r06gu">Cancel</button></div></section>`);
var root_10 = from_html(`<div class="error-block svelte-1r06gu"> </div>`);
var root_11 = from_html(`<p>Loading...</p>`);
var root_12 = from_html(`<p class="muted svelte-1r06gu">Nothing published yet. Use <em>+ Publish new app</em> above to upload your first app.</p>`);
var root_15 = from_html(`<div class="app-desc svelte-1r06gu"> </div>`);
var root_14 = from_html(`<li><div class="app-card svelte-1r06gu"><div class="app-card-top svelte-1r06gu"><div class="app-avatar svelte-1r06gu"> </div> <div class="app-card-title svelte-1r06gu"><div class="app-name svelte-1r06gu"> </div> <div class="app-size svelte-1r06gu"> </div></div> <button>★</button></div> <!> <div class="app-card-footer svelte-1r06gu"><span class="app-date svelte-1r06gu"> </span> <button class="open-btn svelte-1r06gu">Open →</button></div></div></li>`);
var root_18 = from_html(`<div class="apps-divider svelte-1r06gu"></div> <ul class="apps svelte-1r06gu"></ul>`, 1);
var root_16 = from_html(`<ul class="apps svelte-1r06gu"></ul> <!>`, 1);
var root_20 = from_html(`<ul class="apps svelte-1r06gu"></ul>`);
var root_22 = from_html(`<div class="error-block svelte-1r06gu"> </div>`);
var root_23 = from_html(`<p class="muted svelte-1r06gu">No apps published from this address yet. After publishing, the upgrade
                    capabilities will appear here.</p>`);
var root_26 = from_html(`<div class="app-name svelte-1r06gu"> </div> <div class="app-desc svelte-1r06gu"> </div> <div class="app-meta"><span> </span> <span> </span> <span> </span> <span> </span></div>`, 1);
...
var root_25 = from_html(`<li><div class="app-card svelte-1r06gu"><!> <div class="app-id"> </div> <div class="app-id"> </div> <div class="kv svelte-1r06gu"><button class="svelte-1r06gu">Open</button> <button class="svelte-1r06gu">Update</button></div></div></li>`);
var root_24 = from_html(`<ul class="apps svelte-1r06gu"></ul>`);
var root_9 = from_html(
  `<section class="panel svelte-1r06gu"><h3 class="svelte-1r06gu"> </h3> <!> <!></section> <section class="panel my-apps-panel svelte-1r06gu"><div class="my-apps-header svelte-1r06gu"><h3 class="svelte-1r06gu"> </h3> <button class="svelte-1r06gu"> </button></div> <p class="muted svelte-1r06gu">Every <code>AppCap</code> owned by your random signer address. Selecting one lets
                you publish a new <em>app_version</em> - viewers load the app via its shared object id,
                so they get the updated payload automatically on their next visit.</p> <!> <!></section>`,
  1
);
var root_28 = from_html(`<div class="key-row svelte-1r06gu"><strong>Balance:</strong> </div>`);
...
function OnChainApps($$anchor, $$props) {
  ...
  function saveStarred(set2) {
    localStorage.setItem(STARRED_KEY, JSON.stringify([...set2]));
  }
  ...
  let sortedApps = user_derived(() => {
    const pinned = get(apps).filter((a) => get(starred).has(a.id));
    const rest = get(apps).filter((a) => !get(starred).has(a.id));
    return { pinned, rest };
  });
  ...
  var node_1 = sibling(node, 2);
  {
    var consequent_2 = ($$anchor2) => {
      ...
      delegated("click", button_3, () => navigator.clipboard.writeText(skillMd).then(() => {
    ...
    var alternate_4 = ($$anchor2) => {
      ...
      var node_7 = sibling(node_6, 2);
      {
        ...
        var alternate_1 = ($$anchor3) => {
          const appCard = ($$anchor4, app = noop) => {
            ...
            var text_21 = child(div_11);
            var div_12 = sibling(div_11, 2);
            var div_13 = child(div_12);
            var text_22 = child(div_13);
          ...
          var node_9 = first_child(fragment_2);
          {
            var consequent_13 = ($$anchor4) => {
              ...
              each(ul, 21, () => get(sortedApps).pinned, (app) => app.id, ($$anchor5, app) => {
                appCard($$anchor5, () => get(app));
              });
              var node_10 = sibling(ul, 2);
              {
                var consequent_12 = ($$anchor5) => {
                  ...
                  each(ul_1, 21, () => get(sortedApps).rest, (app) => app.id, ($$anchor6, app) => {
                    appCard($$anchor6, () => get(app));
                  });
            ...
            var alternate = ($$anchor4) => {
              var ul_2 = root_20();
              each(ul_2, 21, () => get(sortedApps).rest, (app) => app.id, ($$anchor5, app) => {
                appCard($$anchor5, () => get(app));
              });
              append($$anchor4, ul_2);
            };
      ...
      var node_12 = sibling(node_11, 2);
      {
        ...
        var alternate_3 = ($$anchor3) => {
          var ul_3 = root_24();
          each(ul_3, 21, () => get(myApps), (owned) => owned.capId, ($$anchor4, owned) => {
            var li_1 = root_25();
            ...
            var node_13 = child(div_19);
            {
              var consequent_16 = ($$anchor5) => {
                ...
                var text_29 = child(div_20);
                var div_21 = sibling(div_20, 2);
                var text_30 = child(div_21);
