import { p as push, U as user_effect, n as set, u as store_get, V as state, W as proxy, g as get, w as getSelectedNetworkConfig, f as from_html, s as sibling, c as child, b as if_block, t as template_effect, X as set_value, R as set_style, e as set_text, x as bind_value, k as append, l as pop, v as setup_stores, Y as isValidIotaAddress, Z as normalizeIotaObjectId, _ as toB64, Q as comment, O as first_child, I as each, K as index, j as bind_select_value, $ as writable, a0 as user_derived, B as delegate } from "/iota-utils/assets/index-DnAm28wB.js";
import { J as JsonToggleView } from "/iota-utils/assets/JsonToggleView-u4B_FjtU.js";
import { l as layoutToBcs, g as getMoveLayout, d as decodeBcs, a as deriveDynamicFieldIdWithBcs, b as deriveDynamicFieldId, q as queryDynamicFields, e as enhanceFieldsWithLayoutsAndBcs, c as queryDynamicField, f as queryDynamicObjectField } from "/iota-utils/assets/dynamic-fields-utils-BMbSfdX3.js";
...
var root_24 = from_html(`<div style="margin-top: 0.5em; color: #666; font-style: italic;">Computing...</div>`);
var root_25 = from_html(`<div style="margin-top: 0.5em; color: #999; font-style: italic;">Enter object ID, field type, and field value to compute dynamic field ID</div>`);
var root_26 = from_html(`<div style="color: red; margin-top: 1em;"> </div>`);
var root_27 = from_html(`<h4>dynamicField Result</h4> <!>`, 1);
var root_28 = from_html(`<h4>dynamicObjectField Result</h4> <!>`, 1);
var root_29 = from_html(`<div style="color: red; margin-top: 1em;"> </div>`);
...
function DynamicFields($$anchor, $$props) {
  ...
  input.__input = (e) => updateObjectId(e.target?.value || "");
  ...
  button.__click = () => handleQueryDynamicFields();
  var text_1 = child(button);
  var button_1 = sibling(button, 2);
  button_1.__click = handleGetLayoutsAndBcsValues;
    ...
    var consequent_10 = ($$anchor2) => {
      ...
      var node_8 = sibling(input_3, 2);
      {
        ...
        if_block(node_8, ($$render) => {
          if (get(fieldBcs).trim()) $$render(consequent_9);
        });
      }
        ...
        var consequent_13 = ($$anchor3) => {
          ...
          var node_16 = first_child(fragment_8);
          {
            var consequent_12 = ($$anchor4) => {
              ...
              button_7.__click = () => navigator.clipboard.writeText(get(bcsValue));
  ...
  var node_17 = sibling(node_7, 2);
  {
    var consequent_14 = ($$anchor2) => {
      ...
      button_8.__click = () => navigator.clipboard.writeText(get(computedDynamicFieldId));
    ...
    var alternate_6 = ($$anchor2) => {
      ...
      var node_18 = first_child(fragment_9);
      {
        ...
        if_block(
          node_18,
          ($$render) => {
            if (get(objectId) && get(fieldType) && (get(bcsInputMode) === "base64" ? get(fieldBcs) : get(fieldStructType))) $$render(consequent_15);
  ...
  button_9.__click = handleQueryDynamicField;
  var text_14 = child(button_9);
  var button_10 = sibling(button_9, 2);
  button_10.__click = handleQueryDynamicObjectField;
  var text_15 = child(button_10);
  var node_19 = sibling(div_17, 2);
  {
  ...
  var node_22 = sibling(node_20, 2);
  {
    var consequent_18 = ($$anchor2) => {
      ...
      var node_23 = sibling(first_child(fragment_11), 2);
