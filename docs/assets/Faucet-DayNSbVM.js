import { p as push, i as init, f as from_html, s as sibling, c as child, z as each, A as index, O as store_get, g as get, m as mutable_source, e as event, E as bind_value, j as append, k as pop, S as setup_stores, aU as sharedClientConfig, l as set, ac as activeAddress, T as isValidIotaAddress, t as template_effect, d as set_text } from "/iota-utils/assets/index-B7pbcrNY.js";
...
var root = from_html(`<main><button class="svelte-kvrbts">Set to current network and active address</button> <br/> <span>faucet URL: <input type="string" list="faucetUrls" class="faucet-input svelte-kvrbts" placeholder="faucet URL, like http://127.0.0.1:9123/gas"/> <datalist id="faucetUrls"></datalist></span> <br/> <span>address: <input placeholder="address" class="address-input svelte-kvrbts"/></span> <br/> <span>amount of requests: <input type="number" placeholder="1" size="4"/></span> <span>milliseconds between requests: <input type="number" placeholder="1000" style="width: 7rem;"/></span> <br/> <button class="svelte-kvrbts">Request funds</button> <!></main>`);
