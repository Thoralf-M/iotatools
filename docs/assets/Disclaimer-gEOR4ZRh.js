import { D as set_class, I as if_block, Mt as reset, U as delegate, V as from_html, W as delegated, Y as get, ct as sibling, ft as set, it as template_effect, jt as next, ot as child, pt as state, z as append } from "./disclose-version-CpEJO7r1.js";
//#region src/lib/pages/disclaimer/Disclaimer.svelte
var root = from_html(`<h1>Disclaimer</h1> <h2>1. General</h2> <p>This website ("iotatools.dev") is an experimental, open-source tool for interacting with
            ...
            do not rely solely on this tool for important transactions.</p>`, 1);
var root_1 = from_html(`<h1>Haftungsausschluss</h1> <h2>1. Allgemeines</h2> <p>Diese Website ("iotatools.dev") ist ein experimentelles, quelloffenes Werkzeug zur
            ...
            nicht ausschließlich auf dieses Werkzeug.</p>`, 1);
var root_2 = from_html(`<main><div class="lang-toggle svelte-16ofwrz"><button>English</button> <button>Deutsch</button></div> <!></main>`);
