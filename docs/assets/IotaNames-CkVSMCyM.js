import { p as push, i as init, f as from_html, s as sibling, c as child, m as mutable_source, b as if_block, g as get, N as store_get, E as bind_value, k as append, l as pop, Q as setup_stores, a7 as activeAddress, K as getSelectedNetworkConfig, j as set, ad as Transaction, n as getClient, z as each, A as index, t as template_effect, d as set_text, aW as toHEX, R as isValidIotaAddress, aX as IOTA_CLOCK_OBJECT_ID, W as delegate, I as comment, G as first_child } from "/iota-utils/assets/index-C6pwDMXK.js";
import { I as IotaGraphQLClient, g as graphql } from "/iota-utils/assets/index-BsUd0Vdk.js";
import { T as TransactionView } from "/iota-utils/assets/TransactionView-Cg7UGTVr.js";
import { e as executeTransaction } from "/iota-utils/assets/transaction-execution-DyCYsWgb.js";
...
var on_click = (__10, IOTA_NAMES_PACKAGE_ID, TESTNET_PACKAGE_ID, IOTA_NAMES_OBJECT_ID, PAYMENTS_PACKAGE_ID, SUBNAME_PACKAGE_ID, SUBNAME_PROXY_PACKAGE_ID, AUCTION_PACKAGE_ID, COUPONS_PACKAGE_ID) => {
...
var on_click_1 = (__11, IOTA_NAMES_PACKAGE_ID, DEVNET_PACKAGE_ID, IOTA_NAMES_OBJECT_ID, PAYMENTS_PACKAGE_ID, SUBNAME_PACKAGE_ID, SUBNAME_PROXY_PACKAGE_ID, AUCTION_PACKAGE_ID, COUPONS_PACKAGE_ID) => {
...
function IotaNames($$anchor, $$props) {
  ...
  button_2.__click = [listRegisteredNames, getRegisteredNamesInner, value];
  ...
  button_4.__click = [toggleIotaNamesIds, showIotaNamesIds, getPackageIds];
  var button_5 = sibling(button_4, 2);
  button_5.__click = [getDynamicFields, value, queryDynamicFields];
