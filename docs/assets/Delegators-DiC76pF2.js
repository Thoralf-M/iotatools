import { au as is_runes, ae as block, ag as BranchManager, B as getClient, I as IotaGraphQLClient, G as getSelectedNetworkConfig, p as push, a as prop, C as onMount, _ as onDestroy, v as init, b as sibling, h as child, g as get, s as set, H as bind_value, w as event, d as append, l as pop, y as mutable_source, q as from_html, o as state, Q as proxy, i as if_block, t as template_effect, c as set_text, W as first_child, k as delegated, m as user_derived, av as update, aw as tick, e as each, j as index, X as comment, r as delegate, a8 as set_style, z as set_class, Z as text } from "./index-BrIr3B5H.js";
...
var root_14 = from_html(`<div class="stat-card svelte-z1qq95"><div class="stat-label svelte-z1qq95">Stake Percentage</div> <div class="stat-value svelte-z1qq95"> </div></div>`);
var root_15 = from_html(`<div class="stat-card svelte-z1qq95"><div class="stat-label svelte-z1qq95">Total System Stake Percentage</div> <div class="stat-value svelte-z1qq95"> </div></div>`);
...
var root_27 = from_html(`<div class="objects-footer svelte-z1qq95"><div class="objects-count svelte-z1qq95"> </div></div>`);
...
var root_29 = from_html(`<tr class="svelte-z1qq95"><td class="rank-cell svelte-z1qq95"> </td><td class="richlist-address-cell svelte-z1qq95"><span class="richlist-address-text svelte-z1qq95"> </span> <button class="copy-btn svelte-z1qq95" title="Copy address">📋</button></td><td class="numeric-cell svelte-z1qq95"> </td><td class="numeric-cell svelte-z1qq95"> </td></tr>`);
var root_30 = from_html(`<div class="objects-footer svelte-z1qq95"><div class="objects-count svelte-z1qq95"> </div> <button class="load-more-btn svelte-z1qq95">Load 200 more</button></div>`);
var root_31 = from_html(`<div class="objects-footer svelte-z1qq95"><div class="objects-count svelte-z1qq95"> </div></div>`);
var root_28 = from_html(`<h2 class="svelte-z1qq95">Delegator Richlist</h2> <div class="richlist-table-container svelte-z1qq95"><table class="richlist-table svelte-z1qq95"><thead><tr><th class="rank-header svelte-z1qq95">Rank</th><th class="svelte-z1qq95">Owner Address</th><th class="svelte-z1qq95">Total Staked (IOTA)</th><th class="svelte-z1qq95">Staked Objects</th></tr></thead><tbody class="svelte-z1qq95"></tbody></table></div> <!>`, 1);
var root_12 = from_html(`<div class="stats-container svelte-z1qq95"><h2 class="svelte-z1qq95">Global Statistics</h2> <div class="stats-grid svelte-z1qq95"><div class="stat-card svelte-z1qq95"><div class="stat-label svelte-z1qq95">Staked Objects</div> <div class="stat-value svelte-z1qq95"> </div></div> <div class="stat-card svelte-z1qq95"><div class="stat-label svelte-z1qq95">Timelocked Objects</div> <div class="stat-value svelte-z1qq95"> </div></div> <div class="stat-card svelte-z1qq95"><div class="stat-label svelte-z1qq95">Unique Addresses</div> <div class="stat-value svelte-z1qq95"> </div> <div class="stat-detail svelte-z1qq95"> </div></div> <div class="stat-card svelte-z1qq95"><div class="stat-label svelte-z1qq95">Staked Amount (IOTA)</div> <div class="stat-value svelte-z1qq95"> </div></div> <!> <div class="stat-card svelte-z1qq95"><div class="stat-label svelte-z1qq95">Average Staked Amount (IOTA)</div> <div class="stat-value svelte-z1qq95"> </div></div> <div class="stat-card svelte-z1qq95"><div class="stat-label svelte-z1qq95">Average Stake Duration (epochs)</div> <div class="stat-value svelte-z1qq95"> </div></div> <!> <!></div></div> <!> <!> <!>`, 1);
    ...
    var consequent_24 = ($$anchor2) => {
      ...
      var node_12 = sibling(node_11, 2);
      {
        var consequent_12 = ($$anchor3) => {
          ...
          template_effect(($0) => set_text(text_18, `${$0 ?? ""}%`), [
            () => get(stats).global.totalSystemStakePercentage.toFixed(2)
          ]);
      ...
      var node_13 = sibling(div_14, 2);
      {
        var consequent_19 = ($$anchor3) => {
          ...
          each(tbody, 23, () => get(stats).validators, (validator) => validator.address, ($$anchor4, validator, index$1) => {
            ...
            var td = child(tr_1);
            var text_29 = child(td);
            var td_1 = sibling(td);
            var button_4 = child(td_1);
            var text_30 = child(button_4);
            var span_1 = sibling(button_4, 2);
            var text_31 = child(span_1);
            var td_2 = sibling(td_1);
            var text_32 = child(td_2);
            var td_3 = sibling(td_2);
            var text_33 = child(td_3);
            var td_4 = sibling(td_3);
            var text_34 = child(td_4);
            var td_5 = sibling(td_4);
            var text_35 = child(td_5);
            var td_6 = sibling(td_5);
            var text_36 = child(td_6);
            var td_7 = sibling(td_6);
            var text_37 = child(td_7);
              ...
              var consequent_18 = ($$anchor5) => {
                ...
                var node_18 = sibling(div_39, 2);
                {
                  var consequent_16 = ($$anchor6) => {
                    ...
                    template_effect(
                      ($0, $1) => set_text(text_51, `Showing ${$0 ?? ""} of
                                                        ${$1 ?? ""} objects`),
                      [
      ...
      var node_19 = sibling(node_13, 2);
      {
        var consequent_22 = ($$anchor3) => {
          ...
          each(tbody_2, 23, () => get(computedRichlistRows).slice(0, get(richlistRowsLimit)), (row) => row.ownerAddress, ($$anchor4, row, index2) => {
            ...
            var text_53 = child(td_18);
            var td_19 = sibling(td_18);
            var span_7 = child(td_19);
            var text_54 = child(span_7);
            var button_9 = sibling(span_7, 2);
            var td_20 = sibling(td_19);
            var text_55 = child(td_20);
            var td_21 = sibling(td_20);
            var text_56 = child(td_21);
            template_effect(
              ($0, $1) => {
                set_text(text_53, get(index2) + 1);
          ...
          var node_20 = sibling(div_44, 2);
          {
            var consequent_20 = ($$anchor4) => {
              ...
              template_effect(
                ($0, $1) => set_text(text_57, `Showing ${$0 ?? ""} of ${$1 ?? ""}
                        addresses`),
                [
      ...
      var node_21 = sibling(node_19, 2);
      {
        var consequent_23 = ($$anchor3) => {
          ...
          key(node_22, () => get(chartVersion), ($$anchor4) => {
