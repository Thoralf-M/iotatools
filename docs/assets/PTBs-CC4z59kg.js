import { q as getDefaultExportFromCjs, p as push, r as prop, u as onMount, g as get, m as mutable_source, v as onDestroy, w as legacy_pre_effect, j as set$1, x as deep_read_state, y as legacy_pre_effect_reset, i as init, f as from_html, s as sibling, c as child, z as each$1, A as index$1, B as init_select, b as if_block, C as untrack, t as template_effect, D as select_option, e as event, k as append, l as pop, o as mutate, d as set_text, E as bind_value, F as bind_group, G as first_child, H as text, I as comment, J as set_style, K as set_class } from "/iota-utils/assets/index-2BfZ2Uzt.js";
import { s as set_attribute } from "/iota-utils/assets/attributes-JEJ5dw0E.js";
import { b as bind_this } from "/iota-utils/assets/this-TbBupjWg.js";
import { T as TransactionView } from "/iota-utils/assets/TransactionView-BnjYlKrV.js";
import { E as EpochPTBAnalyzer } from "/iota-utils/assets/index-DQlQMppv.js";
import "/iota-utils/assets/transaction-view-BIhBSRD3.js";
import "/iota-utils/assets/iota-nano-conversion-DWzI2FGN.js";
import "/iota-utils/assets/index-BUX9eKYW.js";
/*!
 * @kurkle/color v0.3.4
...
var root_4 = from_html(`<span class="checkpoint-count svelte-1ohbzcm"> </span>`);
...
var root_8 = from_html(`<span class="checkpoint-count svelte-1ohbzcm"> </span>`);
var root_5 = from_html(`<input id="start-checkpoint" type="number" placeholder="Start" min="0" style="width: 8rem;"/> <span class="range-separator svelte-1ohbzcm">to</span> <input id="end-checkpoint" type="number" placeholder="End" min="0" style="width: 8rem;"/> <button class="fetch-current-epoch-btn" title="Fetch current epoch range"><!></button> <!>`, 1);
...
var root_18 = from_html(`<div class="progress-section svelte-1ohbzcm"><div class="progress-label svelte-1ohbzcm"><span> </span> <span class="progress-percentage svelte-1ohbzcm"> </span></div> <div class="progress-bar svelte-1ohbzcm"><div class="progress-fill svelte-1ohbzcm"></div></div></div>`);
var root_17 = from_html(`<div class="progress-info svelte-1ohbzcm"><div class="progress-header svelte-1ohbzcm"><p class="svelte-1ohbzcm"><strong>Progress:</strong> </p> <button class="stop-btn svelte-1ohbzcm" title="Stop fetching data"> </button></div> <!></div>`);
...
var root_24 = from_html(`<div class="transaction-id-item svelte-1ohbzcm"><span class="tx-id svelte-1ohbzcm"> </span> <button class="copy-btn" style="padding: 4px 8px; align-self: center;" title="Copy transaction ID">📋</button></div>`);
var root_23 = from_html(`<div class="function-item svelte-1ohbzcm"><div class="function-header svelte-1ohbzcm"><div class="function-signature svelte-1ohbzcm"><div class="function-parts svelte-1ohbzcm"><span class="package-id svelte-1ohbzcm"> </span><span class="separator svelte-1ohbzcm">::</span><span class="module svelte-1ohbzcm"> </span><span class="separator svelte-1ohbzcm">::</span><span class="function-name svelte-1ohbzcm"> </span> <button class="copy-btn svelte-1ohbzcm" style="padding: 4px 8px; font-size: 13px;" title="Copy full function signature">📋</button></div> <div class="function-actions svelte-1ohbzcm"><details class="svelte-1ohbzcm"><summary class="svelte-1ohbzcm">Txs</summary></details></div></div> <div class="function-stats svelte-1ohbzcm"><div class="call-count svelte-1ohbzcm"><span class="count-label">Calls:</span> <span class="count-value"> </span></div> <div class="tx-count svelte-1ohbzcm"><span class="count-label">Txs:</span> <span class="count-value"> </span></div></div></div> <div class="transaction-ids-section svelte-1ohbzcm"><div class="transaction-ids-list svelte-1ohbzcm"></div></div></div>`);
var root_25 = from_html(`<div class="address-item svelte-1ohbzcm"><div class="address-header svelte-1ohbzcm"><div class="address-left svelte-1ohbzcm"><div class="address-info svelte-1ohbzcm"><span> </span></div> <button class="copy-btn" style="padding: 4px 8px; align-self: center;" title="Copy address">📋</button></div> <div class="address-stats svelte-1ohbzcm"><div class="tx-count svelte-1ohbzcm"><span class="count-label">TXs:</span> <span class="count-value"> </span></div></div></div></div>`);
var root_26 = from_html(`<div class="address-item svelte-1ohbzcm"><div class="address-header svelte-1ohbzcm"><div class="address-left svelte-1ohbzcm"><div class="address-info svelte-1ohbzcm"><span> </span></div> <button class="copy-btn" style="padding: 4px 8px; align-self: center;" title="Copy address">📋</button></div> <div class="address-stats svelte-1ohbzcm"><div class="call-count svelte-1ohbzcm"><span class="count-label">Calls:</span> <span class="count-value"> </span></div></div></div></div>`);
var root_29 = from_html(`<span class="module-name svelte-1ohbzcm"> </span>`);
var root_28 = from_html(`<div class="modules-row svelte-1ohbzcm"><span class="modules-label svelte-1ohbzcm">Modules:</span> <div class="modules-list svelte-1ohbzcm"></div></div>`);
var root_27 = from_html(`<div class="package-item svelte-1ohbzcm"><div class="package-left svelte-1ohbzcm"><div class="package-header svelte-1ohbzcm"><div class="package-info svelte-1ohbzcm"><div class="package-id-row svelte-1ohbzcm"><span class="package-label svelte-1ohbzcm">Package:</span> <span class="package-id"> </span> <button class="copy-btn" style="padding: 4px 8px; align-self: center;" title="Copy package ID">📋</button></div> <!> <div class="sender-row svelte-1ohbzcm"><span class="sender-label svelte-1ohbzcm">Sender:</span> <span class="sender-address"> </span> <button class="copy-btn" style="padding: 4px 8px; align-self: center;" title="Copy sender address">📋</button></div></div></div></div> <div class="package-meta svelte-1ohbzcm"><div class="version-info"><span class="version-label"> </span></div> <button class="copy-btn tx-btn">TX</button></div></div>`);
var root_32 = from_html(`<div class="transaction-id-item svelte-1ohbzcm"><span class="tx-id svelte-1ohbzcm"> </span> <button class="copy-btn" style="padding: 4px 8px; align-self: center;" title="Copy transaction ID">📋</button></div>`);
var root_31 = from_html(`<div class="function-item svelte-1ohbzcm"><div class="function-header svelte-1ohbzcm"><div class="function-signature svelte-1ohbzcm"><div class="address-left svelte-1ohbzcm"><div class="address-info svelte-1ohbzcm"><span> </span></div> <button class="copy-btn" style="padding: 4px 8px; align-self: center;" title="Copy command type">📋</button></div> <div class="function-actions svelte-1ohbzcm"><details class="svelte-1ohbzcm"><summary class="svelte-1ohbzcm">Txs</summary></details></div> <div class="address-stats svelte-1ohbzcm"><div class="call-count svelte-1ohbzcm"><span class="count-label">Count:</span> <span class="count-value"> </span></div></div></div></div> <div class="transaction-ids-section svelte-1ohbzcm"><div class="transaction-ids-list svelte-1ohbzcm"></div></div></div>`);
var root_34 = from_html(`<button class="clear-checkpoint-btn" title="Clear checkpoint selection">✕</button>`);
var root_35 = from_html(`<div class="checkpoint-loading svelte-1ohbzcm"><p> </p></div>`);
var root_39 = from_html(`<span class="transaction-digest svelte-1ohbzcm"> </span>`);
var root_41 = from_html(`<span class="transaction-digest svelte-1ohbzcm"> </span>`);
var root_42 = from_html(`<span> </span>`);
var root_38 = from_html(`<details class="transaction-details svelte-1ohbzcm"><summary class="transaction-summary svelte-1ohbzcm"><span class="transaction-number svelte-1ohbzcm"></span> <!> <!></summary> <div class="transaction-content svelte-1ohbzcm"><!></div></details>`);
var root_37 = from_html(`<div class="checkpoint-transactions"><div class="transaction-list svelte-1ohbzcm"></div></div>`);
var root_44 = from_html(`<div class="no-transactions svelte-1ohbzcm"><p> </p></div>`);
var root_45 = from_html(`<div class="checkpoint-placeholder svelte-1ohbzcm"><p>Click on a data point in the chart above or enter a checkpoint
                                number to inspect its transactions</p></div>`);
var root_33 = from_html(`<!> <div class="checkpoint-inspector svelte-1ohbzcm"><h4 class="svelte-1ohbzcm">Checkpoint Inspector</h4> <div class="checkpoint-input-section svelte-1ohbzcm"><label for="checkpoint-input" class="svelte-1ohbzcm">Checkpoint Number:</label> <input id="checkpoint-input" type="number" placeholder="Enter checkpoint number or click on chart" min="0" class="svelte-1ohbzcm"/> <!> <h5> </h5></div> <!></div>`, 1);
var root_19 = from_html(`<div class="results"><!> <!> <div class="summary-cards svelte-1ohbzcm"><div class="summary-card svelte-1ohbzcm"><h4 class="svelte-1ohbzcm">Total PTBs</h4> <div class="metric svelte-1ohbzcm"> </div> </div> <div class="summary-card svelte-1ohbzcm"><h4 class="svelte-1ohbzcm">Unique Senders</h4> <div class="metric svelte-1ohbzcm"> </div></div> <div class="summary-card svelte-1ohbzcm"><h4 class="svelte-1ohbzcm">Called Functions</h4> <div class="metric svelte-1ohbzcm"> </div></div> <div class="summary-card svelte-1ohbzcm"><h4 class="svelte-1ohbzcm">Published Packages</h4> <div class="metric svelte-1ohbzcm"> </div></div></div> <div class="details-section svelte-1ohbzcm"><details class="svelte-1ohbzcm"><summary class="svelte-1ohbzcm"> </summary> <div class="function-list svelte-1ohbzcm"></div></details> <details class="svelte-1ohbzcm"><summary class="svelte-1ohbzcm"> </summary> <div class="address-list svelte-1ohbzcm"></div></details> <details class="svelte-1ohbzcm"><summary class="svelte-1ohbzcm"> </summary> <div class="address-list svelte-1ohbzcm"></div></details> <details class="svelte-1ohbzcm"><summary class="svelte-1ohbzcm"> </summary> <div class="package-list svelte-1ohbzcm"></div></details> <details class="svelte-1ohbzcm"><summary class="svelte-1ohbzcm"> </summary> <div class="command-type-list"><!></div></details></div> <!></div>`);
var root = from_html(`<div class="epoch-transaction-blocks svelte-1ohbzcm"><p style="margin-top:0;">Query programmable transaction blocks data for a specific epoch or checkpoint range</p> <div class="input-section svelte-1ohbzcm"><div class="filter-section svelte-1ohbzcm"><div class="filter-row svelte-1ohbzcm"><div class="filter-group svelte-1ohbzcm"><label for="input-object-filter" class="svelte-1ohbzcm">Input Object:</label> <div class="input-with-button svelte-1ohbzcm"><input id="input-object-filter" type="text" placeholder="0x... object ID" class="wide-input svelte-1ohbzcm"/> <button class="example-btn svelte-1ohbzcm" title="Insert example object ID">Example</button></div></div> <div class="filter-group svelte-1ohbzcm"><label for="function-filter" class="svelte-1ohbzcm">Function:</label> <div class="input-with-button svelte-1ohbzcm"><input id="function-filter" type="text" placeholder="package::module::function" class="wide-input svelte-1ohbzcm"/> <button class="example-btn svelte-1ohbzcm" title="Insert example function">Example</button></div></div></div></div> <div class="input-row-single svelte-1ohbzcm"><div class="mode-selection-column svelte-1ohbzcm"><label class="mode-option-stacked svelte-1ohbzcm"><span class="mode-label-stacked svelte-1ohbzcm">Epoch Number</span> <input type="radio" class="svelte-1ohbzcm"/></label> <label class="mode-option-stacked svelte-1ohbzcm"><span class="mode-label-stacked svelte-1ohbzcm">Checkpoint Range</span> <input type="radio" class="svelte-1ohbzcm"/></label></div> <div class="input-controls svelte-1ohbzcm"><!></div></div> <div class="button-row svelte-1ohbzcm"><button> </button> <div class="input-group svelte-1ohbzcm"><label for="transaction-limit">Limit to:</label> <input id="transaction-limit" type="number" placeholder="Max transactions" min="1" style="width: 6rem;"/></div> <button> </button></div></div> <!> <!> <!></div>`);
    ...
    var consequent_24 = ($$anchor2) => {
      ...
      each$1(
        ...
        ($$anchor3, func) => {
          ...
          var span_7 = sibling(child(div_40), 2);
          ...
          each$1(div_43, 5, () => (get(func), untrack(() => get(func).transactionIds)), index$1, ($$anchor4, txId) => {
            ...
            template_effect(
              ($0) => {
                set_attribute(span_9, "title", get(txId));
                set_text(text_33, $0);
              },
              [
          ...
          template_effect(
            ($0, $1) => {
              set_attribute(span_4, "title", (get(func), untrack(() => get(func).package)));
      ...
      each$1(
        ...
        ($$anchor3, pkg) => {
          ...
          var span_14 = sibling(child(div_64), 2);
          var text_41 = child(span_14);
          var button_11 = sibling(span_14, 2);
          ...
          var span_16 = sibling(child(div_67), 2);
          var text_43 = child(span_16);
          var button_12 = sibling(span_16, 2);
          var div_68 = sibling(div_61, 2);
          var div_69 = child(div_68);
          var span_17 = child(div_69);
          var text_44 = child(span_17);
          var button_13 = sibling(div_69, 2);
          template_effect(
            ($0) => {
              ...
              set_attribute(button_13, "title", `Copy transaction ID: ${$0 ?? ""}`);
            },
            [
          ...
          event("click", button_13, () => copyToClipboard(get(pkg).txId));
                  ...
                  each$1(div_86, 5, () => get(checkpointTransactions), index$1, ($$anchor6, tx, index2) => {
                    ...
                    var node_25 = sibling(node_23, 2);
                    {
                      var consequent_20 = ($$anchor7) => {
                        ...
                        template_effect(
                          ($0) => {
                            classes = set_class(span_24, 1, "transaction-status svelte-1ohbzcm", null, classes, $0);
