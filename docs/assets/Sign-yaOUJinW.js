...
import { as as Signer, at as toBase64, au as PasskeyPublicKey, av as Secp256r1PublicKey, aw as Secp256k1PublicKey, ak as Ed25519PublicKey, ax as parseSerializedSignature, ay as PublicKey, az as fromBase64, a8 as iotaBcs, aA as SIGNATURE_FLAG_TO_SCHEME, aB as SIGNATURE_SCHEME_TO_FLAG, aC as normalizeIotaAddress, aa as bytesToHex, aD as blake2b, aE as bytesEqual, p as push, w as legacy_pre_effect, N as store_get, g as get, m as mutable_source, j as set, y as legacy_pre_effect_reset, i as init, f as from_html, s as sibling, c as child, b as if_block, t as template_effect, d as set_text, k as append, l as pop, Q as setup_stores, aF as TransactionDataBuilder, z as each, A as index, aG as get$1, ac as iota_wallets, a7 as activeAddress, ad as Transaction, o as mutate, n as getClient, W as delegate, C as untrack } from "/iota-utils/assets/index-C6pwDMXK.js";
import { a as set_value } from "/iota-utils/assets/attributes-DNoTlwZR.js";
import { b as bind_this } from "/iota-utils/assets/this-CTXLlOBo.js";
import { b as fromBase64$1 } from "/iota-utils/assets/b64-BgM4Sqlt.js";
import { J as JsonToggleView } from "/iota-utils/assets/JsonToggleView-BSTTwzWO.js";
import { T as TransactionView } from "/iota-utils/assets/TransactionView-Cg7UGTVr.js";
import { u as usePageQueryParams, a as updatePageQueryParams } from "/iota-utils/assets/page-query-params-C3eh4VdT.js";
...
async function dryRunTransaction(_, error, dryRunResult, txBytesInput) {
  try {
    ...
    let txBytes;
    try {
      txBytes = fromBase64$1(inputString);
    } catch (e) {
...
async function signTransaction(__2, error, signatureResult, txBytesInput, signatureTypeLabel, signatureTextarea) {
  try {
    ...
    try {
      transactionBytes = fromBase64$1(inputString);
    } catch (e) {
      set(error, "Invalid base64 transaction bytes");
      return;
    }
...
async function submitSignedTx(__4, error, submitResult, txBytesInput, signatureResult) {
  try {
    ...
    let bcsSignature;
    try {
      bcsSignature = fromBase64$1(signatureString);
    } catch (e) {
...
var root_1 = from_html(`<div class="dry-run-result svelte-1aa8roa"><button class="dry-run-close svelte-1aa8roa" aria-label="Close dry run result" title="Close">&#10005;</button> <div class="dry-run-title">Dry Run Result</div> <!></div>`);
var on_input_1 = (e, signatureResult) => set(signatureResult, e.target.value);
var root_2 = from_html(`<div style="margin-top: 8px; padding: 8px; border: 1px solid #ffc107; border-radius: 4px; color: #856404;">🔍 Verifying signature...</div>`);
var root_3 = from_html(`<div style="margin-top: 8px; padding: 8px; background: #003300; border: 1px solid #28a745; border-radius: 4px; color: white;">✓ Signature is valid</div>`);
var root_5 = from_html(`<div style="margin-top: 4px; font-size: 12px;"> </div>`);
var root_4 = from_html(`<div style="margin-top: 8px; padding: 8px; background: #660000; border: 1px solid #dc3545; border-radius: 4px; color: white;">✗ Invalid signature <!></div>`);
var on_click_1 = (__6, copyToClipboard, pair) => copyToClipboard(get(pair).publicKey.toBase64());
var on_click_2 = (__7, copyToClipboard, pair) => copyToClipboard(get(pair).publicKey.toIotaPublicKey());
var on_click_3 = (__8, copyToClipboard, pair) => copyToClipboard(get(pair).publicKey.toIotaAddress());
var on_click_4 = (__9, copyToClipboard, pair) => copyToClipboard(bufferExports.Buffer.from(get(pair).signature).toString("base64"));
var root_7 = from_html(`<div class="signature-item svelte-1aa8roa"><div class="signature-header svelte-1aa8roa"> </div> <div class="signature-details svelte-1aa8roa"><div class="detail-item svelte-1aa8roa"><span class="detail-label svelte-1aa8roa">Public key:</span> <span class="detail-value svelte-1aa8roa"> </span> <button class="copy-button svelte-1aa8roa">Copy</button></div> <div class="detail-item svelte-1aa8roa"><span class="detail-label svelte-1aa8roa">Public key with flag:</span> <span class="detail-value svelte-1aa8roa"> </span> <button class="copy-button svelte-1aa8roa">Copy</button></div> <div class="detail-item svelte-1aa8roa"><span class="detail-label svelte-1aa8roa">Address:</span> <span class="detail-value svelte-1aa8roa"> </span> <button class="copy-button svelte-1aa8roa">Copy</button></div> <div class="detail-item svelte-1aa8roa"><span class="detail-label svelte-1aa8roa">Signature:</span> <span class="detail-value svelte-1aa8roa"> </span> <button class="copy-button svelte-1aa8roa">Copy</button></div></div></div>`);
var root_6 = from_html(`<div class="signature-details-container svelte-1aa8roa"></div>`);
var root_8 = from_html(`<div style="margin: 20px 0;"><!></div>`);
var root_9 = from_html(`<div style="color: red; margin: 10px 0; padding: 10px; border: 1px solid #fcc; border-radius: 4px;"> </div>`);
var root = from_html(`<main><div><div style="float: left; display: flex; align-items: center; gap: 10px;"><span>Tx bytes base64 encoded or message:</span> <button style="padding: 4px 8px; font-size: 12px;">Example tx</button></div> <div class="box"><textarea placeholder="base64 transaction bytes or message" class="svelte-1aa8roa"></textarea></div></div> <div style="margin-top: 20px; display: flex; gap: 10px;"><button style="padding: 8px 16px; background: #007acc; color: white; border: none; border-radius: 4px; cursor: pointer;">Sign Transaction</button> <button style="padding: 8px 16px; background: #28a745; color: white; border: none; border-radius: 4px; cursor: pointer;">Sign Personal Message</button> <button style="padding: 8px 16px; background: #ffc107; color: #333; border: none; border-radius: 4px; cursor: pointer;">Dry Run Transaction</button></div> <!> <div><div style="margin-bottom: 6px; font-weight: bold;"> </div> <textarea placeholder="Signature (base64)" class="signature-textarea svelte-1aa8roa"></textarea> <!> <!> <!> <!> <button style="margin-top: 8px; padding: 8px 16px; background: #6c63ff; color: white; border: none; border-radius: 4px; cursor: pointer;">Submit Signed Tx</button></div> <!> <!> <!></main>`);
function Sign($$anchor, $$props) {
  ...
  function processTransactionBytes(inputString) {
    try {
      let txBytes = fromBase64$1(inputString);
      set(value, TransactionDataBuilder.fromBytes(txBytes));
    } catch (e) {
      console.log("error TransactionDataBuilder", e);
      try {
        set(value, iotaBcs.SenderSignedData.parse(fromBase64$1(inputString))[0]);
      } catch (e2) {
  ...
  async function verifySignature() {
    set(signatureVerificationStatus, "checking");
    ...
    try {
      ...
      try {
        ...
        set(signatureVerificationStatus, "invalid");
        set(signatureVerificationError, `Parsing failed: ${e}`);
        return;
      }
      if (get(signaturePubkeyPairs) && get(signaturePubkeyPairs).length === 1 && inputString) {
        const pair = get(signaturePubkeyPairs)[0];
        try {
          const txBytes = fromBase64$1(inputString);
          ...
          if (verifiedPubKey.toBase64() !== pair.publicKey.toBase64()) {
            set(signatureVerificationStatus, "invalid");
            set(signatureVerificationError, "Public key mismatch");
            return;
          }
          set(signatureVerificationStatus, "valid");
        } catch (e) {
          try {
            ...
            set(signatureVerificationStatus, "invalid");
            set(signatureVerificationError, `Verification failed: ${e2}`);
            return;
          }
        }
      } else if (get(signaturePubkeyPairs) && get(signaturePubkeyPairs).length > 1) {
        set(signatureVerificationStatus, "valid");
      } else {
        set(signatureVerificationStatus, null);
      }
      ...
      set(signatureVerificationStatus, "invalid");
      set(signatureVerificationError, `Verification error: ${e}`);
    }
  }
    ...
    var consequent_4 = ($$anchor2) => {
      ...
      var node_5 = sibling(child(div_9));
      {
        var consequent_3 = ($$anchor3) => {
          ...
          template_effect(() => set_text(text_2, get(signatureVerificationError)));
  ...
  template_effect(() => {
    ...
    set_text(text_1, get(signatureTypeLabel) || "Signature");
