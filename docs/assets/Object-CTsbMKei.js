import { O as render_effect, P as teardown, I as IotaGraphQLClient, B as getClient, p as push, o as state, Q as proxy, C as onMount, s as set, b as sibling, h as child, i as if_block, g as get, k as delegated, R as normalizeIotaAddress, d as append, l as pop, E as store_get, F as setup_stores, t as template_effect, c as set_text, e as each, S as getObjectLink, G as getSelectedNetworkConfig, j as index, U as getTransactionLink, V as set_attribute, W as first_child, x as bind_select_value, q as from_html, m as user_derived, X as comment, Y as getAddressLink, Z as text, r as delegate } from "./index-DNSDOUvd.js";
import { b as bind_this } from "./this-C0sUMBKG.js";
import { q as queryDynamicFields } from "./dynamic-fields-CcTBN-KU.js";
import { u as usePageQueryParams, a as updatePageQueryParams } from "./page-query-params-gEya7Aj4.js";
import { g as getIotaNamesPackageId } from "./iota-names-config-BXWJTRfl.js";
...
var root_24 = from_html(`<span class="owner-type svelte-h7f06r">Address</span> <a target="_blank" class="address-link svelte-h7f06r"> </a>`, 1);
var root_26 = from_html(`<a target="_blank" class="address-link svelte-h7f06r"> </a>`);
var root_25 = from_html(`<span class="owner-type svelte-h7f06r">Object</span> <!>`, 1);
var root_28 = from_html(`<span class="owner-type svelte-h7f06r">Shared</span> `, 1);
var root_29 = from_html(`<span class="owner-type svelte-h7f06r">Immutable</span>`);
...
var root_31 = from_html(`<div class="detail-row svelte-h7f06r"><strong class="svelte-h7f06r">Last tx:</strong> <span class="svelte-h7f06r"><a target="_blank" class="address-link svelte-h7f06r"> </a></span></div>`);
var root_33 = from_html(`<div class="detail-row svelte-h7f06r"><strong class="svelte-h7f06r">Type:</strong> <code class="svelte-h7f06r"> </code></div>`);
var root_34 = from_html(`<details class="dynamic-fields-details svelte-h7f06r"><summary class="dynamic-fields-summary svelte-h7f06r"><strong> </strong></summary> <pre class="json-content svelte-h7f06r"> </pre></details>`);
var root_32 = from_html(`<!> <div class="detail-row svelte-h7f06r"><strong class="svelte-h7f06r">Contents:</strong> <button class="dynamic-fields-btn svelte-h7f06r"> </button></div> <pre class="json-content svelte-h7f06r"> </pre> <!>`, 1);
...
var root_36 = from_html(`<button class="load-more-btn svelte-h7f06r"> </button>`);
var root_39 = from_html(`<strong class="svelte-h7f06r">Version:</strong> <code class="svelte-h7f06r"> </code>`, 1);
var root_40 = from_html(`<strong class="svelte-h7f06r">Digest:</strong> <code class="svelte-h7f06r"> </code>`, 1);
var root_38 = from_html(`<div class="detail-row svelte-h7f06r"><!> <!></div>`);
var root_42 = from_html(`<a target="_blank" class="address-link svelte-h7f06r"> </a>`);
var root_41 = from_html(`<div class="detail-row svelte-h7f06r"><strong class="svelte-h7f06r">Owner:</strong> <span class="svelte-h7f06r"><!></span></div>`);
var root_45 = from_html(`<div class="detail-row svelte-h7f06r"><strong class="svelte-h7f06r">Last tx:</strong> <span class="svelte-h7f06r"><a target="_blank" class="address-link svelte-h7f06r"> </a></span></div>`);
var root_47 = from_html(`<div class="detail-row svelte-h7f06r"><strong class="svelte-h7f06r">Type:</strong> <code class="svelte-h7f06r"> </code></div>`);
var root_48 = from_html(`<details class="dynamic-fields-details svelte-h7f06r"><summary class="dynamic-fields-summary svelte-h7f06r"><strong> </strong></summary> <pre class="json-content svelte-h7f06r"> </pre></details>`);
var root_46 = from_html(`<!> <div class="detail-row svelte-h7f06r"><strong class="svelte-h7f06r">Contents:</strong> <button class="dynamic-fields-btn svelte-h7f06r"> </button></div> <pre class="json-content svelte-h7f06r"> </pre> <!>`, 1);
var root_37 = from_html(`<div class="object-item svelte-h7f06r"><details class="object-details svelte-h7f06r"><summary class="object-summary svelte-h7f06r"><code class="object-address svelte-h7f06r"> </code> <button class="explorer-btn svelte-h7f06r">Explorer</button></summary> <div class="object-details-content svelte-h7f06r"><!> <!> <!> <!></div></details></div>`);
var root_49 = from_html(`<button class="load-more-btn bottom-load-more svelte-h7f06r"> </button>`);
var root_35 = from_html(`<div class="objects-list svelte-h7f06r"><div class="objects-header svelte-h7f06r"><div class="header-controls svelte-h7f06r"><div class="expand-controls svelte-h7f06r"><button class="svelte-h7f06r">Expand All</button> <button class="svelte-h7f06r">Collapse All</button></div> <!> <div class="page-size-control svelte-h7f06r"><label for="page-size" class="svelte-h7f06r">Page Size:</label> <select id="page-size" class="svelte-h7f06r"><option>1</option><option>5</option><option>10</option><option>20</option><option>50</option></select></div></div> <h3 class="svelte-h7f06r"> </h3></div> <!> <!></div>`);
                ...
                var consequent_18 = ($$anchor5) => {
                  ...
                  var node_19 = sibling(first_child(fragment_9), 2);
                  {
                    ...
                    var alternate_1 = ($$anchor6) => {
                      var text_16 = text("(parent not accessible)");
    ...
    var consequent_39 = ($$anchor2) => {
          ...
          var consequent_30 = ($$anchor4) => {
            ...
            var node_28 = child(div_31);
            {
              var consequent_28 = ($$anchor5) => {
                var fragment_13 = root_39();
                var code_9 = sibling(first_child(fragment_13), 2);
                var text_28 = child(code_9);
            ...
            var node_29 = sibling(node_28, 2);
            {
              var consequent_29 = ($$anchor5) => {
                var fragment_14 = root_40();
                var code_10 = sibling(first_child(fragment_14), 2);
                var text_29 = child(code_10);
      ...
      var node_36 = sibling(node_26, 2);
      {
        var consequent_38 = ($$anchor3) => {
          var button_15 = root_49();
          var text_39 = child(button_15);
          template_effect(() => {
