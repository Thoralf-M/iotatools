import { bi as getContext, bj as setContext, p as push, N as prop, i as init, K as comment, J as first_child, b as if_block, h as append, j as pop, u as store_get, v as setup_stores, t as template_effect, Y as set_class, e as event, ae as store_set, n as from_html, k as child, a2 as writable, q as onMount, P as legacy_pre_effect, l as set, Q as deep_read_state, R as legacy_pre_effect_reset, m as mutable_source, s as sibling, H as each, g as get, S as untrack, af as derived_safe_equal, I as index, d as set_text, aM as clsx, ay as to_array, bk as component, bl as spread_props, bm as readable, y as fromBase64, T as TransactionDataBuilder, z as iotaBcs } from "./index-Be4Wjvgu.js";
...
var root_1$1 = from_html(`<span class="container svelte-2pfjjq"><span></span></span>`);
function JSONArrow($$anchor, $$props) {
  ...
  var node = first_child(fragment);
  {
    var consequent = ($$anchor2) => {
      ...
      let classes;
      span_1.textContent = "▶";
      template_effect(() => classes = set_class(span_1, 1, "arrow svelte-2pfjjq", null, classes, { expanded: $expanded() }));
...
var root_8$2 = from_html(`<span class="label svelte-1qs5fza"><!><!><!></span><!>`, 1);
var root_7$4 = from_html(`<li><!></li>`);
var root_6$4 = from_html(`<ul></ul>`);
var root_3$8 = from_html(`<span class="root svelte-1qs5fza"><!> <!></span> <!>`, 1);
      ...
      var node_5 = sibling(span, 2);
      {
        var consequent_3 = ($$anchor3) => {
          ...
          each(ul, 5, keys, index, ($$anchor4, key, index2) => {
            ...
            template_effect(() => classes = set_class(li, 1, "svelte-1qs5fza", null, classes, { indent: $expanded() }));
...
var root_6$3 = from_html(`<span class="comma operator svelte-edipuj">,</span>`);
var root_5$1 = from_html(`<!> <!>`, 1);
var root_7$3 = from_html(`<span class="comma operator svelte-edipuj">,</span> <span class="operator">…</span>`, 1);
...
function JSONValueNode($$anchor, $$props) {
  ...
  var text = child(span);
  template_effect(() => {
    set_class(span, 1, clsx(nodeType()), "svelte-k8tuy6");
    set_text(text, value());
  });
  append($$anchor, span);
}
  ...
  var node = child(span);
  {
    var consequent = ($$anchor2) => {
      ...
      each(node_1, 1, stack, index, ($$anchor3, line, index2) => {
        ...
        set_class(span_1, 1, "svelte-19k9w69", null, {}, { indent: index2 > 0 });
...
var root_1 = from_html(`<span class="svelte-wvrj2k"> </span>`);
var root_2$2 = from_html(`<span class="svelte-wvrj2k"> </span>`);
...
var root_2$1 = from_html(`<span class="i svelte-12s0wwd">ƒ</span>`);
var root_5 = from_html(`<span class="fn i svelte-12s0wwd"> </span>`);
var root_6$1 = from_html(`<span class="i svelte-12s0wwd"> </span>`);
var root_4$2 = from_html(`<!><!>`, 1);
var root_8 = from_html(`<span> </span>`);
var root_11 = from_html(`<span class="i svelte-12s0wwd"> </span>`);
...
var root_2 = from_html(`<span class="regex svelte-h7n85m"> </span>`);
var root_4$1 = from_html(`<span class="regex svelte-h7n85m"> </span>`);
...
var root_4 = from_html(`<span class="svelte-vw7fmj"> </span>`);
...
function Root($$anchor, $$props) {
  ...
  template_effect(() => classes = set_class(span, 1, "svelte-vw7fmj", null, classes, { expandable: get(expandable) }));
  append($$anchor, span);
  pop();
}
