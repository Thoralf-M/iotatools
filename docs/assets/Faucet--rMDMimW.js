import { p as push, i as init, f as from_html, s as sibling, c as child, I as each, t as template_effect, e as set_text, g as get, k as append, K as index, u as store_get, m as mutable_source, h as event, x as bind_value, l as pop, v as setup_stores, aM as sharedClientConfig, n as set, a8 as activeAddress, Y as isValidIotaAddress } from "/iota-utils/assets/index-BYGXtdVn.js";
...
var root = from_html(`<main><button class="svelte-1urodea">Set to current network and active address</button> <br/> <span>faucet URL: <input type="string" list="faucetUrls" class="faucet-input svelte-1urodea" placeholder="faucet URL, like http://127.0.0.1:9123/gas"/> <datalist id="faucetUrls"></datalist></span> <br/> <span>address: <input placeholder="address" class="address-input svelte-1urodea"/></span> <br/> <span>amount of requests: <input type="number" placeholder="1" size="4"/></span> <span>milliseconds between requests: <input type="number" placeholder="1000" style="width: 7rem;"/></span> <br/> <button class="svelte-1urodea">Request funds</button> <!></main>`);
