...
import { g as getTransactionLink, a as getObjectLink, b as getAddressLink, T as TransactionView } from "/iota-utils/assets/TransactionView-BagsgkCQ.js";
import { E as EpochPTBAnalyzer } from "/iota-utils/assets/index-CdMp_nuo.js";
...
import "/iota-utils/assets/index-651h_OrV.js";
/*!
 * @kurkle/color v0.3.4
...
var root_33 = from_html(`<!> <div class="checkpoint-inspector svelte-untdox"><h4 class="svelte-untdox">Checkpoint Inspector</h4> <div class="checkpoint-input-section svelte-untdox"><label for="checkpoint-input" class="svelte-untdox">Checkpoint Number:</label> <input id="checkpoint-input" type="number" placeholder="Enter checkpoint number or click on chart" min="0" class="svelte-untdox"/> <!> <div class="checkpoint-filter-row" style="margin-top: 10px; display: flex; align-items: center; gap: 8px;"><input id="checkpoint-filter-input" type="text" placeholder="Filter transactions by substring (JSON)" style="width: 18rem; font-size: 12px;" class="svelte-untdox"/> <button class="example-btn svelte-untdox" title="Insert example substring">Example</button> <button class="fetch-current-epoch-btn" title="Filter transactions by substring">Filter</button></div> <h5> </h5></div> <!></div>`, 1);
