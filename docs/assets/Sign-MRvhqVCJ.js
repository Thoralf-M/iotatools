...
import { az as parseSerializedSignature, y as fromBase64, p as push, P as legacy_pre_effect, g as get, l as set, R as legacy_pre_effect_reset, i as init, s as sibling, k as child, b as if_block, t as template_effect, _ as set_value, d as set_text, h as append, j as pop, u as store_get, v as setup_stores, m as mutable_source, o as getClient, T as TransactionDataBuilder, z as iotaBcs, aA as getActiveWallet, aB as get$1, ad as activeAddress, ah as getSelectedChain, ai as Transaction, r as mutate, A as toBase64, H as each, S as untrack, I as index, n as from_html, B as delegate } from "./index-CDp1uGc2.js";
import { b as bind_this } from "./this-CwnacTZr.js";
import { J as JsonToggleView } from "./JsonToggleView-BtkYxZAb.js";
import { p as parsePartialSignatures, a as publicKeyFromRawBytes, v as verifyTransactionSignature, b as verifyPersonalMessageSignature, T as TransactionView } from "./TransactionView-Btxp8PB0.js";
...
var root_8 = from_html(`<div style="margin-top: 20px;"><div style="margin-bottom: 6px; font-weight: bold; display: flex; align-items: center; gap: 10px;">Signed Transaction Bytes <button class="copy-button svelte-2sgbh3" style="padding: 4px 10px; font-size: 12px;">Copy</button></div> <textarea readonly="" placeholder="Signed transaction bytes (base64)" class="signature-textarea svelte-2sgbh3" style="background: #f5f5f5; cursor: text;"></textarea> <div style="margin-top: 4px; font-size: 12px; color: #666;">This combines the transaction bytes with the signature and can be submitted to the network.</div></div>`);
...
function Sign($$anchor, $$props) {
  ...
  function createSignedTxBytes() {
    try {
      ...
      const signatureBytes = fromBase64(get(signatureResult).trim());
      ...
      set(signedTxBytes, toBase64(result));
    } catch (e) {
