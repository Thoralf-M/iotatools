import { ai as Transaction, aE as IOTA_SYSTEM_STATE_OBJECT_ID, ab as bcs, $ as isValidIotaAddress, p as push, P as legacy_pre_effect, g as get, l as set, R as legacy_pre_effect_reset, i as init, s as sibling, k as child, b as if_block, S as untrack, t as template_effect, d as set_text, _ as set_value, e as event, x as bind_value, h as append, j as pop, v as setup_stores, m as mutable_source, o as getClient, K as comment, J as first_child, n as from_html, Q as deep_read_state, X as set_style, u as store_get, ad as activeAddress, H as each, I as index } from "./index-CDp1uGc2.js";
import { T as TransactionView } from "./TransactionView-Btxp8PB0.js";
import { a as formatNumberWithUnderscores, f as formatNumbersWithUnderscores } from "./iota-nano-conversion-ChrZDrC2.js";
import { e as executeTransaction } from "./transaction-execution-d3wdcCdR.js";
import { c as computeStakingRewards } from "./staking-utils-BUs9Hfu3.js";
...
var root_5 = from_html(`<button class="svelte-qq920f">Load Validators</button>`);
...
var root_7 = from_html(`<div style="margin-bottom: 1rem;"><div class="section-header svelte-qq920f" style="font-weight: bold; border: 1px solid #ddd; border-radius: 4px; cursor: pointer; display: flex; justify-content: space-between; align-items: center;" role="button" tabindex="0"><span class="svelte-qq920f"> </span> <span class="svelte-qq920f"> </span></div> <!></div>`);
var root_12 = from_html(`<div class="validator-item svelte-qq920f" style="margin: 0.125rem 0; border: 1px solid #ddd; border-radius: 4px; cursor: pointer;" role="button" tabindex="0"><div class="validator-content svelte-qq920f"><span class="validator-address svelte-qq920f"> </span> <span class="validator-status svelte-qq920f"> </span> <span class="validator-name svelte-qq920f"> </span> <span class="validator-stake svelte-qq920f"> </span></div></div>`);
var root_10 = from_html(`<div><div class="section-header svelte-qq920f" style="font-weight: bold; border: 1px solid grey; border-radius: 4px; cursor: pointer; display: flex; justify-content: space-between; align-items: center;" role="button" tabindex="0"><span class="svelte-qq920f"> </span> <span class="svelte-qq920f"> </span></div> <!></div>`);
