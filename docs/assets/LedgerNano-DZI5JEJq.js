...
import { q as getDefaultExportFromCjs, ao as getAugmentedNamespace, p as push, O as state, P as proxy, f as from_html, c as child, s as sibling, g as get, z as each, A as index, E as bind_value, h as bind_select_value, j as set, k as append, l as pop, ap as update, n as getClient, R as isValidIotaAddress, ad as Transaction, al as messageWithIntent, aq as toSerializedSignature, ak as Ed25519PublicKey, W as delegate, G as first_child, b as if_block, t as template_effect, d as set_text, V as user_derived, ar as to_array } from "/iota-utils/assets/index-C6pwDMXK.js";
import { t as toHEX } from "/iota-utils/assets/hex-BsUxbKPD.js";
...
class Iota {
  ...
  async signTransaction(path, txn, options) {
    ...
    const bcsObjects = (options == null ? void 0 : options.bcsObjects) ?? [];
...
function LedgerNano($$anchor, $$props) {
  ...
  button.__click = [on_click, connect];
  ...
  button_1.__click = [on_click_1, generateAddress];
  ...
  button_2.__click = [on_click_2, generateMultipleAddresses];
  var button_3 = sibling(button_2, 4);
  button_3.__click = [on_click_3, getAllBalances];
  var button_4 = sibling(button_3, 2);
  button_4.__click = [on_click_4, getAllBalances];
  var button_5 = sibling(button_4, 2);
  button_5.__click = [on_click_5, getAllObjects];
  var button_6 = sibling(button_5, 2);
  button_6.__click = [on_click_6, getAllObjects];
  ...
  button_7.__click = [on_click_7, sendAllObjects];
  ...
  button_9.__click = [on_click_9, accountEntries, tableAccounts, value];
  var button_10 = sibling(button_9, 2);
  button_10.__click = [on_click_10, expanded, tableAccounts];
  var button_11 = sibling(button_10, 2);
  button_11.__click = [on_click_11, expanded];
  ...
  each(tbody, 21, () => get(tableAccounts), index, ($$anchor2, $$item) => {
    ...
    tr.__click = [on_click_12, toggle, index$1];
    var td = child(tr);
    var text = child(td);
    var td_1 = sibling(td);
