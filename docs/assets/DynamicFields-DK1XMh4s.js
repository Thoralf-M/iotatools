import { p as push, M as user_effect, j as set, N as store_get, O as state, P as proxy, g as get, K as getSelectedNetworkConfig, f as from_html, s as sibling, c as child, b as if_block, t as template_effect, J as set_style, d as set_text, E as bind_value, k as append, l as pop, Q as setup_stores, R as isValidIotaAddress, S as normalizeIotaObjectId, T as toB64, I as comment, G as first_child, z as each, A as index, h as bind_select_value, U as writable, V as user_derived, W as delegate } from "/iota-utils/assets/index-tKsU8hCQ.js";
import { a as set_value } from "/iota-utils/assets/attributes-BcHeetPc.js";
import { J as JsonToggleView } from "/iota-utils/assets/JsonToggleView-B69-X521.js";
import { l as layoutToBcs, g as getMoveLayout, d as decodeBcs, a as deriveDynamicFieldIdWithBcs, b as deriveDynamicFieldId, q as queryDynamicFields, e as enhanceFieldsWithLayoutsAndBcs, c as queryDynamicField, f as queryDynamicObjectField } from "/iota-utils/assets/dynamic-fields-utils-DcfLLlhk.js";
import { u as usePageQueryParams, a as updatePageQueryParams } from "/iota-utils/assets/page-query-params-CfFlp0k0.js";
...
var on_input = (e, updateObjectId) => {
  var _a;
  return updateObjectId(((_a = e.target) == null ? void 0 : _a.value) || "");
};
...
function DynamicFields($$anchor, $$props) {
  ...
  input.__input = [on_input, updateObjectId];
