...
import { aw as Signer, ax as toBase64, ay as PasskeyPublicKey, az as Secp256r1PublicKey, aA as Secp256k1PublicKey, ao as Ed25519PublicKey, aB as parseSerializedSignature, aC as PublicKey, aD as fromBase64, ac as iotaBcs, aE as SIGNATURE_FLAG_TO_SCHEME, aF as SIGNATURE_SCHEME_TO_FLAG, aG as normalizeIotaAddress, ae as bytesToHex, aH as blake2b, aI as bytesEqual, p as push, w as legacy_pre_effect, O as store_get, g as get, m as mutable_source, l as set, y as legacy_pre_effect_reset, i as init, f as from_html, s as sibling, c as child, b as if_block, t as template_effect, R as set_value, d as set_text, j as append, k as pop, S as setup_stores, aJ as TransactionDataBuilder, z as each, A as index, aK as get$1, ag as iota_wallets, aa as activeAddress, ah as Transaction, o as mutate, n as getClient, Y as delegate, C as untrack } from "/iota-utils/assets/index-CZN5jHoS.js";
...
import { J as JsonToggleView } from "/iota-utils/assets/JsonToggleView-C5CY-86n.js";
import { T as TransactionView } from "/iota-utils/assets/TransactionView-B6CkgL0N.js";
import { u as usePageQueryParams, a as updatePageQueryParams } from "/iota-utils/assets/page-query-params-DAqERhIT.js";
...
var root_1 = from_html(`<div class="dry-run-result svelte-lbb7dt"><button class="dry-run-close svelte-lbb7dt" aria-label="Close dry run result" title="Close">&#10005;</button> <div class="dry-run-title">Dry Run Result</div> <!></div>`);
...
var root_7 = from_html(`<div class="signature-item svelte-lbb7dt"><div class="signature-header svelte-lbb7dt"> </div> <div class="signature-details svelte-lbb7dt"><div class="detail-item svelte-lbb7dt"><span class="detail-label svelte-lbb7dt">Public key:</span> <span class="detail-value svelte-lbb7dt"> </span> <button class="copy-button svelte-lbb7dt">Copy</button></div> <div class="detail-item svelte-lbb7dt"><span class="detail-label svelte-lbb7dt">Public key with flag:</span> <span class="detail-value svelte-lbb7dt"> </span> <button class="copy-button svelte-lbb7dt">Copy</button></div> <div class="detail-item svelte-lbb7dt"><span class="detail-label svelte-lbb7dt">Address:</span> <span class="detail-value svelte-lbb7dt"> </span> <button class="copy-button svelte-lbb7dt">Copy</button></div> <div class="detail-item svelte-lbb7dt"><span class="detail-label svelte-lbb7dt">Signature:</span> <span class="detail-value svelte-lbb7dt"> </span> <button class="copy-button svelte-lbb7dt">Copy</button></div></div></div>`);
var root_6 = from_html(`<div class="signature-details-container svelte-lbb7dt"></div>`);
var root_8 = from_html(`<div style="margin: 20px 0;"><!></div>`);
var root_9 = from_html(`<div style="color: #ef4444; margin: 10px 0;"> </div>`);
var root = from_html(`<main><div><div style="float: left; display: flex; align-items: center; gap: 10px;"><span>Tx bytes base64 encoded or message:</span> <button style="padding: 4px 8px; font-size: 12px;" class="svelte-lbb7dt">Example tx</button></div> <div class="box"><textarea placeholder="base64 transaction bytes or message" class="svelte-lbb7dt"></textarea></div></div> <div style="margin-top: 20px; display: flex; gap: 10px;"><button class="svelte-lbb7dt">Sign Tx</button> <button class="svelte-lbb7dt">Sign Message</button> <button class="svelte-lbb7dt">Dry Run</button></div> <!> <div><div style="margin-bottom: 6px; font-weight: bold;"> </div> <textarea placeholder="Signature (base64)" class="signature-textarea svelte-lbb7dt"></textarea> <!> <!> <!> <!> <button class="svelte-lbb7dt">Submit Signed Tx</button></div> <!> <!> <!></main>`);
