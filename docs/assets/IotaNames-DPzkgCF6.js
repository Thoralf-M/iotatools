...
function IotaNames($$anchor, $$props) {
  ...
  button_2.__click = listRegisteredNames;
  var button_3 = sibling(button_2, 2);
  button_3.__click = getReverseRegisteredAddresses;
  var button_4 = sibling(button_3, 2);
  button_4.__click = toggleIotaNamesIds;
  var button_5 = sibling(button_4, 2);
  button_5.__click = getDynamicFields;
  var button_6 = sibling(button_5, 4);
  button_6.__click = getRegistryEntry;
  var button_7 = sibling(button_6, 2);
  button_7.__click = resolveName;
  var button_8 = sibling(button_7, 2);
  button_8.__click = resolveAddress;
  var button_9 = sibling(button_8, 4);
  button_9.__click = registerName;
  var button_10 = sibling(button_9, 2);
  button_10.__click = setTargetAddress;
  var button_11 = sibling(button_10, 2);
  button_11.__click = setReverseLookup;
  var span_3 = sibling(button_11, 4);
  var input_3 = sibling(child(span_3));
  var button_12 = sibling(span_3, 2);
  button_12.__click = startAuctionAndPlaceBid;
  var button_13 = sibling(button_12, 2);
  button_13.__click = placeBid;
  var button_14 = sibling(button_13, 2);
  button_14.__click = claim;
  var button_15 = sibling(button_14, 2);
  button_15.__click = listAuctions;
  var node_3 = sibling(button_15, 2);
