...
import "./dynamic-fields-CXK-kwPa.js";
...
async function renderSectionsToPdf(sections, onProgress) {
  const [{ jsPDF }, autoTableModule] = await Promise.all([
    __vitePreload(() => import("./jspdf.es.min-CTrbcyMs.js").then((n) => n.j), true ? __vite__mapDeps([0,1,2]) : void 0),
