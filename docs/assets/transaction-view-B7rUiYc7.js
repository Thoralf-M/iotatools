import { bf as getContext, bg as setContext, p as push, N as prop, i as init, K as comment, J as first_child, b as if_block, r as store_get, k as append, l as pop, v as setup_stores, f as from_html, c as child, t as template_effect, Y as set_class, h as event, ac as store_set, a2 as writable, q as onMount, P as legacy_pre_effect, n as set, m as mutable_source, Q as deep_read_state, R as legacy_pre_effect_reset, s as sibling, H as each, g as get, S as untrack, a8 as derived_safe_equal, I as index, e as set_text, aJ as clsx, av as to_array, bh as component, bi as spread_props, bj as readable, y as fromBase64, T as TransactionDataBuilder, z as iotaBcs } from "./index-DX1peBGM.js";
...
var root_1$1 = from_html(`<span class="container svelte-vunjc7"><span></span></span>`);
function JSONArrow($$anchor, $$props) {
  ...
  var node = first_child(fragment);
  {
    var consequent = ($$anchor2) => {
      ...
      let classes;
      span_1.textContent = "▶";
      template_effect(() => classes = set_class(span_1, 1, "arrow svelte-vunjc7", null, classes, { expanded: $expanded() }));
...
var root_8$2 = from_html(`<span class="label svelte-1cs7qon"><!><!><!></span><!>`, 1);
var root_7$4 = from_html(`<li><!></li>`);
var root_6$4 = from_html(`<ul></ul>`);
var root_3$8 = from_html(`<span class="root svelte-1cs7qon"><!> <!></span> <!>`, 1);
      ...
      var node_5 = sibling(span, 2);
      {
        var consequent_3 = ($$anchor3) => {
          ...
          each(ul, 5, keys, index, ($$anchor4, key, index2) => {
            ...
            template_effect(() => classes = set_class(li, 1, "svelte-1cs7qon", null, classes, { indent: $expanded() }));
...
var root_6$3 = from_html(`<span class="comma operator svelte-n33r32">,</span>`);
var root_5$1 = from_html(`<!> <!>`, 1);
var root_7$3 = from_html(`<span class="comma operator svelte-n33r32">,</span> <span class="operator">…</span>`, 1);
...
function JSONValueNode($$anchor, $$props) {
  ...
  var text = child(span);
  template_effect(() => {
    set_class(span, 1, clsx(nodeType()), "svelte-1hiktm7");
    set_text(text, value());
  });
  append($$anchor, span);
}
  ...
  var node = child(span);
  {
    var consequent = ($$anchor2) => {
      ...
      each(node_1, 1, stack, index, ($$anchor3, line, index2) => {
        ...
        set_class(span_1, 1, "svelte-64r5jo", null, {}, { indent: index2 > 0 });
...
var root_1 = from_html(`<span class="svelte-10nkjh9"> </span>`);
var root_2$2 = from_html(`<span class="svelte-10nkjh9"> </span>`);
...
var root_2$1 = from_html(`<span class="i svelte-cdp23s">ƒ</span>`);
var root_5 = from_html(`<span class="fn i svelte-cdp23s"> </span>`);
var root_6$1 = from_html(`<span class="i svelte-cdp23s"> </span>`);
var root_4$2 = from_html(`<!><!>`, 1);
var root_8 = from_html(`<span> </span>`);
var root_11 = from_html(`<span class="i svelte-cdp23s"> </span>`);
...
var root_2 = from_html(`<span class="regex svelte-1bb4w0z"> </span>`);
var root_4$1 = from_html(`<span class="regex svelte-1bb4w0z"> </span>`);
...
var root_4 = from_html(`<span class="svelte-m69a3i"> </span>`);
...
function Root($$anchor, $$props) {
  ...
  template_effect(() => classes = set_class(span, 1, "svelte-m69a3i", null, classes, { expandable: get(expandable) }));
  append($$anchor, span);
  pop();
}
