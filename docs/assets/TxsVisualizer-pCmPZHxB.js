import { p as push, H as state, J as proxy, q as onMount, g as get, W as onDestroy, a as from_html, s as sibling, c as child, b as if_block, t as template_effect, a5 as set_class, e as set_text, N as user_derived, v as delegated, y as bind_value, k as append, l as pop, n as set, L as each, O as index, a4 as set_style, d as set_attribute, S as getAddressLink, x as getSelectedNetworkConfig, M as getObjectLink, D as TransactionView, an as to_array, E as delegate } from "./index-BCoJFR-s.js";
import { f as fetchRecentTransactions } from "./fetchTransactions-DtA6u0Ce.js";
...
function TxsVisualizer($$anchor, $$props) {
  ...
  var node = sibling(div_1, 2);
  {
    ...
    var alternate = ($$anchor2) => {
      ...
      each(node_1, 17, () => get(multiTxAddresses), index, ($$anchor3, address) => {
        var div_14 = root_5();
        ...
        var node_2 = sibling(div_16, 2);
        {
          ...
          var d = user_derived(() => get(multiTxCommonCalls).get(get(address)));
        ...
        each(node_3, 17, () => get(txsBySender).get(get(address)) || [], index, ($$anchor4, tx) => {
          var button_4 = root_7();
          template_effect(
            ($0, $1, $2) => {
      ...
      each(node_4, 17, () => get(otherTxsByMoveCall).withMoveCall, index, ($$anchor3, $$item) => {
        ...
        each(node_5, 17, () => data().txs, index, ($$anchor4, tx) => {
          var button_5 = root_9();
          template_effect(
            ($0, $1) => {
      ...
      var node_6 = sibling(node_4, 2);
      {
        var consequent_4 = ($$anchor3) => {
          ...
          each(node_7, 17, () => get(otherTxsByMoveCall).noMoveCall, index, ($$anchor4, tx) => {
  ...
  var node_8 = sibling(node, 2);
  {
    var consequent_5 = ($$anchor2) => {
      ...
      delegated("click", div_27, closeTransactionPopup);
      delegated("keydown", div_27, (e) => e.key === "Escape" && closeTransactionPopup());
      delegated("click", div_28, (e) => e.stopPropagation());
      delegated("keydown", div_28, (e) => e.stopPropagation());
