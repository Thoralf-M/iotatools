...
import { _ as _typeof$1 } from "./jspdf.es.min-OtYTyrbC.js";
import { a as getAugmentedNamespace, g as getDefaultExportFromCjs } from "./_commonjsHelpers-BWERQOLb.js";
import "./index-SxTlDbgm.js";
var es_promise = {};
...
const performanceNow = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null
}, Symbol.toStringTag, { value: "Module" }));
const require$$0 = /* @__PURE__ */ getAugmentedNamespace(performanceNow);
var hasRequiredRaf;
function requireRaf() {
  if (hasRequiredRaf) return raf.exports;
  hasRequiredRaf = 1;
  var now = require$$0, root = typeof window === "undefined" ? globalThis : window, vendors = ["moz", "webkit"], suffix = "AnimationFrame", raf$1 = root["request" + suffix], caf = root["cancel" + suffix] || root["cancelRequest" + suffix];
