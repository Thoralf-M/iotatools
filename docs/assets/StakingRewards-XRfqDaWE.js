...
async function renderSectionsToPdf(sections) {
  const [{ jsPDF }, autoTableModule] = await Promise.all([
    __vitePreload(() => import("./jspdf.es.min-m1m_twDu.js").then((n) => n.j), true ? __vite__mapDeps([0,1,2]) : void 0),
