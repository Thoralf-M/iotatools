import { C as render_effect, D as teardown, p as push, E as state, F as proxy, r as onMount, u as store_get, n as set, f as from_html, s as sibling, c as child, G as normalizeIotaAddress, b as if_block, g as get, k as append, l as pop, v as setup_stores, t as template_effect, e as set_text, w as getSelectedNetworkConfig, H as each, I as index, d as set_attribute, J as first_child, j as bind_select_value, K as comment, L as text, B as delegate } from "./index-u8ECAdDy.js";
import { b as bind_this } from "./this-Ccxqu_8q.js";
import { I as IotaGraphQLClient } from "./client-CFGD-Pz4.js";
import { q as queryDynamicFields } from "./dynamic-fields-utils-BSGGq7N8.js";
import { g as getObjectLink, a as getTransactionLink, b as getAddressLink } from "./explorer-links-Bx4a9wSX.js";
import { u as usePageQueryParams, a as updatePageQueryParams } from "./page-query-params-DCAq4Twc.js";
...
var root_1 = from_html(`<div class="error-message svelte-1wgd05d"><strong>Error:</strong> </div>`);
var root_2 = from_html(`<div class="loading-message svelte-1wgd05d"><div class="spinner svelte-1wgd05d"></div> <span>Loading...</span></div>`);
var root_5 = from_html(`<a target="_blank" class="address-link svelte-1wgd05d"> </a>`);
var root_4 = from_html(`<div class="detail-row svelte-1wgd05d"><strong class="svelte-1wgd05d">Owner:</strong> <span class="svelte-1wgd05d"><!></span></div>`);
var root_9 = from_html(`<div class="detail-row svelte-1wgd05d"><strong class="svelte-1wgd05d">Last tx:</strong> <span class="svelte-1wgd05d"><a target="_blank" class="address-link svelte-1wgd05d"> </a></span></div>`);
var root_11 = from_html(`<div class="detail-row svelte-1wgd05d"><strong class="svelte-1wgd05d">Type:</strong> <code class="svelte-1wgd05d"> </code></div>`);
var root_12 = from_html(`<details class="dynamic-fields-details svelte-1wgd05d"><summary class="dynamic-fields-summary svelte-1wgd05d"><strong> </strong></summary> <pre class="json-content svelte-1wgd05d"> </pre></details>`);
var root_10 = from_html(`<!> <div class="detail-row svelte-1wgd05d"><strong class="svelte-1wgd05d">Contents:</strong> <button class="dynamic-fields-btn svelte-1wgd05d"> </button></div> <pre class="json-content svelte-1wgd05d"> </pre> <!>`, 1);
var root_3 = from_html(`<div class="objects-list svelte-1wgd05d"><h3 class="svelte-1wgd05d">Object Details</h3> <div class="object-item svelte-1wgd05d"><details class="object-details svelte-1wgd05d"><summary class="object-summary svelte-1wgd05d"><code class="object-address svelte-1wgd05d"> </code> <button class="explorer-btn svelte-1wgd05d">Explorer</button></summary> <div class="object-details-content svelte-1wgd05d"><!> <!> <!></div></details></div></div>`);
var root_14 = from_html(`<button class="type-btn svelte-1wgd05d"><code class="svelte-1wgd05d"> </code></button>`);
var root_13 = from_html(`<div class="package-types svelte-1wgd05d"><h3 class="svelte-1wgd05d">Package Types</h3> <div class="package-id svelte-1wgd05d"><strong class="svelte-1wgd05d">Package:</strong> <code class="svelte-1wgd05d"> </code></div> <p>Click on a type to search for objects of that type:</p> <div class="types-list"></div></div>`);
var root_16 = from_html(`<button class="load-more-btn svelte-1wgd05d"> </button>`);
var root_19 = from_html(`<a target="_blank" class="address-link svelte-1wgd05d"> </a>`);
var root_18 = from_html(`<div class="detail-row svelte-1wgd05d"><strong class="svelte-1wgd05d">Owner:</strong> <span class="svelte-1wgd05d"><!></span></div>`);
var root_23 = from_html(`<div class="detail-row svelte-1wgd05d"><strong class="svelte-1wgd05d">Last tx:</strong> <span class="svelte-1wgd05d"><a target="_blank" class="address-link svelte-1wgd05d"> </a></span></div>`);
var root_25 = from_html(`<div class="detail-row svelte-1wgd05d"><strong class="svelte-1wgd05d">Type:</strong> <code class="svelte-1wgd05d"> </code></div>`);
var root_26 = from_html(`<details class="dynamic-fields-details svelte-1wgd05d"><summary class="dynamic-fields-summary svelte-1wgd05d"><strong> </strong></summary> <pre class="json-content svelte-1wgd05d"> </pre></details>`);
var root_24 = from_html(`<!> <div class="detail-row svelte-1wgd05d"><strong class="svelte-1wgd05d">Contents:</strong> <button class="dynamic-fields-btn svelte-1wgd05d"> </button></div> <pre class="json-content svelte-1wgd05d"> </pre> <!>`, 1);
var root_17 = from_html(`<div class="object-item svelte-1wgd05d"><details class="object-details svelte-1wgd05d"><summary class="object-summary svelte-1wgd05d"><code class="object-address svelte-1wgd05d"> </code> <button class="explorer-btn svelte-1wgd05d">Explorer</button></summary> <div class="object-details-content svelte-1wgd05d"><!> <!> <!></div></details></div>`);
var root_27 = from_html(`<button class="load-more-btn bottom-load-more svelte-1wgd05d"> </button>`);
var root_15 = from_html(`<div class="objects-list svelte-1wgd05d"><div class="objects-header svelte-1wgd05d"><div class="header-controls svelte-1wgd05d"><div class="expand-controls svelte-1wgd05d"><button class="svelte-1wgd05d">Expand All</button> <button class="svelte-1wgd05d">Collapse All</button></div> <!> <div class="page-size-control svelte-1wgd05d"><label for="page-size" class="svelte-1wgd05d">Page Size:</label> <select id="page-size" class="svelte-1wgd05d"><option>1</option><option>10</option><option>20</option><option>50</option></select></div></div> <h3 class="svelte-1wgd05d"> </h3></div> <!> <!></div>`);
var root = from_html(`<div class="object-page svelte-1wgd05d"><h3 class="svelte-1wgd05d">Object Viewer</h3> <div class="input-section svelte-1wgd05d"><div class="input-header svelte-1wgd05d"><label for="object-input" class="svelte-1wgd05d">Object ID (hex), Object Type, or Package ID:</label> <div class="examples-section svelte-1wgd05d"><span class="svelte-1wgd05d">Examples:</span> <div class="button-group svelte-1wgd05d"><button class="svelte-1wgd05d">IOTA Framework</button> <button class="svelte-1wgd05d">System Package</button> <button class="svelte-1wgd05d">Clock Object</button> <button class="svelte-1wgd05d">IOTA-Names testnet</button></div></div></div> <input type="text" id="object-input" placeholder="Enter object ID (0x...), type (0x2::coin::Coin), or package ID (0x...)" class="svelte-1wgd05d"/></div> <!> <!> <!> <!> <!></div>`);
function Object$1($$anchor, $$props) {
    ...
    try {
      ...
      const result = await graphqlClient.query({
        query: `
                ...
                `,
        variables: { type, cursor, first: parseInt(get(pageSize)) }
      });
  ...
  var node_2 = sibling(node_1, 2);
  {
    var consequent_9 = ($$anchor2) => {
      ...
      button_4.__click = () => window.open(getObjectLink(getSelectedNetworkConfig(), get(objectData).address), "_blank");
      ...
      var node_7 = sibling(node_6, 2);
      {
        var consequent_8 = ($$anchor3) => {
          ...
          var button_5 = sibling(child(div_13), 2);
          button_5.__click = () => queryDynamicFieldsForObject(get(objectData).address);
      ...
      each(node_13, 17, () => get(objectsList), index, ($$anchor3, obj, i) => {
        ...
        var node_18 = sibling(node_17, 2);
        {
          var consequent_18 = ($$anchor4) => {
            ...
            var button_11 = sibling(child(div_27), 2);
            button_11.__click = () => queryDynamicFieldsForObject(get(obj).address);
            var text_21 = child(button_11);
