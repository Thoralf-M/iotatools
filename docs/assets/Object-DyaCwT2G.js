import { F as render_effect, G as teardown, I as IotaGraphQLClient, p as push, H as state, J as proxy, r as onMount, u as store_get, o as set, a as from_html, s as sibling, c as child, K as normalizeIotaAddress, d as if_block, g as get, l as append, n as pop, w as setup_stores, t as template_effect, h as set_text, L as each, M as getObjectLink, x as getSelectedNetworkConfig, N as index, O as getTransactionLink, e as set_attribute, P as first_child, k as bind_select_value, Q as comment, R as user_derived, S as getAddressLink, U as text, E as delegate } from "./index-CPgSmdCN.js";
import { b as bind_this } from "./this-DvjIPzh1.js";
import { q as queryDynamicFields } from "./dynamic-fields-Cli2kpKf.js";
import { u as usePageQueryParams, a as updatePageQueryParams } from "./page-query-params-Djlxn6AD.js";
import { g as getIotaNamesPackageId } from "./iota-names-config-vNgwkR2E.js";
...
var root_10 = from_html(`<button class="type-btn svelte-h7f06r"><code class="svelte-h7f06r"> </code></button>`);
var root_9 = from_html(`<p class="types-hint svelte-h7f06r">Click on a type to search for objects of that type:</p> <div class="types-list svelte-h7f06r"></div>`, 1);
var root_11 = from_html(`<p class="no-types svelte-h7f06r">No new types in this version</p>`);
...
var root_12 = from_html(`<button class="load-more-btn svelte-h7f06r" style="margin-top: 0.5rem;"> </button>`);
...
var root_16 = from_html(`<li class="svelte-h7f06r"> </li>`);
var root_14 = from_html(`<!> <div class="detail-row svelte-h7f06r"><strong class="svelte-h7f06r">Package</strong></div> <div class="detail-row svelte-h7f06r"><strong class="svelte-h7f06r">Modules:</strong> <ul class="svelte-h7f06r"></ul></div>`, 1);
...
var root_13 = from_html(`<div class="objects-list svelte-h7f06r"><h3 class="svelte-h7f06r">Object Details</h3> <div class="object-item svelte-h7f06r"><details class="object-details svelte-h7f06r"><summary class="object-summary svelte-h7f06r"><code class="object-address svelte-h7f06r"> </code> <button class="explorer-btn svelte-h7f06r">Explorer</button></summary> <div class="object-details-content svelte-h7f06r"><!></div></details></div></div>`);
var root_28 = from_html(`<button class="load-more-btn svelte-h7f06r"> </button>`);
var root_31 = from_html(`<a target="_blank" class="address-link svelte-h7f06r"> </a>`);
var root_30 = from_html(`<div class="detail-row svelte-h7f06r"><strong class="svelte-h7f06r">Owner:</strong> <span class="svelte-h7f06r"><!></span></div>`);
var root_35 = from_html(`<div class="detail-row svelte-h7f06r"><strong class="svelte-h7f06r">Last tx:</strong> <span class="svelte-h7f06r"><a target="_blank" class="address-link svelte-h7f06r"> </a></span></div>`);
var root_37 = from_html(`<div class="detail-row svelte-h7f06r"><strong class="svelte-h7f06r">Type:</strong> <code class="svelte-h7f06r"> </code></div>`);
var root_38 = from_html(`<details class="dynamic-fields-details svelte-h7f06r"><summary class="dynamic-fields-summary svelte-h7f06r"><strong> </strong></summary> <pre class="json-content svelte-h7f06r"> </pre></details>`);
var root_36 = from_html(`<!> <div class="detail-row svelte-h7f06r"><strong class="svelte-h7f06r">Contents:</strong> <button class="dynamic-fields-btn svelte-h7f06r"> </button></div> <pre class="json-content svelte-h7f06r"> </pre> <!>`, 1);
var root_29 = from_html(`<div class="object-item svelte-h7f06r"><details class="object-details svelte-h7f06r"><summary class="object-summary svelte-h7f06r"><code class="object-address svelte-h7f06r"> </code> <button class="explorer-btn svelte-h7f06r">Explorer</button></summary> <div class="object-details-content svelte-h7f06r"><!> <!> <!></div></details></div>`);
var root_39 = from_html(`<button class="load-more-btn bottom-load-more svelte-h7f06r"> </button>`);
var root_27 = from_html(`<div class="objects-list svelte-h7f06r"><div class="objects-header svelte-h7f06r"><div class="header-controls svelte-h7f06r"><div class="expand-controls svelte-h7f06r"><button class="svelte-h7f06r">Expand All</button> <button class="svelte-h7f06r">Collapse All</button></div> <!> <div class="page-size-control svelte-h7f06r"><label for="page-size" class="svelte-h7f06r">Page Size:</label> <select id="page-size" class="svelte-h7f06r"><option>1</option><option>5</option><option>10</option><option>20</option><option>50</option></select></div></div> <h3 class="svelte-h7f06r"> </h3></div> <!> <!></div>`);
...
function Object$1($$anchor, $$props) {
  ...
  var node_2 = sibling(node_1, 2);
  {
    var consequent_7 = ($$anchor2) => {
      ...
      each(node_3, 17, () => get(packageVersions), index, ($$anchor3, ver, i) => {
        ...
        button_4.__click = () => toggleVersionExpand(i, get(ver).address);
        ...
        button_5.__click = () => window.open(getObjectLink(getSelectedNetworkConfig(), get(ver).address), "_blank");
          ...
          var consequent_5 = ($$anchor4) => {
            ...
            var node_5 = child(div_10);
            {
              ...
              var alternate_1 = ($$anchor5) => {
                ...
                var node_6 = first_child(fragment);
                {
                  var consequent_4 = ($$anchor6) => {
                    ...
                    var node_7 = first_child(fragment_1);
                    {
                      var consequent_3 = ($$anchor7) => {
                        ...
                        var div_12 = sibling(first_child(fragment_2), 2);
                        each(div_12, 21, () => get(newTypes), index, ($$anchor8, type) => {
                          var button_6 = root_10();
                          button_6.__click = () => searchType(get(type).fullType);
                  ...
                  if_block(
                    node_6,
                    ($$render) => {
                      if (isVersionTypesReady(i)) $$render(consequent_4);
                    },
                    true
                  );
                }
              ...
              if_block(node_5, ($$render) => {
                if (isVersionTypesLoading(i)) $$render(consequent_2);
      ...
      var node_8 = sibling(node_3, 2);
      {
        var consequent_6 = ($$anchor3) => {
          var button_7 = root_12();
          button_7.__click = loadMoreVersions;
  ...
  var node_9 = sibling(node_2, 2);
  {
    var consequent_17 = ($$anchor2) => {
      ...
      button_8.__click = () => window.open(getObjectLink(getSelectedNetworkConfig(), get(objectData).address), "_blank");
        ...
        var alternate_4 = ($$anchor3) => {
                ...
                var alternate_3 = ($$anchor5) => {
                  ...
                  var node_14 = first_child(fragment_5);
                  {
                    ...
                    if_block(
                      node_14,
                      ($$render) => {
                        if (get(objectData).owner.initialSharedVersion) $$render(consequent_11);
          ...
          var node_16 = sibling(node_15, 2);
          {
            var consequent_16 = ($$anchor4) => {
              ...
              button_9.__click = () => queryDynamicFieldsForObject(get(objectData).address);
              var text_15 = child(button_9);
              var pre = sibling(div_21, 2);
              var text_16 = child(pre);
              var node_18 = sibling(pre, 2);
              {
                ...
                if_block(node_18, ($$render) => {
                  if (get(objectData).address && (get(dynamicFieldsMap).get(get(objectData).address)?.length ?? 0) > 0) $$render(consequent_15);
                });
              }
              template_effect(
                ($0, $1, $2) => {
  ...
  var node_19 = sibling(node_9, 2);
  {
    var consequent_27 = ($$anchor2) => {
      ...
      button_10.__click = expandAllObjects;
      var button_11 = sibling(button_10, 2);
      button_11.__click = collapseAllObjects;
      var node_20 = sibling(div_25, 2);
      {
        var consequent_18 = ($$anchor3) => {
          var button_12 = root_28();
      ...
      var node_21 = sibling(div_23, 2);
      each(node_21, 17, () => get(objectsList), index, ($$anchor3, obj, i) => {
        var div_27 = root_29();
        ...
        button_13.__click = () => window.open(getObjectLink(getSelectedNetworkConfig(), get(obj).address), "_blank");
              ...
              var alternate_6 = ($$anchor5) => {
                ...
                var node_24 = first_child(fragment_9);
                {
                  var consequent_20 = ($$anchor6) => {
                    ...
                    append($$anchor6, text_23);
                  };
                  var alternate_5 = ($$anchor6) => {
                    var text_24 = text();
                    template_effect(($0) => set_text(text_24, $0), [() => JSON.stringify(get(obj).owner)]);
                    append($$anchor6, text_24);
                  };
                  if_block(
                    node_24,
                    ($$render) => {
                      if (get(obj).owner.initialSharedVersion) $$render(consequent_20);
        ...
        var node_26 = sibling(node_25, 2);
        {
          var consequent_25 = ($$anchor4) => {
            ...
            button_14.__click = () => queryDynamicFieldsForObject(get(obj).address);
            var text_27 = child(button_14);
            var pre_2 = sibling(div_32, 2);
            var text_28 = child(pre_2);
            var node_28 = sibling(pre_2, 2);
            {
              var consequent_24 = ($$anchor5) => {
                var details_3 = root_38();
              ...
              if_block(node_28, ($$render) => {
                if (get(obj).address && (get(dynamicFieldsMap).get(get(obj).address)?.length ?? 0) > 0) $$render(consequent_24);
              });
            }
            template_effect(
              ($0, $1, $2) => {
      ...
      var node_29 = sibling(node_21, 2);
      {
        var consequent_26 = ($$anchor3) => {
          var button_15 = root_39();
          button_15.__click = loadNextPage;
