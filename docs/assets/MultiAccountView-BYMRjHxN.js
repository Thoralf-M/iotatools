import { p as push, V as state, W as proxy, f as from_html, c as child, s as sibling, b as if_block, g as get, n as set, I as each, t as template_effect, d as set_attribute, e as set_text, k as append, S as set_class, h as event, a0 as user_derived, x as bind_value, j as bind_select_value, l as pop, v as setup_stores, u as store_get, o as getClient, A as toBase64, Y as isValidIotaAddress, P as text, Q as comment, O as first_child, aa as iota_accounts, ae as Transaction, af as iota_wallets, B as delegate } from "/iota-utils/assets/index-vY-WO24d.js";
import { b as fetchCurrentPrice, a as action } from "/iota-utils/assets/price-fetching-E8y_rCbL.js";
import { T as TransactionView } from "/iota-utils/assets/TransactionView-Bhi_UfWp.js";
import { n as nanoToIota } from "/iota-utils/assets/iota-nano-conversion-b3Q1k4mO.js";
import { c as computeStakingRewards } from "/iota-utils/assets/staking-utils-BNbIK5kk.js";
import { c as calculateGasFee } from "/iota-utils/assets/transaction-execution-BV0iihtw.js";
...
var root_4 = from_html(`<div><div class="object-header svelte-1d1qa4j"><span class="object-type svelte-1d1qa4j"><!></span> <span class="object-amount svelte-1d1qa4j"><!></span></div> <div style="position: relative;"><!> <details class="object-details svelte-1d1qa4j"><summary style="text-align: center; list-style-position: inside;" class="svelte-1d1qa4j">Data</summary> <pre class="svelte-1d1qa4j"> </pre></details></div></div>`);
var root_13 = from_html(`<div style="text-align: center; color: var(--text-muted); padding: 1rem; font-size: 0.8rem;">No objects</div>`);
var root_15 = from_html(`<div class="object-item svelte-1d1qa4j" style="border-color: rgba(248, 113, 113, 0.3);"><div class="object-header svelte-1d1qa4j"><span class="object-type svelte-1d1qa4j"> </span> <span class="object-amount svelte-1d1qa4j"><!></span></div> <details class="object-details svelte-1d1qa4j"><summary class="svelte-1d1qa4j">Data</summary> <pre class="svelte-1d1qa4j"> </pre></details></div>`);
...
var root_3 = from_html(`<div class="object-list svelte-1d1qa4j"><!> <!> <!></div>`);
var root_2 = from_html(`<div class="account-card svelte-1d1qa4j"><div class="account-header svelte-1d1qa4j"><div style="display: flex; flex-direction: column;"><div style="display: flex; align-items: center; gap: 0.5rem;"><span class="account-title svelte-1d1qa4j"> </span> <button style="font-size: 0.7rem; padding: 0.1rem 0.3rem; width: fit-content; background: var(--secondary-color); border-radius: 3px;">Copy Address</button></div> <div class="account-buttons svelte-1d1qa4j" style="display: flex; gap: 0.5rem; margin-top: 0.2rem;"><button style="font-size: 0.7rem; padding: 0.1rem 0.3rem; width: fit-content; border-radius: 3px;"> </button></div></div> <div style="text-align: right; display: flex; flex-direction: column; align-items: flex-end; gap: 0.2rem;"><button class="danger svelte-1d1qa4j" style="font-size: 0.7rem; padding: 0.1rem 0.3rem; width: fit-content; border-radius: 3px;">Remove</button> <div class="account-balance svelte-1d1qa4j"> <span style="font-size: 0.8em; color: var(--text-muted);">IOTA</span></div></div></div> <!></div>`);
var root = from_html(`<main class="container svelte-1d1qa4j"><div class="toolbar svelte-1d1qa4j"><div style="display: flex; gap: 0.5rem;"><button style="background: #059669;" class="svelte-1d1qa4j">Sync/Reset</button></div> <div style="display: flex; align-items: center; gap: 0.5rem; flex-grow: 1; flex-wrap: wrap;"><input type="text" placeholder="Enter external address (0x...)" class="svelte-1d1qa4j"/> <button class="svelte-1d1qa4j">Add Account</button></div> <div style="display: flex; gap: 0.5rem;"><button class="svelte-1d1qa4j">Dry Run</button> <button class="svelte-1d1qa4j">Prepare Tx Bytes</button> <button class="svelte-1d1qa4j">Send</button></div></div> <!> <!> <div class="summary-section svelte-1d1qa4j"><div class="summary-header svelte-1d1qa4j"><h3 class="svelte-1d1qa4j">Balance Breakdown</h3> <div class="price-controls svelte-1d1qa4j"><select class="svelte-1d1qa4j"><option>USD</option><option>EUR</option></select> <button class="svelte-1d1qa4j">Fetch Price</button></div></div> <div class="table-wrapper"><table class="summary-table svelte-1d1qa4j"><thead><tr><th class="svelte-1d1qa4j">Category</th><th class="svelte-1d1qa4j">Amount (IOTA)</th><th class="svelte-1d1qa4j"> </th></tr></thead><tbody><tr class="total-row" style="background: rgba(16, 185, 129, 0.1);"><td class="svelte-1d1qa4j"><strong>Total</strong></td><td class="svelte-1d1qa4j"><strong> </strong></td><td class="svelte-1d1qa4j"><strong> </strong></td></tr><tr><td class="svelte-1d1qa4j">IOTA Coins</td><td class="svelte-1d1qa4j"> </td><td class="svelte-1d1qa4j"> </td></tr><tr><td class="svelte-1d1qa4j">Staked</td><td class="svelte-1d1qa4j"> </td><td class="svelte-1d1qa4j"> </td></tr><tr><td class="svelte-1d1qa4j">Staking Rewards</td><td class="svelte-1d1qa4j"> </td><td class="svelte-1d1qa4j"> </td></tr></tbody></table></div></div> <div class="accounts-grid svelte-1d1qa4j"></div></main>`);
    ...
    var node_2 = sibling(div_11, 2);
    {
      var consequent_10 = ($$anchor3) => {
        ...
        each(node_3, 17, () => get(account).objects, (item) => item.id, ($$anchor4, item) => {
          ...
          template_effect(
            ($0) => {
              classes = set_class(div_18, 1, "object-item svelte-1d1qa4j", null, classes, { foreign: get(account).address !== get(item).currentOwner });
