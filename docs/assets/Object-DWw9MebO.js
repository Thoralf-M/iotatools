import { F as render_effect, G as teardown, I as IotaGraphQLClient, p as push, H as state, J as proxy, q as onMount, r as store_get, n as set, a as from_html, s as sibling, c as child, b as if_block, g as get, v as delegated, K as normalizeIotaAddress, k as append, l as pop, w as setup_stores, t as template_effect, e as set_text, L as each, M as getObjectLink, x as getSelectedNetworkConfig, N as user_derived, O as index, P as getTransactionLink, d as set_attribute, Q as first_child, j as bind_select_value, R as comment, S as getAddressLink, U as text, E as delegate } from "./index-CucOG5wu.js";
import { b as bind_this } from "./this-C-CXai7f.js";
import { q as queryDynamicFields } from "./dynamic-fields-B1UV0EMm.js";
import { u as usePageQueryParams, a as updatePageQueryParams } from "./page-query-params-DNaY494g.js";
import { g as getIotaNamesPackageId } from "./iota-names-config-DFVG7pyd.js";
...
async function fetchPackageVersionsData(packageAddress, graphqlUrl, cursor = null, first = 10) {
  ...
  return result.data?.packageVersions || null;
}
...
var root_6 = from_html(`<div class="loading-message svelte-h7f06r" style="padding: 0.5rem; margin: 0.25rem 0;"><div class="spinner svelte-h7f06r"></div> <span>Loading types...</span></div>`);
var root_9 = from_html(`<button class="type-btn svelte-h7f06r"><code class="svelte-h7f06r"> </code></button>`);
var root_8 = from_html(`<p class="types-hint svelte-h7f06r">Click on a type to search for objects of that type:</p> <div class="types-list svelte-h7f06r"></div>`, 1);
var root_10 = from_html(`<p class="no-types svelte-h7f06r">No new types in this version</p>`);
var root_5 = from_html(`<div class="version-types svelte-h7f06r"><!></div>`);
var root_4 = from_html(`<div class="version-item svelte-h7f06r"><div class="version-header svelte-h7f06r"><button class="version-toggle-btn svelte-h7f06r"><span class="version-arrow svelte-h7f06r"> </span> <strong> </strong> <code class="version-address svelte-h7f06r"> </code></button> <button class="explorer-btn svelte-h7f06r">Explorer</button></div> <!></div>`);
var root_11 = from_html(`<button class="load-more-btn svelte-h7f06r" style="margin-top: 0.5rem;"> </button>`);
var root_3 = from_html(`<div class="package-types svelte-h7f06r"><h3 class="svelte-h7f06r"> </h3> <!> <!></div>`);
var root_15 = from_html(`<strong class="svelte-h7f06r">Version:</strong> <code class="svelte-h7f06r"> </code>`, 1);
var root_16 = from_html(`<strong class="svelte-h7f06r">Digest:</strong> <code class="svelte-h7f06r"> </code>`, 1);
var root_14 = from_html(`<div class="detail-row svelte-h7f06r"><!> <!></div>`);
var root_17 = from_html(`<div class="detail-row svelte-h7f06r"><strong class="svelte-h7f06r">Last tx:</strong> <span class="svelte-h7f06r"><a target="_blank" class="address-link svelte-h7f06r"> </a></span></div>`);
var root_18 = from_html(`<li class="svelte-h7f06r"> </li>`);
var root_13 = from_html(`<!> <!> <div class="detail-row svelte-h7f06r"><strong class="svelte-h7f06r">Package</strong></div> <div class="detail-row svelte-h7f06r"><strong class="svelte-h7f06r">Modules:</strong> <ul class="svelte-h7f06r"></ul></div>`, 1);
var root_21 = from_html(`<strong class="svelte-h7f06r">Version:</strong> <code class="svelte-h7f06r"> </code>`, 1);
var root_22 = from_html(`<strong class="svelte-h7f06r">Digest:</strong> <code class="svelte-h7f06r"> </code>`, 1);
var root_20 = from_html(`<div class="detail-row svelte-h7f06r"><!> <!></div>`);
var root_24 = from_html(`<a target="_blank" class="address-link svelte-h7f06r"> </a>`);
var root_23 = from_html(`<div class="detail-row svelte-h7f06r"><strong class="svelte-h7f06r">Owner:</strong> <span class="svelte-h7f06r"><!></span></div>`);
...
var root_12 = from_html(`<div class="objects-list svelte-h7f06r"><h3 class="svelte-h7f06r">Object Details</h3> <div class="object-item svelte-h7f06r"><details class="object-details svelte-h7f06r"><summary class="object-summary svelte-h7f06r"><code class="object-address svelte-h7f06r"> </code> <button class="explorer-btn svelte-h7f06r">Explorer</button></summary> <div class="object-details-content svelte-h7f06r"><!></div></details></div></div>`);
var root_32 = from_html(`<button class="load-more-btn svelte-h7f06r"> </button>`);
var root_35 = from_html(`<strong class="svelte-h7f06r">Version:</strong> <code class="svelte-h7f06r"> </code>`, 1);
var root_36 = from_html(`<strong class="svelte-h7f06r">Digest:</strong> <code class="svelte-h7f06r"> </code>`, 1);
var root_34 = from_html(`<div class="detail-row svelte-h7f06r"><!> <!></div>`);
var root_38 = from_html(`<a target="_blank" class="address-link svelte-h7f06r"> </a>`);
var root_37 = from_html(`<div class="detail-row svelte-h7f06r"><strong class="svelte-h7f06r">Owner:</strong> <span class="svelte-h7f06r"><!></span></div>`);
var root_41 = from_html(`<div class="detail-row svelte-h7f06r"><strong class="svelte-h7f06r">Last tx:</strong> <span class="svelte-h7f06r"><a target="_blank" class="address-link svelte-h7f06r"> </a></span></div>`);
var root_43 = from_html(`<div class="detail-row svelte-h7f06r"><strong class="svelte-h7f06r">Type:</strong> <code class="svelte-h7f06r"> </code></div>`);
var root_44 = from_html(`<details class="dynamic-fields-details svelte-h7f06r"><summary class="dynamic-fields-summary svelte-h7f06r"><strong> </strong></summary> <pre class="json-content svelte-h7f06r"> </pre></details>`);
var root_42 = from_html(`<!> <div class="detail-row svelte-h7f06r"><strong class="svelte-h7f06r">Contents:</strong> <button class="dynamic-fields-btn svelte-h7f06r"> </button></div> <pre class="json-content svelte-h7f06r"> </pre> <!>`, 1);
var root_33 = from_html(`<div class="object-item svelte-h7f06r"><details class="object-details svelte-h7f06r"><summary class="object-summary svelte-h7f06r"><code class="object-address svelte-h7f06r"> </code> <button class="explorer-btn svelte-h7f06r">Explorer</button></summary> <div class="object-details-content svelte-h7f06r"><!> <!> <!> <!></div></details></div>`);
var root_45 = from_html(`<button class="load-more-btn bottom-load-more svelte-h7f06r"> </button>`);
var root_31 = from_html(`<div class="objects-list svelte-h7f06r"><div class="objects-header svelte-h7f06r"><div class="header-controls svelte-h7f06r"><div class="expand-controls svelte-h7f06r"><button class="svelte-h7f06r">Expand All</button> <button class="svelte-h7f06r">Collapse All</button></div> <!> <div class="page-size-control svelte-h7f06r"><label for="page-size" class="svelte-h7f06r">Page Size:</label> <select id="page-size" class="svelte-h7f06r"><option>1</option><option>5</option><option>10</option><option>20</option><option>50</option></select></div></div> <h3 class="svelte-h7f06r"> </h3></div> <!> <!></div>`);
...
function Object$1($$anchor, $$props) {
  ...
  async function queryDynamicFieldsForObject(objectId) {
    ...
    set(dynamicFieldsLoading, new Map(get(
    ...
    set(dynamicFieldsMap, new Map(get(
      dynamicFieldsMap
      // Trigger reactivity
    )), true);
    set(dynamicFieldsInitiallyOpen, new Map(get(
      dynamicFieldsInitiallyOpen
      // Trigger reactivity
    )), true);
  }
  ...
  async function fetchPackageVersions(packageId, cursor = null) {
    try {
      if (!cursor) {
        ...
        set(packageVersionsLoading, true);
      }
      set(error, "");
      const config = getSelectedNetworkConfig();
      ...
      if (cursor) {
        ...
        for (let i = startIndex; i < get(packageVersions).length; i++) {
          if (getNewTypesForVersion(i).length > 0) {
            get(expandedVersions)[i] = true;
          }
        }
      } else {
        set(packageVersions, result.nodes, true);
      }
      ...
      if (!cursor && get(packageVersions).length > 0) {
        ...
        for (let i = 0; i < get(packageVersions).length; i++) {
          if (getNewTypesForVersion(i).length > 0) {
            get(expandedVersions)[i] = true;
          }
        }
  ...
  async function loadMoreVersions() {
    ...
    await fetchPackageVersions(input, get(packageVersionsCursor));
  }
  async function toggleVersionExpand(index2, versionAddress) {
    get(expandedVersions)[index2] = !get(expandedVersions)[index2];
    if (get(expandedVersions)[index2]) {
      const fetchPromises = [];
      for (let j = 0; j <= index2; j++) {
        fetchPromises.push(fetchTypesForVersion(get(packageVersions)[j].address));
      }
      await Promise.all(fetchPromises);
    }
  }
  function isVersionTypesLoading(index2) {
    for (let j = 0; j <= index2; j++) {
      if (get(packageTypesLoadingMap).get(get(packageVersions)[j].address)) return true;
    }
    return false;
  }
  function isVersionTypesReady(index2) {
    for (let j = 0; j <= index2; j++) {
      if (!get(packageTypesPerVersion).has(get(packageVersions)[j].address)) return false;
    }
    return true;
  }
  function getNewTypesForVersion(index2) {
    const versionAddress = get(packageVersions)[index2].address;
    const types = get(packageTypesPerVersion).get(versionAddress) ?? [];
    const earlierTypes = /* @__PURE__ */ new Set();
    for (let j = 0; j < index2; j++) {
      const prevTypes = get(packageTypesPerVersion).get(get(packageVersions)[j].address) ?? [];
  ...
  var node_2 = sibling(node_1, 2);
  {
    var consequent_7 = ($$anchor2) => {
      ...
      each(node_3, 17, () => get(packageVersions), index, ($$anchor3, ver, i) => {
        var div_8 = root_4();
              ...
              var consequent_4 = ($$anchor5) => {
                ...
                var node_6 = first_child(fragment);
                {
                  var consequent_3 = ($$anchor6) => {
                    ...
                    each(div_12, 21, () => get(newTypes), index, ($$anchor7, type) => {
                      var button_6 = root_9();
  ...
  var node_8 = sibling(node_2, 2);
  {
        ...
        var alternate_2 = ($$anchor3) => {
          ...
          var node_17 = sibling(node_14, 2);
          {
            var consequent_18 = ($$anchor4) => {
              ...
              var node_18 = child(span_2);
              {
                ...
                var consequent_17 = ($$anchor5) => {
                  var text_15 = text();
                  template_effect(() => set_text(text_15, `Shared (v${get(objectData).owner.initialSharedVersion ?? ""})`));
                  append($$anchor5, text_15);
                };
                var alternate_1 = ($$anchor5) => {
                  var text_16 = text();
                  template_effect(($0) => set_text(text_16, $0), [() => JSON.stringify(get(objectData).owner)]);
                  append($$anchor5, text_16);
                };
                if_block(node_18, ($$render) => {
                  if (get(objectData).owner.owner) $$render(consequent_16);
                  else if (get(objectData).owner.initialSharedVersion) $$render(consequent_17, 1);
            ...
            if_block(node_17, ($$render) => {
              if (get(objectData).owner) $$render(consequent_18);
            });
          }
          var node_19 = sibling(node_17, 2);
          {
            var consequent_19 = ($$anchor4) => {
              var div_21 = root_27();
              var span_3 = sibling(child(div_21), 2);
              var a_2 = child(span_3);
              var text_17 = child(a_2);
              template_effect(
                ($0) => {
                  set_attribute(a_2, "href", $0);
                  set_text(text_17, get(objectData).previousTransactionBlock.digest);
                },
                [
                  () => getTransactionLink(getSelectedNetworkConfig(), get(objectData).previousTransactionBlock.digest)
                ]
            ...
            if_block(node_19, ($$render) => {
              if (get(objectData).previousTransactionBlock) $$render(consequent_19);
            });
          }
          var node_20 = sibling(node_19, 2);
          {
            var consequent_22 = ($$anchor4) => {
              ...
              var node_21 = first_child(fragment_10);
              {
                var consequent_20 = ($$anchor5) => {
                  ...
                  var text_18 = child(code_7);
                  template_effect(() => set_text(text_18, get(objectData).asMoveObject.contents.type?.repr || "Unknown"));
                  append($$anchor5, div_22);
                };
                if_block(node_21, ($$render) => {
                  if (get(currentInputType) === "hex") $$render(consequent_20);
                });
              }
              var div_23 = sibling(node_21, 2);
              var button_9 = sibling(child(div_23), 2);
              var text_19 = child(button_9);
              var pre = sibling(div_23, 2);
              var text_20 = child(pre);
              var node_22 = sibling(pre, 2);
              {
                var consequent_21 = ($$anchor5) => {
                  var details_1 = root_30();
                  var summary_1 = child(details_1);
                  var strong_1 = child(summary_1);
                  var text_21 = child(strong_1);
                  var pre_1 = sibling(summary_1, 2);
                  var text_22 = child(pre_1);
                  template_effect(
                    ($0, $1, $2) => {
                      details_1.open = $0;
                      set_text(text_21, `Dynamic Fields (${$1 ?? ""})`);
                      set_text(text_22, $2);
                    },
                    [
            ...
            if_block(node_20, ($$render) => {
              if (get(objectData).asMoveObject) $$render(consequent_22);
            });
          }
    ...
    if_block(node_8, ($$render) => {
      if (get(objectData)) $$render(consequent_23);
    });
  }
  var node_23 = sibling(node_8, 2);
  {
    var consequent_36 = ($$anchor2) => {
      ...
      var node_24 = sibling(div_27, 2);
      {
        var consequent_24 = ($$anchor3) => {
          var button_12 = root_32();
          var text_23 = child(button_12);
          template_effect(() => {
            button_12.disabled = get(loadingNext);
            set_text(text_23, get(loadingNext) ? "Loading..." : "Load More");
          });
          delegated("click", button_12, loadNextPage);
          append($$anchor3, button_12);
        };
        if_block(node_24, ($$render) => {
          if (get(hasNext)) $$render(consequent_24);
        });
      }
      var div_28 = sibling(node_24, 2);
      ...
      each(node_25, 17, () => get(objectsList), index, ($$anchor3, obj, i) => {
          ...
          var consequent_27 = ($$anchor4) => {
            ...
            var node_27 = child(div_31);
            {
              var consequent_25 = ($$anchor5) => {
                ...
                var code_9 = sibling(first_child(fragment_11), 2);
                var text_26 = child(code_9);
                template_effect(() => set_text(text_26, get(obj).version));
                append($$anchor5, fragment_11);
              };
              if_block(node_27, ($$render) => {
                if (get(obj).version) $$render(consequent_25);
              });
            }
            var node_28 = sibling(node_27, 2);
            {
              var consequent_26 = ($$anchor5) => {
                ...
                var code_10 = sibling(first_child(fragment_12), 2);
                var text_27 = child(code_10);
                template_effect(() => set_text(text_27, get(obj).digest));
                append($$anchor5, fragment_12);
              };
              if_block(node_28, ($$render) => {
                if (get(obj).digest) $$render(consequent_26);
              });
            }
            append($$anchor4, div_31);
          };
          if_block(node_26, ($$render) => {
            if (get(obj).version || get(obj).digest) $$render(consequent_27);
          });
        }
        var node_29 = sibling(node_26, 2);
        {
          var consequent_30 = ($$anchor4) => {
            var div_32 = root_37();
            var span_4 = sibling(child(div_32), 2);
            var node_30 = child(span_4);
            {
              var consequent_28 = ($$anchor5) => {
                ...
                template_effect(
                  ($0) => {
                    ...
                    set_text(text_28, get(obj).owner.owner.address || get(obj).owner.owner);
                  },
                  [
              ...
              var consequent_29 = ($$anchor5) => {
                var text_29 = text();
                template_effect(() => set_text(text_29, `Shared (v${get(obj).owner.initialSharedVersion ?? ""})`));
                append($$anchor5, text_29);
              };
              var alternate_3 = ($$anchor5) => {
                var text_30 = text();
                template_effect(($0) => set_text(text_30, $0), [() => JSON.stringify(get(obj).owner)]);
                append($$anchor5, text_30);
              };
              if_block(node_30, ($$render) => {
                if (get(obj).owner.owner) $$render(consequent_28);
                else if (get(obj).owner.initialSharedVersion) $$render(consequent_29, 1);
          ...
          if_block(node_29, ($$render) => {
            if (get(obj).owner) $$render(consequent_30);
          });
        }
        var node_31 = sibling(node_29, 2);
        {
          var consequent_31 = ($$anchor4) => {
            ...
            var a_4 = child(span_5);
            var text_31 = child(a_4);
            template_effect(
              ($0) => {
                set_attribute(a_4, "href", $0);
                set_text(text_31, get(obj).previousTransactionBlock.digest);
              },
              [
          ...
          if_block(node_31, ($$render) => {
            if (get(obj).previousTransactionBlock) $$render(consequent_31);
          });
        }
        var node_32 = sibling(node_31, 2);
        {
          var consequent_34 = ($$anchor4) => {
            ...
            var node_33 = first_child(fragment_15);
            {
              var consequent_32 = ($$anchor5) => {
                ...
                var text_32 = child(code_11);
                template_effect(() => set_text(text_32, get(obj).asMoveObject.contents.type?.repr || "Unknown"));
                append($$anchor5, div_34);
              };
              if_block(node_33, ($$render) => {
                if (get(currentInputType) === "hex") $$render(consequent_32);
              });
            }
            var div_35 = sibling(node_33, 2);
            var button_14 = sibling(child(div_35), 2);
            var text_33 = child(button_14);
            var pre_2 = sibling(div_35, 2);
            var text_34 = child(pre_2);
            var node_34 = sibling(pre_2, 2);
            {
              var consequent_33 = ($$anchor5) => {
                var details_3 = root_44();
                var summary_3 = child(details_3);
                var strong_2 = child(summary_3);
                var text_35 = child(strong_2);
                var pre_3 = sibling(summary_3, 2);
                var text_36 = child(pre_3);
                template_effect(
                  ($0, $1, $2) => {
                    details_3.open = $0;
                    set_text(text_35, `Dynamic Fields (${$1 ?? ""})`);
                    set_text(text_36, $2);
                  },
                  [
              ...
              if_block(node_34, ($$render) => {
                if (get(d_3)) $$render(consequent_33);
              });
            }
            template_effect(
              ($0, $1, $2) => {
          ...
          if_block(node_32, ($$render) => {
            if (get(obj).asMoveObject) $$render(consequent_34);
          });
        }
        template_effect(() => set_text(text_25, get(obj).address));
      ...
      var node_35 = sibling(node_25, 2);
      {
        var consequent_35 = ($$anchor3) => {
          var button_15 = root_45();
          var text_37 = child(button_15);
          template_effect(() => {
            button_15.disabled = get(loadingNext);
            set_text(text_37, get(loadingNext) ? "Loading..." : "Load More");
          });
          delegated("click", button_15, loadNextPage);
          append($$anchor3, button_15);
        };
        if_block(node_35, ($$render) => {
          if (get(hasNext)) $$render(consequent_35);
        });
      }
      template_effect(() => set_text(text_24, `Objects (${get(objectsList).length ?? ""})`));
    ...
    if_block(node_23, ($$render) => {
      if (get(objectsList).length > 0) $$render(consequent_36);
    });
  }
