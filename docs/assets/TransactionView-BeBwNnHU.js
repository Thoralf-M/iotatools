import { a7 as bcs, aa as fromB64, p as push, r as prop, w as legacy_pre_effect, j as set, m as mutable_source, x as deep_read_state, g as get, y as legacy_pre_effect_reset, i as init, f as from_html, b as if_block, c as child, k as append, l as pop, G as first_child, s as sibling, C as untrack, t as template_effect, K as getSelectedNetworkConfig, d as set_text, J as set_style, I as comment, z as each, A as index, a6 as derived_safe_equal, H as text, L as set_class, e as event } from "/iota-utils/assets/index-D8OM-sNc.js";
import { f as formatJsonWithCompactArrays, r as removeKindFields, i as isTransactionData, g as getTransactionData, R as Root } from "/iota-utils/assets/transaction-view-CuBbJ2R9.js";
import { s as set_attribute } from "/iota-utils/assets/attributes-ctlhnk33.js";
import { a as formatNumberWithUnderscores, n as nanoToIota } from "/iota-utils/assets/iota-nano-conversion-Df5aFe-n.js";
...
var root_4 = from_html(`<span class="field-value svelte-a1c9r5">N/A</span>`);
...
var root_9 = from_html(`<div class="full-address svelte-a1c9r5">N/A</div>`);
...
var root_6 = from_html(`<div class="section svelte-a1c9r5"><h4 class="svelte-a1c9r5"> </h4> <div class="balance-columns svelte-a1c9r5"><div class="negative-changes svelte-a1c9r5"><h5 class="column-header deleted svelte-a1c9r5"> </h5> <div class="balance-content svelte-a1c9r5"></div></div> <div class="positive-changes svelte-a1c9r5"><h5 class="column-header created svelte-a1c9r5"> </h5> <div class="balance-content svelte-a1c9r5"></div></div></div></div>`);
...
var root$1 = from_html(`<div class="transaction-effects svelte-a1c9r5"><!></div>`);
...
var root_1 = from_html(`<button>Formatted View</button>`);
var root_2 = from_html(`<button>Tx Bytes</button>`);
var root_3 = from_html(`<div class="tx-bytes-view svelte-1u6kzt3"><button class="copy-btn svelte-1u6kzt3">Copy Bytes</button> <pre class="wrap-bytes svelte-1u6kzt3"> </pre></div>`);
var root_5 = from_html(`<div class="formatted-view svelte-1u6kzt3"><!></div>`);
var root_7 = from_html(`<div class="tree-view svelte-1u6kzt3"><!></div>`);
var root_8 = from_html(`<div class="json-view svelte-1u6kzt3"><pre class="svelte-1u6kzt3"> </pre></div>`);
var root = from_html(`<div class="transaction-view ultra-compact svelte-1u6kzt3"><div class="view-controls svelte-1u6kzt3"><!> <button>Raw JSON</button> <button>JSON Tree</button> <!></div> <!></div>`);
function TransactionView($$anchor, $$props) {
  push($$props, false);
  const hasTxBytes = mutable_source();
  let value = prop($$props, "value", 8);
  let viewMode = mutable_source("formatted");
  let showTxBytes = mutable_source(false);
  let prevViewMode = mutable_source("formatted");
  ...
  legacy_pre_effect(() => (get(showTxBytes), get(viewMode), get(prevViewMode)), () => {
    if (get(showTxBytes)) {
      if (get(viewMode) !== "txbytes") {
        set(prevViewMode, get(viewMode));
        set(viewMode, "txbytes");
      }
    } else if (get(viewMode) === "txbytes") {
      set(viewMode, get(prevViewMode));
    }
  });
  legacy_pre_effect(() => deep_read_state(value()), () => {
    set(hasTxBytes, value() && typeof value() === "object" && "transactionBytes" in value() && value().transactionBytes);
  });
  legacy_pre_effect_reset();
  init();
  var div = root();
  ...
  var node = child(div_1);
  {
    var consequent = ($$anchor2) => {
      var button = root_1();
      let classes;
      template_effect(($0) => classes = set_class(button, 1, "svelte-1u6kzt3", null, classes, $0), [() => ({ active: get(viewMode) === "formatted" })]);
      event("click", button, () => {
        set(showTxBytes, false);
        set(viewMode, "formatted");
      });
    ...
    if_block(node, ($$render) => {
      if (deep_read_state(isTransactionData), deep_read_state(value()), untrack(() => isTransactionData(value()))) $$render(consequent);
    });
  }
  ...
  var node_1 = sibling(button_2, 2);
  {
    var consequent_1 = ($$anchor2) => {
      var button_3 = root_2();
      let classes_3;
      template_effect(($0) => classes_3 = set_class(button_3, 1, "svelte-1u6kzt3", null, classes_3, $0), [() => ({ active: get(showTxBytes) })]);
  ...
  var node_2 = sibling(div_1, 2);
  {
    var consequent_2 = ($$anchor2) => {
      ...
      var pre = sibling(button_4, 2);
      var text2 = child(pre);
      template_effect(() => set_text(text2, (deep_read_state(value()), untrack(() => value().transactionBytes))));
      event("click", button_4, () => navigator.clipboard.writeText(value().transactionBytes));
    ...
    var alternate_2 = ($$anchor2) => {
      ...
      var node_3 = first_child(fragment);
      {
        ...
        if_block(
          node_3,
          ($$render) => {
            if (get(viewMode), deep_read_state(isTransactionData), deep_read_state(value()), untrack(() => get(viewMode) === "formatted" && isTransactionData(value()))) $$render(consequent_3);
            else $$render(alternate_1, false);
          },
          true
        );
  ...
  template_effect(
    ($0, $1, $2) => {
      div.hidden = $0;
      classes_1 = set_class(button_1, 1, "svelte-1u6kzt3", null, classes_1, $1);
      classes_2 = set_class(button_2, 1, "svelte-1u6kzt3", null, classes_2, $2);
    },
    [
