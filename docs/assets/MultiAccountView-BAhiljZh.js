import { p as push, O as state, P as proxy, f as from_html, s as sibling, c as child, N as store_get, b as if_block, g as get, z as each, t as template_effect, V as user_derived, d as set_text, E as bind_value, h as bind_select_value, j as set, k as append, l as pop, Q as setup_stores, ab as iota_accounts, ac as iota_wallets, n as getClient, ad as Transaction, R as isValidIotaAddress, W as delegate, L as set_class, e as event, H as text, I as comment, G as first_child } from "/iota-utils/assets/index-C6pwDMXK.js";
import { b as fetchCurrentPrice, a as action } from "/iota-utils/assets/price-fetching-8FCV-qdb.js";
import { s as set_attribute } from "/iota-utils/assets/attributes-DNoTlwZR.js";
...
import { n as nanoToIota } from "/iota-utils/assets/iota-nano-conversion-B_KEmPoK.js";
import { c as computeStakingRewards } from "/iota-utils/assets/staking-utils-DRyo0UgI.js";
import { c as calculateGasFee } from "/iota-utils/assets/transaction-execution-DyCYsWgb.js";
...
const syncReset = async (_, extendedAccounts, $iota_accounts, getObjects, computeAllStakingRewards, value) => {
  try {
...
var on_click_1 = (__6, account) => navigator.clipboard.writeText(get(account).address);
var on_click_2 = (__7, removeAccount, account) => removeAccount(get(account).address);
var root_3 = from_html(`<div style="color: #10b981; font-size: 0.75em;"> </div>`);
...
var root_4 = from_html(`<div><div class="object-header svelte-qjemsi"><span class="object-type svelte-qjemsi"><!></span> <span class="object-amount svelte-qjemsi"><!></span></div> <div style="position: relative;"><!> <details class="object-details svelte-qjemsi"><summary style="text-align: center; list-style-position: inside;" class="svelte-qjemsi">Data</summary> <pre class="svelte-qjemsi"> </pre></details></div></div>`);
var root_13 = from_html(`<div style="text-align: center; color: var(--text-muted); padding: 1rem; font-size: 0.8rem;">No objects</div>`);
var root_15 = from_html(`<div class="object-item svelte-qjemsi" style="border-color: rgba(248, 113, 113, 0.3);"><div class="object-header svelte-qjemsi"><span class="object-type svelte-qjemsi"> </span> <span class="object-amount svelte-qjemsi"><!></span></div> <details class="object-details svelte-qjemsi"><summary class="svelte-qjemsi">Data</summary> <pre class="svelte-qjemsi"> </pre></details></div>`);
...
var root_2 = from_html(`<div class="account-card svelte-qjemsi"><div class="account-header svelte-qjemsi"><div style="display: flex; flex-direction: column;"><span class="account-title svelte-qjemsi"> </span> <div style="display: flex; gap: 0.5rem; margin-top: 0.2rem;"><button style="font-size: 0.7rem; padding: 0.1rem 0.3rem; width: fit-content; background: var(--secondary-color);">Copy Address</button> <button class="danger svelte-qjemsi" style="font-size: 0.7rem; padding: 0.1rem 0.3rem; width: fit-content;">Remove</button></div></div> <div style="text-align: right;"><div class="account-balance svelte-qjemsi"> <span style="font-size: 0.8em; color: var(--text-muted);">IOTA</span></div> <!></div></div> <div class="object-list svelte-qjemsi"><!> <!> <!></div></div>`);
var root = from_html(`<main class="container svelte-qjemsi"><div class="toolbar svelte-qjemsi"><div style="display: flex; align-items: center; gap: 0.5rem; flex-grow: 1;"><input type="text" placeholder="Enter external address (0x...)" class="svelte-qjemsi"/> <button class="svelte-qjemsi">Add Account</button></div> <div style="display: flex; gap: 0.5rem;"><button class="svelte-qjemsi">Sync/Reset</button> <button class="svelte-qjemsi">Dry Run</button> <button class="svelte-qjemsi">Prepare Tx Bytes</button> <button style="background: #059669;" class="svelte-qjemsi">Send</button></div></div> <!> <!> <div class="summary-section svelte-qjemsi"><div class="summary-header svelte-qjemsi"><h3 class="svelte-qjemsi">Balance Breakdown</h3> <div class="price-controls svelte-qjemsi"><select class="svelte-qjemsi"><option>USD</option><option>EUR</option></select> <button class="svelte-qjemsi">Fetch Price</button></div></div> <table class="summary-table svelte-qjemsi"><thead><tr><th class="svelte-qjemsi">Category</th><th class="svelte-qjemsi">Amount (IOTA)</th><th class="svelte-qjemsi"> </th></tr></thead><tbody><tr class="total-row" style="background: rgba(16, 185, 129, 0.1);"><td class="svelte-qjemsi"><strong>Total</strong></td><td class="svelte-qjemsi"><strong> </strong></td><td class="svelte-qjemsi"><strong> </strong></td></tr><tr><td class="svelte-qjemsi">IOTA Coins</td><td class="svelte-qjemsi"> </td><td class="svelte-qjemsi"> </td></tr><tr><td class="svelte-qjemsi">Staked</td><td class="svelte-qjemsi"> </td><td class="svelte-qjemsi"> </td></tr><tr><td class="svelte-qjemsi">Staking Rewards</td><td class="svelte-qjemsi"> </td><td class="svelte-qjemsi"> </td></tr></tbody></table></div> <div class="accounts-grid svelte-qjemsi"></div></main>`);
function MultiAccountView($$anchor, $$props) {
  ...
  each(div_7, 21, () => get(extendedAccounts), (account) => account.id, ($$anchor2, account) => {
    var div_8 = root_2();
    ...
    button_6.__click = [on_click_1, account];
    var button_7 = sibling(button_6, 2);
    button_7.__click = [on_click_2, removeAccount, account];
    ...
    var node_2 = sibling(div_13, 2);
    {
      var consequent_1 = ($$anchor3) => {
        var div_14 = root_3();
        var text_12 = child(div_14);
        template_effect(($0) => set_text(text_12, `+${$0 ?? ""} rewards`), [() => nanoToIota(get(account).stakingRewards.toString())]);
    ...
    each(node_3, 17, () => get(account).objects, (item) => item.id, ($$anchor3, item) => {
      ...
      action(div_17, ($$node) => dragHandle == null ? void 0 : dragHandle($$node));
      var div_18 = sibling(div_17, 2);
      var node_8 = child(div_18);
      {
        var consequent_6 = ($$anchor4) => {
          var div_19 = root_12();
          var text_18 = child(div_19);
      ...
      template_effect(
        ($0, $1) => {
          classes = set_class(div_16, 1, "object-item svelte-qjemsi", null, classes, $0);
          set_attribute(span_1, "title", get(item).label);
          set_text(text_19, $1);
        },
        [
          () => ({ foreign: get(account).address !== get(item).currentOwner }),
    ...
    var node_9 = sibling(node_3, 2);
    {
      ...
      if_block(node_9, ($$render) => {
        if (get(account).objects.length === 0 && get(account).timelockedObjects.length === 0) $$render(consequent_7);
      });
    }
    var node_10 = sibling(node_9, 2);
    {
        ...
        each(node_11, 17, () => get(account).timelockedObjects, (item) => item.id, ($$anchor4, item) => {
          ...
          var node_12 = child(span_4);
          {
            ...
            var alternate_3 = ($$anchor5) => {
              ...
              var node_13 = first_child(fragment_7);
              {
                var consequent_9 = ($$anchor6) => {
                  ...
                  append($$anchor6, text_22);
                };
                if_block(
                  node_13,
                  ($$render) => {
                    if (get(item).label.startsWith("Coin<0x2::iota::IOTA>")) $$render(consequent_9);
                  },
                  true
                );
              }
            ...
            if_block(node_12, ($$render) => {
              if (get(item).label == "TimelockedStakedIota") $$render(consequent_8);
              else $$render(alternate_3, false);
            });
          }
          var details_1 = sibling(div_23, 2);
      ...
      if_block(node_10, ($$render) => {
        if (get(account).timelockedObjects.length != 0) $$render(consequent_10);
      });
    }
    action(div_15, ($$node, $$action_arg) => dragHandleZone == null ? void 0 : dragHandleZone($$node, $$action_arg), () => ({ items: get(account).objects, flipDurationMs: 200 }));
    template_effect(
      ($0, $1) => {
    ...
    event("consider", div_15, (e) => handleDnd(e, get(account).id));
    event("finalize", div_15, (e) => handleDnd(e, get(account).id));
