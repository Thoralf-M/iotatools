import { p as push, o as state, R as proxy, u as user_effect, s as set, g as get, b as sibling, h as child, i as if_block, t as template_effect, c as set_text, k as delegated, J as bind_value, d as append, l as pop, G as setup_stores, B as getClient, aC as Transaction, aF as addAndRun, Y as comment, X as first_child, q as from_html, F as store_get, as as activeAddress, m as user_derived, r as delegate } from "./index-BHax3LxJ.js";
...
function SplitMergeCoins($$anchor, $$props) {
  ...
  const splitIotaCoins = async () => {
    try {
      ...
      await addAndRun({
        label: `Split into ${splitAmounts.length} × ${get(amountPerObject)} NANO`,
        transaction: tx
      });
    } catch (err) {
      console.error(err);
