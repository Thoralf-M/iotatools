...
import { b as fetchCurrentPrice, a as action } from "/iota-utils/assets/price-fetching-C93JV-L5.js";
import { s as set_attribute } from "/iota-utils/assets/attributes-VovyPtrj.js";
...
import { n as nanoToIota } from "/iota-utils/assets/iota-nano-conversion-CtcA8Xaw.js";
import { c as computeStakingRewards } from "/iota-utils/assets/staking-utils-BIbhnbXX.js";
import { c as calculateGasFee } from "/iota-utils/assets/transaction-execution-29GTTCIX.js";
    ...
    each(node_3, 17, () => get(account).objects, (item) => item.id, ($$anchor3, item) => {
      ...
      var node_8 = child(div_18);
      {
        var consequent_6 = ($$anchor4) => {
          ...
          template_effect(($0, $1) => set_text(text_18, `From: ${$0 ?? ""}...${$1 ?? ""}`), [
            () => get(item).currentOwner.slice(0, 6),
            () => get(item).currentOwner.slice(-4)
          ]);
