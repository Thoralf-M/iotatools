const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/jspdf.es.min-CtwHFJGJ.js","assets/index-DtiGzVAl.js","assets/index-2HiTQFdT.css"])))=>i.map(i=>d[i]);
import { ae as block, af as EFFECT_TRANSPARENT, ag as BranchManager, ah as effect, a2 as untrack, p as push, a as prop, C as onMount, _ as onDestroy, g as get, $ as legacy_pre_effect, a0 as deep_read_state, a1 as legacy_pre_effect_reset, v as init, b as sibling, h as child, k as delegated, d as append, l as pop, y as mutable_source, s as set, D as mutate, q as from_html, r as delegate, o as state, Q as proxy, u as user_effect, ai as attribute_effect, i as if_block, e as each, X as comment, W as first_child, t as template_effect, a8 as set_style, m as user_derived, aj as STYLE, ak as rest_props, al as __vitePreload, z as set_class, V as set_attribute, c as set_text, a5 as bind_group, am as bind_checked, H as bind_value, j as index, x as bind_select_value, a7 as copyToClipboard, w as event, G as getSelectedNetworkConfig, Z as text, an as noop, ao as NANOS_PER_IOTA, A as to_array, ap as get$1, aa as isValidIotaAddress, E as store_get, aq as activeAddress, F as setup_stores, ar as store_set, a9 as set_value, as as derived_safe_equal, at as iota_accounts } from "./index-DtiGzVAl.js";
import { J as JsonToggleView } from "./JsonToggleView-Cql04EWV.js";
import { u as usePageQueryParams, a as updatePageQueryParams } from "./page-query-params-Cum3l-dJ.js";
import { E as EpochPTBAnalyzer } from "./epoch-ptb-analyzer-DECNR0yp.js";
import { f as fetchPoolExchangeRates, s as safeBigInt, g as getTokenAmount, a as getIotaAmount, b as fetchSystemState, c as getCurrentActiveValidatorsExchangeRateIds, d as getInactiveValidatorsExchangeRateIds, e as getValidatorInfo, h as fetchAllExchangeRates, i as exchangeRateCache, j as formatNanoAsIota, n as nanoToIota, k as formatNanoAsIotaFullPrecision, l as fetchEpochTimestampsForDisplay, m as action, o as setInitialExchangeRateCacheFromBinary, p as exchangeRateCacheBinary, q as fetchStakeTransactions, r as fetchReceivedStakeTransactions, t as fetchCurrentStakedObjects } from "./utils-DU-f4veT.js";
...
function buildExportSections(inputs) {
  ...
  const sections = [{ headers: mainHeaders, rows: mainRows }];
...
function buildStakeObjectLongRows(epochs, epochEndDates, currentEpoch, stakeObjects, epochData) {
  const rows = [];
  for (const stakeObject of stakeObjects) {
    for (let i = 0; i < epochs.length; i++) {
      const epoch = epochs[i];
...
function buildValidatorLongRows(epochs, epochEndDates, currentEpoch, uniqueValidators, epochData) {
  const rows = [];
...
async function renderSectionsToPdf(sections) {
  const [{ jsPDF }, autoTableModule] = await Promise.all([
    __vitePreload(() => import("./jspdf.es.min-CtwHFJGJ.js").then((n) => n.j), true ? __vite__mapDeps([0,1,2]) : void 0),
  ...
  for (const section of sections) {
    ...
    for (let g = 0; g < groups.length; g++) {
      ...
      const estimatedHeight = (showTitle ? titleHeight : 0) + rowHeight + rows.length * rowHeight;
...
async function renderSectionsToPdfBlobUrl(sections) {
  const doc = await renderSectionsToPdf(sections);
  return doc.output("bloburl");
}
async function exportTableToPDF(epochs, epochEndDates, currentEpoch, stakeObjects, uniqueValidators, epochData, options) {
  const sections = buildExportSections({
    epochs,
    epochEndDates,
    currentEpoch,
...
var root_11$1 = from_html(`<th class="svelte-1ubkki9"> </th>`);
var root_13$2 = from_html(`<td class="svelte-1ubkki9"> </td>`);
var root_12 = from_html(`<tr></tr>`);
var root_14$2 = from_html(`<div class="preview-more svelte-1ubkki9"> </div>`);
...
function ExportDialog($$anchor, $$props) {
  ...
  let previewSections = user_derived(() => open() ? $$props.buildPreview(get(effectiveOpts)) : []);
  ...
  function truncateSectionsForPreview(sections) {
    return sections.map((s) => ({ ...s, rows: s.rows.slice(0, PDF_PREVIEW_ROW_LIMIT) }));
  }
  user_effect(() => {
    ...
    const timeout = setTimeout(
      async () => {
        try {
          const sections = truncateSectionsForPreview($$props.buildPreview(opts));
  ...
  var node = first_child(fragment);
  {
    var consequent_7 = ($$anchor2) => {
      ...
      var node_2 = sibling(div_5, 2);
      {
        ...
        var alternate_1 = ($$anchor3) => {
          ...
          each(div_12, 21, () => get(previewSections), index, ($$anchor4, section) => {
            ...
            each(tbody, 21, () => get(section).rows.slice(0, PREVIEW_ROW_LIMIT), index, ($$anchor5, row) => {
              var tr_1 = root_12();
            ...
            var node_6 = sibling(table, 2);
            {
              var consequent_6 = ($$anchor5) => {
                ...
                template_effect(() => set_text(text_5, `… ${get(section).rows.length - PREVIEW_ROW_LIMIT} more row${get(section).rows.length - PREVIEW_ROW_LIMIT === 1 ? "" : "s"}`));
                append($$anchor5, div_14);
              };
              if_block(node_6, ($$render) => {
                if (get(section).rows.length > PREVIEW_ROW_LIMIT) $$render(consequent_6);
              });
            }
      ...
      template_effect(() => {
        ...
        set_text(text2, get(isMaximized) ? "⤢ Restore" : "⤢ Maximize");
        set_text(text_6, `.${get(format) ?? ""}`);
      });
...
var root_25 = from_html(`<div class="table-cell stake-cell svelte-toncsw"><div class="stake-popup-container svelte-toncsw"><!> <!></div></div>`);
var root_15 = from_html(`<div><div class="data-row svelte-toncsw"><div class="table-cell epoch-cell svelte-toncsw"> </div> <div class="table-cell end-date-cell svelte-toncsw"> </div> <!> <!> <!> <!> <!> <!> <!> <!> <!></div></div>`);
...
function StakingRewardsTable($$anchor, $$props) {
  ...
  let previousCurrency = state("usd");
  ...
  function handleExportConfirm(opts) {
    ...
    const args = [
      get(filteredEpochs),
      get(filteredEpochEndDates),
      currentEpoch(),
      stakeObjects(),
      get(uniqueValidators),
      get(epochData),
      options
    ];
    try {
      if (opts.format === "pdf") {
        exportTableToPDF(...args).catch((err) => {
          ...
          set(exportError, err instanceof Error ? err.message : "Failed to export PDF", true);
        });
      } else {
      ...
      set(exportError, err instanceof Error ? err.message : "Failed to export", true);
    }
  }
  ...
  var node_5 = sibling(node_4, 2);
  {
    ...
    ExportDialog(node_5, {
      ...
      buildPreview: (opts) => buildExportSections({
      ...
      onCancel: () => set(showExportDialog, false),
...
var root_8 = from_html(`<label class="timeframe-date svelte-us09jc">From: <input type="date" class="svelte-us09jc"/></label> <label class="timeframe-date svelte-us09jc">To: <input type="date" class="svelte-us09jc"/></label>`, 1);
var root_9 = from_html(`<label class="timeframe-date svelte-us09jc">From epoch: <input type="number" min="0" step="1" placeholder="0" class="epoch-input svelte-us09jc"/></label> <label class="timeframe-date svelte-us09jc">To epoch: <input type="number" min="0" step="1" class="epoch-input svelte-us09jc"/></label>`, 1);
var root_13 = from_html(`<span class="timeframe-mapping svelte-us09jc"> </span>`);
var root_14 = from_html(`<span class="timeframe-mapping svelte-us09jc"> </span>`);
var root_10 = from_html(`<span class="timeframe-info svelte-us09jc"><!> <!> <!></span>`);
var root_16 = from_html(`<div class="info-message svelte-us09jc"> <!></div>`);
var root_18 = from_html(`<div class="loading-message svelte-us09jc">Loading can take minutes, depending on the number of transactions/epochs.</div>`);
var root_19 = from_html(`<div class="error-message svelte-us09jc"> </div>`);
var root_20 = from_html(`<div class="error-message svelte-us09jc"> </div>`);
...
function StakingRewards($$anchor, $$props) {
    ...
    try {
      ...
      const allTxsPromises = get(allAddresses).map(async (addr) => {
        try {
          ...
          sentDone++;
          set(loadingStep, `Fetching stake txs ${sentDone}/${total}...`);
          let receivedTxs = [];
          if (get(fetchReceivedTxs)) {
            receivedTxs = await fetchReceivedStakeTransactions(addr);
            receivedDone++;
            set(loadingStep, `Fetching received txs ${receivedDone}/${total}...`);
          }
  ...
  var node_5 = sibling(label_3, 2);
  {
    var consequent_5 = ($$anchor2) => {
      ...
      bind_value(input_3, () => get(customDateStart), ($$value) => set(customDateStart, $$value));
      bind_value(input_4, () => get(customDateEnd), ($$value) => set(customDateEnd, $$value));
      append($$anchor2, fragment_3);
    };
    if_block(node_5, ($$render) => {
      if (get(selectedTimeFrame) === "custom") $$render(consequent_5);
    });
  }
  var node_6 = sibling(node_5, 2);
  {
    var consequent_6 = ($$anchor2) => {
      ...
      var label_6 = first_child(fragment_4);
      var input_5 = sibling(child(label_6));
      var label_7 = sibling(label_6, 2);
      var input_6 = sibling(child(label_7));
      template_effect(() => set_attribute(input_6, "placeholder", get(latestKnownEpoch) !== void 0 ? `current (${get(latestKnownEpoch)})` : "current"));
      bind_value(input_5, () => get(customEpochStart), ($$value) => set(customEpochStart, $$value));
      bind_value(input_6, () => get(customEpochEnd), ($$value) => set(customEpochEnd, $$value));
      append($$anchor2, fragment_4);
    };
    if_block(node_6, ($$render) => {
      if (get(selectedTimeFrame) === "custom-epochs") $$render(consequent_6);
    });
  }
  var node_7 = sibling(node_6, 2);
  {
    var consequent_11 = ($$anchor2) => {
      ...
      var node_8 = child(span);
      {
        var consequent_7 = ($$anchor3) => {
          var text_3 = text();
          template_effect(
            ($0) => set_text(text_3, `Epoch ${(get(customEpochRange), untrack(() => get(customEpochRange).start)) ?? ""} to ${(get(customEpochRange), untrack(() => get(customEpochRange).end)) ?? ""}${$0 ?? ""}`),
            [
        ...
        if_block(node_8, ($$render) => {
          if (get(selectedTimeFrame) === "custom-epochs" && get(customEpochRange)) $$render(consequent_7);
          else $$render(alternate_1, -1);
        });
      }
      var node_9 = sibling(node_8, 2);
      {
        var consequent_8 = ($$anchor3) => {
          ...
          template_effect(($0, $1) => set_text(text_5, `≈ ${$0 ?? ""} to ${$1 ?? ""}`), [
        ...
        var consequent_9 = ($$anchor3) => {
          var span_2 = root_14();
          var text_6 = child(span_2);
          template_effect(() => set_text(text_6, `≈ epoch ${(get(mappedEpochRangeForDates), untrack(() => get(mappedEpochRangeForDates).start)) ?? ""} to ${(get(mappedEpochRangeForDates), untrack(() => get(mappedEpochRangeForDates).end)) ?? ""}`));
          append($$anchor3, span_2);
        };
        if_block(node_9, ($$render) => {
          if (get(selectedTimeFrame) === "custom-epochs" && get(mappedDateRangeForEpochs)) $$render(consequent_8);
          else if (get(selectedTimeFrame) !== "custom-epochs" && get(mappedEpochRangeForDates)) $$render(consequent_9, 1);
        });
      }
      var node_10 = sibling(node_9, 2);
      {
        var consequent_10 = ($$anchor3) => {
          var text_7 = text();
          template_effect(() => set_text(text_7, `(${(get(timeFrameFilteredEpochs), untrack(() => get(timeFrameFilteredEpochs).length)) ?? ""} of ${(get(tableData), untrack(() => get(tableData).epochs.length)) ?? ""} epochs)`));
          append($$anchor3, text_7);
        };
        if_block(node_10, ($$render) => {
          if (get(tableData), untrack(() => get(tableData).epochs.length > 0)) $$render(consequent_10);
        });
      }
      append($$anchor2, span);
    };
    if_block(node_7, ($$render) => {
      if (get(selectedTimeFrame) !== "all") $$render(consequent_11);
    });
  }
  ...
  var node_11 = sibling(div, 2);
  {
    var consequent_13 = ($$anchor2) => {
      var div_8 = root_16();
      var text_9 = child(div_8);
      var node_12 = sibling(text_9);
      {
        var consequent_12 = ($$anchor3) => {
          var text_10 = text();
          template_effect(() => set_text(text_10, `and ${(get(allAddresses), untrack(() => get(allAddresses).length - 3)) ?? ""} more`));
          append($$anchor3, text_10);
        };
        if_block(node_12, ($$render) => {
          if (get(allAddresses), untrack(() => get(allAddresses).length > 3)) $$render(consequent_12);
        });
      }
      template_effect(
        ($0) => set_text(text_9, `Fetching data for ${(get(allAddresses), untrack(() => get(allAddresses).length)) ?? ""} addresses: ${$0 ?? ""} `),
        [
    ...
    if_block(node_11, ($$render) => {
      if (get(allAddresses), untrack(() => get(allAddresses).length > 1)) $$render(consequent_13);
    });
  }
  var node_13 = sibling(node_11, 2);
  {
    ...
    if_block(node_13, ($$render) => {
      if (get(loadingTxs)) $$render(consequent_14);
    });
  }
  var node_14 = sibling(node_13, 2);
  {
    ...
    if_block(node_14, ($$render) => {
      if (get(error)) $$render(consequent_15);
    });
  }
  var node_15 = sibling(node_14, 2);
  {
    var consequent_16 = ($$anchor2) => {
      ...
      template_effect(
        ($0) => set_text(text_12, `Available Rewards went negative at ${(get(filteredNegativeEpochs), untrack(() => get(filteredNegativeEpochs).length)) ?? ""} epoch(s). This is most
    ...
    if_block(node_15, ($$render) => {
      if (get(filteredNegativeEpochs), untrack(() => get(filteredNegativeEpochs).length > 0)) $$render(consequent_16);
    });
  }
  var div_12 = sibling(node_15, 2);
  var node_16 = child(div_12);
  {
    let $0 = derived_safe_equal(() => get(epoch) || 1);
    StakingRewardsTable(node_16, {
      get currentEpoch() {
        return get($0);
      },
      get stakeObjects() {
  ...
  var node_17 = sibling(div_12, 2);
  {
    ...
    if_block(node_17, ($$render) => {
      if (get(stakeObjects), untrack(() => get(stakeObjects).length > 0)) $$render(consequent_17);
    });
  }
  var details = sibling(node_17, 2);
  var node_18 = sibling(child(details), 2);
  JsonToggleView(node_18, {
    get value() {
      return get(stakeObjects);
    }
  });
  var details_1 = sibling(details, 2);
  var node_19 = sibling(child(details_1), 2);
  ...
  template_effect(() => {
    input_2.disabled = get(loadingTxs);
    button_1.disabled = get(loadingTxs);
    set_text(text_8, get(loadingTxs) ? get(loadingStep) ?? "Loading..." : "Fetch Data");
  });
  bind_checked(input, () => get(useMultipleAddresses), ($$value) => set(useMultipleAddresses, $$value));
  bind_checked(input_2, () => get(fetchReceivedTxs), ($$value) => set(fetchReceivedTxs, $$value));
