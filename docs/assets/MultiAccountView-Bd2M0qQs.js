import { p as push, O as state, P as proxy, f as from_html, s as sibling, c as child, N as store_get, b as if_block, g as get, z as each, t as template_effect, d as set_text, E as bind_value, h as bind_select_value, j as set, k as append, l as pop, Q as setup_stores, ab as iota_accounts, ac as iota_wallets, n as getClient, ad as Transaction, R as isValidIotaAddress, W as delegate, J as set_style, L as set_class, ae as clsx, e as event, G as first_child, H as text, I as comment } from "/iota-utils/assets/index-BjYXlUa6.js";
import { b as fetchCurrentPrice, a as action } from "/iota-utils/assets/price-fetching-DqENsknQ.js";
...
import { n as nanoToIota } from "/iota-utils/assets/iota-nano-conversion-CPaWL8Ad.js";
import { c as computeStakingRewards } from "/iota-utils/assets/staking-utils-tsdXtp4G.js";
import { c as calculateGasFee } from "/iota-utils/assets/transaction-execution-DJq56HrZ.js";
...
const syncReset = async (_, extendedAccounts, $iota_accounts, getObjects, computeAllStakingRewards, allAccountsTotalBalance, allAccountsTotalRewards, allAccountsTotalIotaCoins, allAccountsTotalStaked, value) => {
  try {
    ...
    set(allAccountsTotalBalance, BigInt(0), true);
    set(allAccountsTotalRewards, BigInt(0), true);
    set(allAccountsTotalIotaCoins, BigInt(0), true);
    set(allAccountsTotalStaked, BigInt(0), true);
    for (let account of get(extendedAccounts)) {
      set(allAccountsTotalIotaCoins, get(allAccountsTotalIotaCoins) + account.objects.reduce(
        (acc, obj) => {
          var _a;
          let amountToAdd = BigInt(0);
          if (((_a = obj.data.content.fields) == null ? void 0 : _a.balance) && obj.data.content.type === "0x2::coin::Coin<0x2::iota::IOTA>") {
      ...
      set(allAccountsTotalIotaCoins, get(allAccountsTotalIotaCoins) + account.timelockedObjects.reduce(
        (acc, obj) => {
          var _a;
          let amountToAdd = BigInt(0);
      ...
      set(allAccountsTotalStaked, get(allAccountsTotalStaked) + account.objects.reduce(
        (acc, obj) => {
          var _a;
          let amountToAdd = BigInt(0);
          if (((_a = obj.data.content.fields) == null ? void 0 : _a.principal) && obj.label === "StakedIota") {
      ...
      set(allAccountsTotalStaked, get(allAccountsTotalStaked) + account.timelockedObjects.reduce(
        (acc, obj) => {
          var _a, _b, _c;
          let amountToAdd = BigInt(0);
          if ((_c = (_b = (_a = obj.data.content.fields) == null ? void 0 : _a.staked_iota) == null ? void 0 : _b.fields) == null ? void 0 : _c.principal) {
      ...
      set(allAccountsTotalBalance, get(allAccountsTotalBalance) + account.timelockedObjects.reduce(
        (acc, obj) => {
          ...
          let amountToAdd = BigInt(0);
          if ((_a = obj.data.content.fields) == null ? void 0 : _a.locked) {
            amountToAdd = BigInt((_b = obj.data.content.fields) == null ? void 0 : _b.locked);
      ...
      set(allAccountsTotalBalance, get(allAccountsTotalBalance) + account.stakingRewards);
      set(allAccountsTotalRewards, get(allAccountsTotalRewards) + account.stakingRewards);
    }
  } catch (err) {
...
async function prepareTxBytes(__3, prepareTxs, value) {
  try {
    const client = getClient();
    let preparedTxs = await prepareTxs();
    let results = [];
...
function addExternalAccount(__4, newAccountAddress, newAccountError, extendedAccounts, $iota_accounts) {
...
var on_click = (__5, currentPrice) => fetchCurrentPrice().then((price) => set(currentPrice, price, true));
var root_3 = from_html(`<span style="color: #00d084; font-size: 0.85em;"> </span>`);
var on_click_1 = (__6, removeExternalAccount, account) => removeExternalAccount(get(account).address);
var root_4 = from_html(`<button style="margin:0.2rem; background-color: #d63031; " class="svelte-mif7l5">Remove External Account</button> <br/>`, 1);
var root_12 = from_html(`<div> </div>`);
var root_5 = from_html(`<div style="border-top: 1px solid #525252;"><div class="handle"><span><!></span> <!></div> <div class="item"><details><summary>Show object data</summary> <pre style="font-size:0.7rem;  text-align: left;" class="svelte-mif7l5"> </pre></details></div></div>`);
var root_13 = from_html(`<br/> <br/> <br/> <br/>`, 1);
var root_22 = from_html(`<div> </div>`);
var root_15 = from_html(`<div style="border-top: 1px solid #525252;"><span style="word-break: break-all;"><!></span> <!></div> <div class="item"><details><summary>Show object data</summary> <pre style="font-size:0.7rem;  text-align: left;" class="svelte-mif7l5"> </pre></details></div>`, 1);
var root_14 = from_html(`<details><summary style="color: #ff9991;">Timelocked objects</summary> <!></details>`);
var root_2 = from_html(`<div class="account svelte-mif7l5"><div class="accountHeader svelte-mif7l5"> <!></div> <!> <div style="text-align: left;"> </div> <div style="max-height: 300px; overflow-y: auto;"><!> <!> <!></div></div>`);
var root = from_html(`<main><span style="float:left">Drag and drop objects between accounts.</span> <br/> <input type="text" placeholder="Enter external address" style="margin:0.5rem;" size="67"/> <button class="svelte-mif7l5">Add External Account</button> <!> <br/> <button class="svelte-mif7l5">sync/reset</button> <button class="svelte-mif7l5">dry run</button> <button class="svelte-mif7l5">prepare tx bytes</button> <button class="svelte-mif7l5">send</button> <!> <br/> <div class="balance-breakdown svelte-mif7l5"><div class="balance-header svelte-mif7l5"><h3 class="svelte-mif7l5">Balance Breakdown for All Accounts</h3> <div class="price-controls svelte-mif7l5"><select class="svelte-mif7l5"><option>USD</option><option>EUR</option></select> <button class="svelte-mif7l5">Fetch price from CoinGecko</button></div></div> <table class="svelte-mif7l5"><thead><tr><th class="svelte-mif7l5">Category</th><th class="svelte-mif7l5">Amount (IOTA)</th><th class="svelte-mif7l5"> </th></tr></thead><tbody><tr class="total-row svelte-mif7l5"><td class="svelte-mif7l5"><strong>Total IOTA Amount</strong></td><td class="svelte-mif7l5"><strong> </strong></td><td class="svelte-mif7l5"><strong> </strong></td></tr><tr><td class="svelte-mif7l5">IOTA Coins</td><td class="svelte-mif7l5"> </td><td class="svelte-mif7l5"> </td></tr><tr><td class="svelte-mif7l5">Staked IOTAs</td><td class="svelte-mif7l5"> </td><td class="svelte-mif7l5"> </td></tr><tr><td class="svelte-mif7l5">Staking Rewards</td><td class="svelte-mif7l5"> </td><td class="svelte-mif7l5"> </td></tr></tbody></table></div> <div class="grid svelte-mif7l5"></div></main>`);
function MultiAccountView($$anchor, $$props) {
  ...
  let allAccountsTotalBalance = state(proxy(BigInt(0)));
  let allAccountsTotalRewards = state(proxy(BigInt(0)));
  let allAccountsTotalIotaCoins = state(proxy(BigInt(0)));
  let allAccountsTotalStaked = state(proxy(BigInt(0)));
  ...
  button_1.__click = [
    ...
    allAccountsTotalRewards,
    allAccountsTotalIotaCoins,
    allAccountsTotalStaked,
    value
  ];
  var button_2 = sibling(button_1, 2);
  button_2.__click = [dryRun, prepareTxs, value];
  var button_3 = sibling(button_2, 2);
  button_3.__click = [prepareTxBytes, prepareTxs, value];
  var button_4 = sibling(button_3, 2);
  button_4.__click = [send, prepareTxs, $iota_wallets, value];
  ...
  button_5.__click = [on_click, currentPrice];
  var table = sibling(div_2, 2);
  ...
  each(div_4, 21, () => get(extendedAccounts), (account) => account.id, ($$anchor2, account) => {
    var div_5 = root_2();
    var div_6 = child(div_5);
    var text_10 = child(div_6);
    var node_2 = sibling(text_10);
    {
      var consequent_1 = ($$anchor3) => {
        var span = root_3();
        var text_11 = child(span);
        template_effect(($0) => set_text(text_11, `(+${$0 ?? ""} rewards)`), [() => nanoToIota(get(account).stakingRewards.toString())]);
        append($$anchor3, span);
      };
      if_block(node_2, ($$render) => {
        if (get(account).stakingRewards > BigInt(0)) $$render(consequent_1);
      });
    }
    var node_3 = sibling(div_6, 2);
    {
      var consequent_2 = ($$anchor3) => {
        ...
        button_6.__click = [on_click_1, removeExternalAccount, account];
        append($$anchor3, fragment);
      };
      if_block(node_3, ($$render) => {
        if (!$iota_accounts().some((acc) => acc.address === get(account).address)) $$render(consequent_2);
      });
    }
    var div_7 = sibling(node_3, 2);
    var text_12 = child(div_7);
    var div_8 = sibling(div_7, 2);
    var node_4 = child(div_8);
    each(node_4, 17, () => get(account).objects, (item) => item.id, ($$anchor3, item) => {
      var div_9 = root_5();
      ...
      var node_5 = child(span_1);
      {
        var consequent_3 = ($$anchor4) => {
          var text_13 = text();
          template_effect(($0) => set_text(text_13, `${get(item).label ?? ""}: ${$0 ?? ""} IOTA`), [() => {
            var _a, _b;
        ...
        var alternate_2 = ($$anchor4) => {
          ...
          var node_6 = first_child(fragment_2);
          {
            var consequent_4 = ($$anchor5) => {
              var text_14 = text();
              template_effect(
                ($0) => set_text(text_14, `${get(item).label ?? ""}: ${$0 ?? ""}
                                        IOTA`),
                [
                  () => {
                    var _a, _b;
            ...
            var alternate_1 = ($$anchor5) => {
              ...
              var node_7 = first_child(fragment_4);
              {
                var consequent_5 = ($$anchor6) => {
                  var text_15 = text();
                  template_effect(($0) => set_text(text_15, `${get(item).label ?? ""}: ${$0 ?? ""} IOTA`), [
                ...
                if_block(
                  node_7,
                  ($$render) => {
                    if (get(item).label == "TimelockedStakedIota") $$render(consequent_5);
            ...
            if_block(
              node_6,
              ($$render) => {
                if (get(item).label == "StakedIota") $$render(consequent_4);
        ...
        if_block(node_5, ($$render) => {
          if (get(item).label.startsWith("Coin<0x2::iota::IOTA>")) $$render(consequent_3);
      ...
      var node_8 = sibling(span_1, 2);
      {
        var consequent_6 = ($$anchor4) => {
          ...
          template_effect(($0) => set_text(text_17, `from: ${$0 ?? ""}`), [
            () => get(item).currentOwner.slice(0, 6) + "..." + get(item).currentOwner.slice(-4)
          ]);
          append($$anchor4, div_11);
        };
        if_block(node_8, ($$render) => {
          if (get(account).address !== get(item).currentOwner) $$render(consequent_6);
        });
      }
      action(div_10, ($$node) => dragHandle == null ? void 0 : dragHandle($$node));
      var div_12 = sibling(div_10, 2);
      var details = child(div_12);
      var pre = sibling(child(details), 2);
      var text_18 = child(pre);
      template_effect(
        ($0) => {
          set_style(div_10, get(account).address !== get(item).currentOwner ? "background-color: #19400e;" : "");
          set_text(text_18, `
                                        ${$0 ?? ""}
                                    `);
        },
    ...
    var node_9 = sibling(node_4, 2);
    {
      ...
      if_block(node_9, ($$render) => {
        if (get(account).objects.length == 0) $$render(consequent_7);
      });
    }
    var node_10 = sibling(node_9, 2);
    {
      var consequent_12 = ($$anchor3) => {
        var details_1 = root_14();
        var node_11 = sibling(child(details_1), 2);
        each(node_11, 17, () => get(account).timelockedObjects, (item) => item.id, ($$anchor4, item) => {
          ...
          var node_12 = child(span_2);
          {
            var consequent_8 = ($$anchor5) => {
              var text_19 = text();
              template_effect(($0) => set_text(text_19, `${get(item).label ?? ""}: ${$0 ?? ""} IOTA`), [() => {
                var _a, _b;
                return nanoToIota((_b = (_a = get(item).data) == null ? void 0 : _a.content.fields) == null ? void 0 : _b.balance);
              }]);
            ...
            var alternate_5 = ($$anchor5) => {
              ...
              var node_13 = first_child(fragment_10);
              {
                var consequent_9 = ($$anchor6) => {
                  var text_20 = text();
                  template_effect(
                    ($0) => set_text(text_20, `${get(item).label ?? ""}: ${$0 ?? ""}
                                            IOTA`),
                    [
                      () => {
                        var _a, _b;
                ...
                var alternate_4 = ($$anchor6) => {
                  ...
                  var node_14 = first_child(fragment_12);
                  {
                    var consequent_10 = ($$anchor7) => {
                      var text_21 = text();
                      template_effect(($0) => set_text(text_21, `${get(item).label ?? ""}: ${$0 ?? ""} IOTA`), [
                        () => nanoToIota(get(item).data.content.fields.staked_iota.fields.principal)
                      ]);
                      append($$anchor7, text_21);
                    };
                    var alternate_3 = ($$anchor7) => {
                      var text_22 = text();
                      template_effect(() => set_text(text_22, get(item).label));
                ...
                if_block(
                  node_13,
                  ($$render) => {
                    if (get(item).label == "StakedIota") $$render(consequent_9);
          ...
          var node_15 = sibling(span_2, 2);
          {
            var consequent_11 = ($$anchor5) => {
              var div_14 = root_22();
              var text_23 = child(div_14);
              template_effect(($0) => set_text(text_23, `from: ${$0 ?? ""}`), [
                () => get(item).currentOwner.slice(0, 6) + "..." + get(item).currentOwner.slice(-4)
              ]);
              append($$anchor5, div_14);
            };
            if_block(node_15, ($$render) => {
              if (get(account).address !== get(item).currentOwner) $$render(consequent_11);
            });
          }
          var div_15 = sibling(div_13, 2);
          var details_2 = child(div_15);
    ...
    action(div_8, ($$node, $$action_arg) => dragHandleZone == null ? void 0 : dragHandleZone($$node, $$action_arg), () => ({ items: get(account).objects, flipDurationMs: 200 }));
    template_effect(
      ($0, $1) => {
        set_text(text_10, `${$0 ?? ""}: ${$1 ?? ""} IOTA `);
        set_text(text_12, `Owned objects (${get(account).objects.length ?? ""}):`);
        set_class(div_8, 1, clsx(get(account).id), "svelte-mif7l5");
      },
      [
    ...
    event("consider", div_8, handleDnd);
    event("finalize", div_8, handleDnd);
