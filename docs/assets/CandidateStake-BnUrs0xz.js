import { G as getSelectedNetworkConfig, B as getClient, p as push, c as state, Q as proxy, C as onMount, u as user_effect, D as store_get, d as from_html, i as if_block, g as get, b as user_derived, h as child, e as sibling, V as set_attribute, o as delegated, s as set, l as append, q as pop, F as setup_stores, aq as activeAddress, b1 as sharedClientConfig, t as template_effect, S as getObjectLink, a6 as formatAddress, k as set_text, H as bind_value, W as first_child, j as each, Y as getAddressLink, z as set_class, a8 as set_style, N as TransactionView, m as index, y as bind_select_value, r as delegate, aE as Transaction } from "./index-CVQbfH3x.js";
import { e as executeTransaction } from "./transaction-execution-5Syu4h4p.js";
...
var root_4 = from_html(
  `<!> <div class="section svelte-fmaoys"><h3 class="section-title svelte-fmaoys">Create Pool</h3> <!> <!> <!></div> <details class="faq-section svelte-fmaoys"><summary class="svelte-fmaoys">FAQ</summary> <dl class="svelte-fmaoys"><dt class="svelte-fmaoys">What do I need to deposit?</dt> <dd class="svelte-fmaoys">You need existing <code class="svelte-fmaoys">StakedIota</code> objects in your wallet. These are obtained
                    ...
                    any accrued rewards).</dd> <dt class="svelte-fmaoys">How much staking reward do I miss?</dt> <dd class="svelte-fmaoys">Your deposits remain staked until execution, so you keep earning rewards. During
                    the restaking transition you miss one epoch of rewards.</dd> <dt class="svelte-fmaoys">What happens if the pool is full (1,000 deposits)?</dt> <dd class="svelte-fmaoys">You can still deposit — but only if your deposit is strictly larger than the
