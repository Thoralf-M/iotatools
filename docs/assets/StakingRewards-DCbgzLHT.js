...
import "./dynamic-fields-DsEw9wx4.js";
...
async function renderSectionsToPdf(sections, onProgress) {
  const [{ jsPDF }, autoTableModule] = await Promise.all([
    __vitePreload(() => import("./jspdf.es.min-CJcOSyPU.js").then((n) => n.j), true ? __vite__mapDeps([0,1,2]) : void 0),
