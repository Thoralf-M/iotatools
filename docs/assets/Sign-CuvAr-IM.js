...
import { ax as Signer, A as toBase64, ay as PasskeyPublicKey, az as Secp256r1PublicKey, aA as Secp256k1PublicKey, ap as Ed25519PublicKey, aB as parseSerializedSignature, aC as PublicKey, y as fromBase64, z as iotaBcs, aD as SIGNATURE_FLAG_TO_SCHEME, aE as SIGNATURE_SCHEME_TO_FLAG, aF as normalizeIotaAddress, ad as bytesToHex, aG as blake2b, aH as bytesEqual, p as push, F as legacy_pre_effect, u as store_get, g as get, m as mutable_source, n as set, H as legacy_pre_effect_reset, i as init, f as from_html, s as sibling, c as child, b as if_block, t as template_effect, X as set_value, e as set_text, k as append, l as pop, v as setup_stores, o as getClient, T as TransactionDataBuilder, aI as get$1, af as iota_wallets, a8 as activeAddress, ae as Transaction, q as mutate, I as each, J as untrack, K as index, B as delegate } from "/iota-utils/assets/index-DnAm28wB.js";
...
import { u as usePageQueryParams, a as updatePageQueryParams } from "/iota-utils/assets/page-query-params-CW6CCVAS.js";
...
var root_1 = from_html(`<div class="dry-run-result svelte-qb6v63"><button class="dry-run-close svelte-qb6v63" aria-label="Close dry run result" title="Close">&#10005;</button> <div class="dry-run-title">Dry Run Result</div> <!></div>`);
...
var root_7 = from_html(`<div class="signature-item svelte-qb6v63"><div class="signature-header svelte-qb6v63"> </div> <div class="signature-details svelte-qb6v63"><div class="detail-item svelte-qb6v63"><span class="detail-label svelte-qb6v63">Public key:</span> <span class="detail-value svelte-qb6v63"> </span> <button class="copy-button svelte-qb6v63">Copy</button></div> <div class="detail-item svelte-qb6v63"><span class="detail-label svelte-qb6v63">Public key with flag:</span> <span class="detail-value svelte-qb6v63"> </span> <button class="copy-button svelte-qb6v63">Copy</button></div> <div class="detail-item svelte-qb6v63"><span class="detail-label svelte-qb6v63">Address:</span> <span class="detail-value svelte-qb6v63"> </span> <button class="copy-button svelte-qb6v63">Copy</button></div> <div class="detail-item svelte-qb6v63"><span class="detail-label svelte-qb6v63">Signature:</span> <span class="detail-value svelte-qb6v63"> </span> <button class="copy-button svelte-qb6v63">Copy</button></div></div></div>`);
var root_6 = from_html(`<div class="signature-details-container svelte-qb6v63"></div>`);
var root_8 = from_html(`<div style="margin: 20px 0;"><!></div>`);
var root_9 = from_html(`<div style="color: #ef4444; margin: 10px 0;"> </div>`);
var root = from_html(`<main><div><div style="float: left; display: flex; align-items: center; gap: 10px;"><span>Tx bytes base64 encoded or message:</span> <button style="padding: 4px 8px; font-size: 12px;" class="svelte-qb6v63">Example tx</button></div> <div class="box"><textarea placeholder="base64 transaction bytes or message" class="svelte-qb6v63"></textarea></div></div> <div style="margin-top: 20px; display: flex; gap: 10px;"><button class="svelte-qb6v63">Sign Tx</button> <button class="svelte-qb6v63">Sign Message</button> <button class="svelte-qb6v63">Dry Run</button></div> <!> <div><div style="margin-bottom: 6px; font-weight: bold;"> </div> <textarea placeholder="Signature (base64)" class="signature-textarea svelte-qb6v63"></textarea> <!> <!> <!> <!> <button class="svelte-qb6v63">Submit Signed Tx</button></div> <!> <!> <!></main>`);
  ...
  var node_6 = sibling(node_4, 2);
  {
    var consequent_5 = ($$anchor2) => {
      ...
      each(div_11, 5, () => get(signaturePubkeyPairs), index, ($$anchor3, pair, index2) => {
        ...
        button_5.__click = () => copyToClipboard(get(pair).publicKey.toBase64());
        var div_16 = sibling(div_15, 2);
        var span_1 = sibling(child(div_16), 2);
        var text_5 = child(span_1);
        var button_6 = sibling(span_1, 2);
        button_6.__click = () => copyToClipboard(get(pair).publicKey.toIotaPublicKey());
        var div_17 = sibling(div_16, 2);
        var span_2 = sibling(child(div_17), 2);
        var text_6 = child(span_2);
        var button_7 = sibling(span_2, 2);
        button_7.__click = () => copyToClipboard(get(pair).publicKey.toIotaAddress());
        var div_18 = sibling(div_17, 2);
        var span_3 = sibling(child(div_18), 2);
        var text_7 = child(span_3);
        var button_8 = sibling(span_3, 2);
        button_8.__click = () => copyToClipboard(bufferExports.Buffer.from(get(pair).signature).toString("base64"));
        template_effect(
          ($0, $1, $2, $3) => {
