...
import { A as getDefaultExportFromCjs, p as push, B as prop, q as onMount, g as get, m as mutable_source, C as onDestroy, D as legacy_pre_effect, l as set$1, E as deep_read_state, F as legacy_pre_effect_reset, i as init, f as from_html, s as sibling, c as child, G as each$1, H as index$1, I as init_select, b as if_block, J as untrack, t as template_effect, K as select_option, e as event, j as append, k as pop, o as mutate, d as set_text, L as bind_value, M as bind_group, N as first_child, O as text, P as comment, Q as set_style, v as getSelectedNetworkConfig, R as set_attribute, S as set_class } from "/iota-utils/assets/index-LSzG6O2x.js";
import { b as bind_this } from "/iota-utils/assets/this-B0ipSicb.js";
import { g as getTransactionLink, a as getObjectLink, b as getAddressLink, T as TransactionView } from "/iota-utils/assets/TransactionView-BqBJn15y.js";
import { E as EpochPTBAnalyzer } from "/iota-utils/assets/index-DsPHThAQ.js";
import "/iota-utils/assets/transaction-view-D2YsAVC7.js";
import "/iota-utils/assets/client-BN-Hd5HA.js";
import "/iota-utils/assets/iota-nano-conversion-63uBrWen.js";
import "/iota-utils/assets/index-DtL_1hQz.js";
/*!
 * @kurkle/color v0.3.4
...
var root_4 = from_html(`<span class="checkpoint-count svelte-uf8f2g"> </span>`);
...
var root_8 = from_html(`<span class="checkpoint-count svelte-uf8f2g"> </span>`);
var root_5 = from_html(`<input id="start-checkpoint" type="number" placeholder="Start" min="0" style="width: 8rem;"/> <span class="range-separator svelte-uf8f2g">to</span> <input id="end-checkpoint" type="number" placeholder="End" min="0" style="width: 8rem;"/> <button class="fetch-current-epoch-btn" title="Fetch current epoch range"><!></button> <!>`, 1);
...
var root_18 = from_html(`<div class="progress-section svelte-uf8f2g"><div class="progress-label svelte-uf8f2g"><span> </span> <span class="progress-percentage svelte-uf8f2g"> </span></div> <div class="progress-bar svelte-uf8f2g"><div class="progress-fill svelte-uf8f2g"></div></div></div>`);
var root_17 = from_html(`<div class="progress-info svelte-uf8f2g"><div class="progress-header svelte-uf8f2g"><p class="svelte-uf8f2g"><strong>Progress:</strong> </p> <button class="stop-btn svelte-uf8f2g" title="Stop fetching data"> </button></div> <!></div>`);
...
var root_24 = from_html(`<div class="transaction-id-item svelte-uf8f2g"><a target="_blank" rel="noopener noreferrer" class="tx-id link-style svelte-uf8f2g"> </a> <button class="copy-btn" style="padding: 4px 8px; align-self: center;" title="Copy transaction ID">📋</button></div>`);
var root_23 = from_html(`<div class="function-item svelte-uf8f2g"><div class="function-header svelte-uf8f2g"><div class="function-signature svelte-uf8f2g"><div class="function-parts svelte-uf8f2g"><a target="_blank" rel="noopener noreferrer" class="package-id link-style svelte-uf8f2g"> </a><span class="separator svelte-uf8f2g">::</span><span class="module svelte-uf8f2g"> </span><span class="separator svelte-uf8f2g">::</span><span class="function-name svelte-uf8f2g"> </span> <button class="copy-btn svelte-uf8f2g" style="padding: 4px 8px; font-size: 13px;" title="Copy full function signature">📋</button></div> <div class="function-actions svelte-uf8f2g"><details class="svelte-uf8f2g"><summary class="svelte-uf8f2g">Txs</summary></details></div></div> <div class="function-stats svelte-uf8f2g"><div class="call-count svelte-uf8f2g"><span class="count-label">Calls:</span> <span class="count-value"> </span></div> <div class="tx-count svelte-uf8f2g"><span class="count-label">Txs:</span> <span class="count-value"> </span></div></div></div> <div class="transaction-ids-section svelte-uf8f2g"><div class="transaction-ids-list svelte-uf8f2g"></div></div></div>`);
var root_25 = from_html(`<div class="address-item svelte-uf8f2g"><div class="address-header svelte-uf8f2g"><div class="address-left svelte-uf8f2g"><div class="address-info svelte-uf8f2g"><a target="_blank" rel="noopener noreferrer" class="link-style svelte-uf8f2g"> </a></div> <button class="copy-btn" style="padding: 4px 8px; align-self: center;" title="Copy address">📋</button></div> <div class="address-stats svelte-uf8f2g"><div class="tx-count svelte-uf8f2g"><span class="count-label">TXs:</span> <span class="count-value"> </span></div></div></div></div>`);
var root_26 = from_html(`<div class="address-item svelte-uf8f2g"><div class="address-header svelte-uf8f2g"><div class="address-left svelte-uf8f2g"><div class="address-info svelte-uf8f2g"><a target="_blank" rel="noopener noreferrer" class="link-style svelte-uf8f2g"> </a></div> <button class="copy-btn" style="padding: 4px 8px; align-self: center;" title="Copy address">📋</button></div> <div class="address-stats svelte-uf8f2g"><div class="call-count svelte-uf8f2g"><span class="count-label">Calls:</span> <span class="count-value"> </span></div></div></div></div>`);
var root_29 = from_html(`<span class="module-name svelte-uf8f2g"> </span>`);
var root_28 = from_html(`<div class="modules-row svelte-uf8f2g"><span class="modules-label svelte-uf8f2g">Modules:</span> <div class="modules-list svelte-uf8f2g"></div></div>`);
var root_27 = from_html(`<div class="package-item svelte-uf8f2g"><div class="package-left svelte-uf8f2g"><div class="package-header svelte-uf8f2g"><div class="package-info svelte-uf8f2g"><div class="package-id-row svelte-uf8f2g"><span class="package-label svelte-uf8f2g">Package:</span> <a target="_blank" rel="noopener noreferrer" class="package-id link-style svelte-uf8f2g"> </a> <button class="copy-btn" style="padding: 4px 8px; align-self: center;" title="Copy package ID">📋</button></div> <!> <div class="sender-row svelte-uf8f2g"><span class="sender-label svelte-uf8f2g">Sender:</span> <a target="_blank" rel="noopener noreferrer" class="sender-address link-style svelte-uf8f2g"> </a> <button class="copy-btn" style="padding: 4px 8px; align-self: center;" title="Copy sender address">📋</button></div></div></div></div> <div class="package-meta svelte-uf8f2g"><div class="version-info"><span class="version-label"> </span></div> <a target="_blank" rel="noopener noreferrer" class="copy-btn tx-btn link-style svelte-uf8f2g">TX</a></div></div>`);
var root_32 = from_html(`<div class="transaction-id-item svelte-uf8f2g"><a target="_blank" rel="noopener noreferrer" class="tx-id link-style svelte-uf8f2g"> </a> <button class="copy-btn" style="padding: 4px 8px; align-self: center;" title="Copy transaction ID">📋</button></div>`);
var root_31 = from_html(`<div class="function-item svelte-uf8f2g"><div class="function-header svelte-uf8f2g"><div class="function-signature svelte-uf8f2g"><div class="address-left svelte-uf8f2g"><div class="address-info svelte-uf8f2g"><span> </span></div> <button class="copy-btn" style="padding: 4px 8px; align-self: center;" title="Copy command type">📋</button></div> <div class="function-actions svelte-uf8f2g"><details class="svelte-uf8f2g"><summary class="svelte-uf8f2g">Txs</summary></details></div> <div class="address-stats svelte-uf8f2g"><div class="call-count svelte-uf8f2g"><span class="count-label">Count:</span> <span class="count-value"> </span></div></div></div></div> <div class="transaction-ids-section svelte-uf8f2g"><div class="transaction-ids-list svelte-uf8f2g"></div></div></div>`);
var root_34 = from_html(`<button class="clear-checkpoint-btn" title="Clear checkpoint selection">✕</button>`);
var root_35 = from_html(`<div class="checkpoint-loading svelte-uf8f2g"><p> </p></div>`);
var root_39 = from_html(`<span class="transaction-digest svelte-uf8f2g"> </span>`);
var root_41 = from_html(`<span class="transaction-digest svelte-uf8f2g"> </span>`);
var root_42 = from_html(`<span> </span>`);
var root_38 = from_html(`<details class="transaction-details svelte-uf8f2g"><summary class="transaction-summary svelte-uf8f2g"><span class="transaction-number svelte-uf8f2g"></span> <!> <!></summary> <div class="transaction-content svelte-uf8f2g"><!></div></details>`);
var root_37 = from_html(`<div class="checkpoint-transactions"><div class="transaction-list svelte-uf8f2g"></div></div>`);
var root_44 = from_html(`<div class="no-transactions svelte-uf8f2g"><p> </p></div>`);
var root_45 = from_html(`<div class="checkpoint-placeholder svelte-uf8f2g"><p>Click on a data point in the chart above or enter a checkpoint
                                number to inspect its transactions</p></div>`);
var root_33 = from_html(`<!> <div class="checkpoint-inspector svelte-uf8f2g"><h4 class="svelte-uf8f2g">Checkpoint Inspector</h4> <div class="checkpoint-input-section svelte-uf8f2g"><label for="checkpoint-input" class="svelte-uf8f2g">Checkpoint Number:</label> <input id="checkpoint-input" type="number" placeholder="Enter checkpoint number or click on chart" min="0" class="svelte-uf8f2g"/> <!> <div class="checkpoint-filter-row" style="margin-top: 10px; display: flex; align-items: center; gap: 8px;"><input id="checkpoint-filter-input" type="text" placeholder="Filter transactions by substring (JSON)" style="width: 18rem; font-size: 12px;" class="svelte-uf8f2g"/> <button class="example-btn svelte-uf8f2g" title="Insert example substring">Example</button> <button class="fetch-current-epoch-btn" title="Filter transactions by substring">Filter</button></div> <h5> </h5></div> <!></div>`, 1);
var root_19 = from_html(`<div class="results"><!> <!> <div class="summary-cards svelte-uf8f2g"><div class="summary-card svelte-uf8f2g"><h4 class="svelte-uf8f2g">Total PTBs</h4> <div class="metric svelte-uf8f2g"> </div> </div> <div class="summary-card svelte-uf8f2g"><h4 class="svelte-uf8f2g">Unique Senders</h4> <div class="metric svelte-uf8f2g"> </div></div> <div class="summary-card svelte-uf8f2g"><h4 class="svelte-uf8f2g">Called Functions</h4> <div class="metric svelte-uf8f2g"> </div></div> <div class="summary-card svelte-uf8f2g"><h4 class="svelte-uf8f2g">Published Packages</h4> <div class="metric svelte-uf8f2g"> </div></div></div> <div class="details-section svelte-uf8f2g"><details class="svelte-uf8f2g"><summary class="svelte-uf8f2g"> </summary> <div class="function-list svelte-uf8f2g"></div></details> <details class="svelte-uf8f2g"><summary class="svelte-uf8f2g"> </summary> <div class="address-list svelte-uf8f2g"></div></details> <details class="svelte-uf8f2g"><summary class="svelte-uf8f2g"> </summary> <div class="address-list svelte-uf8f2g"></div></details> <details class="svelte-uf8f2g"><summary class="svelte-uf8f2g"> </summary> <div class="package-list svelte-uf8f2g"></div></details> <details class="svelte-uf8f2g"><summary class="svelte-uf8f2g"> </summary> <div class="command-type-list"><!></div></details></div> <!></div>`);
var root = from_html(`<div class="epoch-transaction-blocks svelte-uf8f2g"><p style="margin-top:0;">Query programmable transaction blocks data for a specific epoch or checkpoint range</p> <div class="input-section svelte-uf8f2g"><div class="filter-section svelte-uf8f2g"><div class="filter-row svelte-uf8f2g"><div class="filter-group svelte-uf8f2g"><label for="input-object-filter" class="svelte-uf8f2g">Input Object:</label> <div class="input-with-button svelte-uf8f2g"><input id="input-object-filter" type="text" placeholder="0x... object ID" class="wide-input svelte-uf8f2g"/> <button class="example-btn svelte-uf8f2g" title="Insert example object ID">Example</button></div></div> <div class="filter-group svelte-uf8f2g"><label for="function-filter" class="svelte-uf8f2g">Function:</label> <div class="input-with-button svelte-uf8f2g"><input id="function-filter" type="text" placeholder="package::module::function" class="wide-input svelte-uf8f2g"/> <button class="example-btn svelte-uf8f2g" title="Insert example function">Example</button></div></div></div></div> <div class="input-row-single svelte-uf8f2g"><div class="mode-selection-column svelte-uf8f2g"><label class="mode-option-stacked svelte-uf8f2g"><span class="mode-label-stacked svelte-uf8f2g">Epoch Number</span> <input type="radio" class="svelte-uf8f2g"/></label> <label class="mode-option-stacked svelte-uf8f2g"><span class="mode-label-stacked svelte-uf8f2g">Checkpoint Range</span> <input type="radio" class="svelte-uf8f2g"/></label></div> <div class="input-controls svelte-uf8f2g"><!></div></div> <div class="button-row svelte-uf8f2g"><button> </button> <div class="input-group svelte-uf8f2g"><label for="transaction-limit">Limit to:</label> <input id="transaction-limit" type="number" placeholder="Max transactions" min="1" style="width: 6rem;"/></div> <button> </button></div></div> <!> <!> <!></div>`);
    ...
    var consequent_24 = ($$anchor2) => {
      ...
      var node_18 = sibling(div_32, 2);
      {
        var consequent_23 = ($$anchor3) => {
          ...
          var div_84 = sibling(node_20, 2);
          var input_9 = child(div_84);
          var button_16 = sibling(input_9, 2);
          var button_17 = sibling(button_16, 2);
          var h5 = sibling(div_84, 2);
          var text_49 = child(h5);
          var node_21 = sibling(div_83, 2);
          {
            var consequent_17 = ($$anchor4) => {
              var div_85 = root_35();
              var p_7 = child(div_85);
                    ...
                    ($$anchor6, tx, index2) => {
                      ...
                      var node_25 = sibling(node_23, 2);
                      {
                        var consequent_20 = ($$anchor7) => {
                          ...
                          template_effect(
                            ($0) => {
                              classes = set_class(span_17, 1, "transaction-status svelte-uf8f2g", null, classes, $0);
                      ...
                      var div_88 = sibling(summary_5, 2);
          ...
          template_effect(() => {
            ...
            button_16.disabled = get(loadingCheckpointTransactions) || !get(selectedCheckpoint);
            button_17.disabled = (get(loadingCheckpointTransactions), get(selectedCheckpoint), get(checkpointTransactions), untrack(() => get(loadingCheckpointTransactions) || !get(selectedCheckpoint) || !get(checkpointTransactions).length));
          ...
          event("click", button_16, () => set$1(checkpointFilterSubstring, "MoveCall"));
          event("click", button_17, filterCheckpointTransactions);
