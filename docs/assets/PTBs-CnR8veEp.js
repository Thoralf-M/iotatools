import { M as getDefaultExportFromCjs, p as push, N as prop, q as onMount, g as get, O as onDestroy, P as legacy_pre_effect, l as set$1, Q as deep_read_state, R as legacy_pre_effect_reset, i as init, s as sibling, k as child, H as each$1, t as template_effect, d as set_text, S as untrack, h as append, I as index$1, U as init_select, b as if_block, V as select_option, e as event, j as pop, m as mutable_source, r as mutate, n as from_html, x as bind_value, W as bind_group, J as first_child, w as getSelectedNetworkConfig, c as set_attribute, L as text, K as comment, X as set_style, Y as set_class } from "./index-4zFFfimK.js";
...
import { f as formatAddress, c as copyToClipboard } from "./formatting-DskCwl5J.js";
import { E as EpochPTBAnalyzer } from "./epoch-ptb-analyzer-DYbFxvMJ.js";
...
var root_41 = from_html(`<span class="transaction-digest svelte-5fvkuj"> </span>`);
var root_42 = from_html(`<span> </span>`);
var root_38 = from_html(`<details class="transaction-details svelte-5fvkuj"><summary class="transaction-summary svelte-5fvkuj"><span class="transaction-number svelte-5fvkuj"></span> <!> <!></summary> <div class="transaction-content svelte-5fvkuj"><!></div></details>`);
var root_37 = from_html(`<div class="checkpoint-transactions"><div class="transaction-list svelte-5fvkuj"></div></div>`);
var root_44 = from_html(`<div class="no-transactions svelte-5fvkuj"><p> </p></div>`);
var root_45 = from_html(`<div class="checkpoint-placeholder svelte-5fvkuj"><p>Click on a data point in the chart above or enter a checkpoint
