import { aD as Transaction, a$ as IOTA_SYSTEM_STATE_OBJECT_ID, ag as bcs, a8 as isValidIotaAddress, p as push, X as legacy_pre_effect, g as get, m as mutable_source, n as set, Z as legacy_pre_effect_reset, i as init, a as from_html, s as sibling, c as child, b as if_block, N as user_derived, D as TransactionView, t as template_effect, e as set_text, h as event, y as bind_value, k as append, l as pop, w as setup_stores, o as getClient, _ as untrack, Y as deep_read_state, aw as formatNumberWithUnderscores, a4 as set_style, Q as first_child, r as store_get, f as formatNumbersWithUnderscores, ap as activeAddress, R as comment, L as each, O as index } from "./index-BCoJFR-s.js";
import { I as IotaAmountInput } from "./IotaAmountInput-DwZC5HDF.js";
import { e as executeTransaction } from "./transaction-execution-DH0Awqu1.js";
import { c as computeStakingRewards } from "./staking-utils-uPx5JcoR.js";
...
var root_8 = from_html(`<div class="validator-item svelte-qq920f" style="margin: 0.125rem 0; border: 1px solid grey; border-radius: 4px; cursor: pointer;" role="button" tabindex="0"><div class="validator-content svelte-qq920f"><span class="validator-address svelte-qq920f"> </span> <span class="validator-status svelte-qq920f" style="color: #c62828;"> </span> <span class="validator-name svelte-qq920f"> </span> <span class="validator-stake svelte-qq920f"> </span></div></div>`);
var root_6 = from_html(`<div style="margin-bottom: 1rem;"><div class="section-header svelte-qq920f" style="font-weight: bold; border: 1px solid #ddd; border-radius: 4px; cursor: pointer; display: flex; justify-content: space-between; align-items: center;" role="button" tabindex="0"><span class="svelte-qq920f"> </span> <span class="svelte-qq920f"> </span></div> <!></div>`);
...
var root_9 = from_html(`<div><div class="section-header svelte-qq920f" style="font-weight: bold; border: 1px solid grey; border-radius: 4px; cursor: pointer; display: flex; justify-content: space-between; align-items: center;" role="button" tabindex="0"><span class="svelte-qq920f"> </span> <span class="svelte-qq920f"> </span></div> <!></div>`);
var root_5 = from_html(`<div><strong>Select a validator:</strong></div> <!> <!>`, 1);
...
function Stake($$anchor, $$props) {
  ...
  var node_1 = sibling(span_1, 2);
  {
      ...
      var node_2 = child(div_1);
      {
        ...
        var alternate = ($$anchor3) => {
          ...
          var node_3 = sibling(first_child(fragment), 2);
          {
            ...
            var d_1 = user_derived(() => (get(validators), untrack(() => get(validators).filter((v) => v.status === "Candidate").length > 0)));
          ...
          var node_6 = sibling(node_3, 2);
          {
            ...
            var d_2 = user_derived(() => (get(validators), untrack(() => get(validators).filter((v) => v.status === "Committee Member" || v.status === "Active Validator").length > 0)));
    ...
    if_block(node_1, ($$render) => {
      ...
      else if (get(selectedValidator)) $$render(consequent_8, 1);
    });
  }
  var div_14 = sibling(node_1, 4);
