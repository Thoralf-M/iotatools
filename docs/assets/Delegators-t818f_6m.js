import { ak as is_runes, a3 as block, a5 as BranchManager, o as getClient, w as getSelectedNetworkConfig, p as push, M as prop, q as onMount, N as onDestroy, i as init, f as from_html, s as sibling, c as child, g as get, m as mutable_source, n as set, x as bind_value, h as event, k as append, l as pop, E as state, F as proxy, b as if_block, t as template_effect, a2 as user_derived, e as set_text, J as first_child, K as comment, al as update, am as tick, H as each, I as index, B as delegate, W as set_style, X as set_class, L as text } from "./index-DhPNfbms.js";
import { I as IotaGraphQLClient } from "./client-EYP8Efee.js";
...
var root_5 = from_html(`<button class="svelte-z1qq95"> </button>`);
var root_6 = from_html(`<button class="svelte-z1qq95">Pause Fetching</button>`);
var root_9 = from_html(`<div class="progress-bar-container svelte-z1qq95"><div class="progress-bar svelte-z1qq95"><div class="progress-fill svelte-z1qq95"></div></div> <span class="progress-percentage svelte-z1qq95"> </span></div>`);
var root_8 = from_html(`<div class="svelte-z1qq95"> </div> <!>`, 1);
var root_10 = from_html(`<div class="timer svelte-z1qq95"> </div>`);
var root_11 = from_html(`<div class="svelte-z1qq95"> </div>`);
var root_12 = from_html(`<div class="svelte-z1qq95"> </div>`);
var root_7 = from_html(`<div class="progress-message svelte-z1qq95"><!> <!> <!> <!></div>`);
var root_14 = from_html(`<div class="stat-card svelte-z1qq95"><div class="stat-label svelte-z1qq95">Total Stake (System State)</div> <div class="stat-value svelte-z1qq95"> </div></div> <div class="stat-card svelte-z1qq95"><div class="stat-label svelte-z1qq95">Wrapped Stake (Other Objects)</div> <div class="stat-value svelte-z1qq95"> </div></div>`, 1);
var root_15 = from_html(`<div class="stat-card svelte-z1qq95"><div class="stat-label svelte-z1qq95">Total Stake Percentage</div> <div class="stat-value svelte-z1qq95"> </div></div>`);
var root_19 = from_html(`<th class="svelte-z1qq95">Object ID</th> <th class="svelte-z1qq95">Type</th>`, 1);
var root_20 = from_html(`<th class="svelte-z1qq95">Count</th>`);
var root_22 = from_html(`<td class="object-id-cell svelte-z1qq95"><span class="object-id-text svelte-z1qq95"> </span> <button class="copy-btn svelte-z1qq95" title="Copy object ID">📋</button></td> <td class="type-cell svelte-z1qq95"><span> </span></td>`, 1);
var root_23 = from_html(`<td class="count-cell svelte-z1qq95"> </td>`);
var root_25 = from_html(`<span class="muted svelte-z1qq95">Multiple</span>`);
var root_21 = from_html(`<tr class="svelte-z1qq95"><!><td class="numeric-cell svelte-z1qq95"> </td><td class="numeric-cell svelte-z1qq95"><!></td><td class="owner-address-cell svelte-z1qq95"><span class="owner-address-text svelte-z1qq95"> </span> <button class="copy-btn svelte-z1qq95" title="Copy owner address">📋</button></td></tr>`);
var root_26 = from_html(`<div class="objects-footer svelte-z1qq95"><div class="objects-count svelte-z1qq95"> </div> <button class="load-more-btn svelte-z1qq95">Load 200 more</button></div>`);
var root_28 = from_html(`<div class="objects-footer svelte-z1qq95"><div class="objects-count svelte-z1qq95"> </div></div>`);
...
var root_17 = from_html(`<tr class="svelte-z1qq95"><td class="rank-cell svelte-z1qq95"> </td><td class="name-cell svelte-z1qq95"><button class="details-btn svelte-z1qq95" title="View staked objects"> </button> <span class="validator-name svelte-z1qq95"> </span></td><td class="numeric-cell svelte-z1qq95"> </td><td class="numeric-cell svelte-z1qq95"> </td><td class="numeric-cell svelte-z1qq95"> </td><td class="numeric-cell svelte-z1qq95"> </td><td class="numeric-cell svelte-z1qq95"> </td><td class="numeric-cell svelte-z1qq95"> </td><td class="numeric-cell svelte-z1qq95"> </td><td class="numeric-cell svelte-z1qq95"> </td><td class="address-cell svelte-z1qq95"><span class="address-text svelte-z1qq95"> </span> <button class="copy-btn svelte-z1qq95" title="Copy address">📋</button></td></tr> <!>`, 1);
var root_16 = from_html(`<h2 class="svelte-z1qq95">Validator Statistics</h2> <p> </p> <div class="validators-table-container svelte-z1qq95"><table class="validators-table svelte-z1qq95"><thead><tr><th class="rank-header svelte-z1qq95">Rank</th><th class="sortable svelte-z1qq95"> </th><th class="sortable svelte-z1qq95"> </th><th class="sortable svelte-z1qq95"> </th><th class="sortable svelte-z1qq95"> </th><th class="sortable svelte-z1qq95"> </th><th class="sortable svelte-z1qq95"> </th><th class="sortable svelte-z1qq95"> </th><th class="sortable svelte-z1qq95"> </th><th class="sortable svelte-z1qq95"> </th><th class="svelte-z1qq95">Address</th></tr></thead><tbody class="svelte-z1qq95"></tbody></table></div>`, 1);
var root_30 = from_html(`<tr class="svelte-z1qq95"><td class="rank-cell svelte-z1qq95"> </td><td class="richlist-address-cell svelte-z1qq95"><span class="richlist-address-text svelte-z1qq95"> </span> <button class="copy-btn svelte-z1qq95" title="Copy address">📋</button></td><td class="numeric-cell svelte-z1qq95"> </td><td class="numeric-cell svelte-z1qq95"> </td></tr>`);
var root_31 = from_html(`<div class="objects-footer svelte-z1qq95"><div class="objects-count svelte-z1qq95"> </div> <button class="load-more-btn svelte-z1qq95">Load 200 more</button></div>`);
var root_33 = from_html(`<div class="objects-footer svelte-z1qq95"><div class="objects-count svelte-z1qq95"> </div></div>`);
var root_29 = from_html(`<h2 class="svelte-z1qq95">Delegator Richlist</h2> <div class="richlist-table-container svelte-z1qq95"><table class="richlist-table svelte-z1qq95"><thead><tr><th class="rank-header svelte-z1qq95">Rank</th><th class="svelte-z1qq95">Owner Address</th><th class="svelte-z1qq95">Total Staked (IOTA)</th><th class="svelte-z1qq95">Staked Objects</th></tr></thead><tbody class="svelte-z1qq95"></tbody></table></div> <!>`, 1);
var root_13 = from_html(`<div class="stats-container svelte-z1qq95"><h2 class="svelte-z1qq95">Global Statistics</h2> <div class="stats-grid svelte-z1qq95"><div class="stat-card svelte-z1qq95"><div class="stat-label svelte-z1qq95">Total Staked Objects</div> <div class="stat-value svelte-z1qq95"> </div></div> <div class="stat-card svelte-z1qq95"><div class="stat-label svelte-z1qq95">Total Timelocked Objects</div> <div class="stat-value svelte-z1qq95"> </div></div> <div class="stat-card svelte-z1qq95"><div class="stat-label svelte-z1qq95">Total Unique Addresses</div> <div class="stat-value svelte-z1qq95"> </div></div> <div class="stat-card svelte-z1qq95"><div class="stat-label svelte-z1qq95">Total Staked Amount (IOTA)</div> <div class="stat-value svelte-z1qq95"> </div></div> <!> <div class="stat-card svelte-z1qq95"><div class="stat-label svelte-z1qq95">Average Staked Amount (IOTA)</div> <div class="stat-value svelte-z1qq95"> </div></div> <div class="stat-card svelte-z1qq95"><div class="stat-label svelte-z1qq95">Average Stake Duration (epochs)</div> <div class="stat-value svelte-z1qq95"> </div></div> <!></div></div> <!> <!> <!>`, 1);
...
function Delegators($$anchor, $$props) {
  ...
  var node_1 = child(div_5);
  {
    var consequent_1 = ($$anchor2) => {
      ...
      button.__click = startFreshFetch;
      var button_1 = sibling(button, 2);
      button_1.__click = fetchData;
  ...
  var node_3 = sibling(node_1, 2);
  {
    var consequent_3 = ($$anchor2) => {
      var button_3 = root_6();
      button_3.__click = pauseFetching;
    ...
    var consequent_23 = ($$anchor2) => {
      ...
      var node_11 = sibling(div_22, 2);
      {
        var consequent_10 = ($$anchor3) => {
          ...
          var div_24 = first_child(fragment_4);
      ...
      var node_13 = sibling(div_14, 2);
      {
        var consequent_18 = ($$anchor3) => {
          ...
          var p = sibling(first_child(fragment_5), 2);
          var text_17 = child(p);
          ...
          th.__click = () => sortValidators("name");
          var text_18 = child(th);
          var th_1 = sibling(th);
          th_1.__click = () => sortValidators("stakedObjectCount");
          var text_19 = child(th_1);
          var th_2 = sibling(th_1);
          th_2.__click = () => sortValidators("timelockedObjectCount");
          var text_20 = child(th_2);
          var th_3 = sibling(th_2);
          th_3.__click = () => sortValidators("uniqueAddresses");
          var text_21 = child(th_3);
          var th_4 = sibling(th_3);
          th_4.__click = () => sortValidators("totalStakedAmount");
          var text_22 = child(th_4);
          var th_5 = sibling(th_4);
          th_5.__click = () => sortValidators("averageStakedAmount");
          var text_23 = child(th_5);
          var th_6 = sibling(th_5);
          th_6.__click = () => sortValidators("averageStakeDuration");
          var text_24 = child(th_6);
          var th_7 = sibling(th_6);
          th_7.__click = () => sortValidators("stakePercentage");
          var text_25 = child(th_7);
          var th_8 = sibling(th_7);
          th_8.__click = () => sortValidators("systemStakePercentage");
          ...
          each(tbody, 23, () => get(stats).validators, (validator) => validator.address, ($$anchor4, validator, index$1) => {
            ...
            var tr_1 = first_child(fragment_6);
            var td = child(tr_1);
            var text_27 = child(td);
            var td_1 = sibling(td);
            var button_4 = child(td_1);
            button_4.__click = () => toggleValidatorDetails(get(validator).poolId);
            ...
            button_5.__click = () => navigator.clipboard.writeText(get(validator).address);
            var node_14 = sibling(tr_1, 2);
            {
              var consequent_17 = ($$anchor5) => {
                ...
                th_10.__click = () => sortObjectTable("amount");
                var text_40 = child(th_10);
                var th_11 = sibling(th_10);
                th_11.__click = () => sortObjectTable("epoch");
                var text_41 = child(th_11);
                var th_12 = sibling(th_11);
                th_12.__click = () => sortObjectTable("owner");
                ...
                each(tbody_1, 21, () => get(objectRows).slice(0, get(objectRowsLimit)), index, ($$anchor6, row) => {
                  ...
                  var node_16 = child(tr_4);
                  {
                    var consequent_13 = ($$anchor7) => {
                      ...
                      var td_12 = first_child(fragment_8);
                      var span_3 = child(td_12);
                      var text_43 = child(span_3);
                      var button_6 = sibling(span_3, 2);
                      button_6.__click = () => navigator.clipboard.writeText(get(row).id);
                  ...
                  button_7.__click = () => navigator.clipboard.writeText(get(row).ownerAddress);
                  template_effect(
                    ($0, $1, $2) => {
                      set_text(text_46, $0);
                ...
                var node_18 = sibling(div_36, 2);
                {
                  var consequent_15 = ($$anchor6) => {
                    ...
                    button_8.__click = () => set(objectRowsLimit, get(objectRowsLimit) + 200);
                    template_effect(
                  ...
                  var alternate_5 = ($$anchor6) => {
                    ...
                    var node_19 = first_child(fragment_10);
                    {
                      var consequent_16 = ($$anchor7) => {
                        ...
                        append($$anchor7, div_39);
                      };
                      if_block(
                        node_19,
                        ($$render) => {
                          if (get(objectRows).length > 0) $$render(consequent_16);
                        },
                        true
                      );
                    }
      ...
      var node_20 = sibling(node_13, 2);
      {
        var consequent_21 = ($$anchor3) => {
          ...
          var div_41 = sibling(first_child(fragment_11), 2);
          ...
          each(tbody_2, 23, () => get(computedRichlistRows).slice(0, get(richlistRowsLimit)), (row) => row.ownerAddress, ($$anchor4, row, index2) => {
            ...
            button_9.__click = () => navigator.clipboard.writeText(get(row).ownerAddress);
          ...
          var node_21 = sibling(div_41, 2);
          {
            var consequent_19 = ($$anchor4) => {
              ...
              button_10.__click = () => set(richlistRowsLimit, get(richlistRowsLimit) + 200);
              template_effect(
            ...
            var alternate_6 = ($$anchor4) => {
              ...
              var node_22 = first_child(fragment_12);
              {
                ...
                if_block(
                  node_22,
                  ($$render) => {
                    if (get(computedRichlistRows).length > 0) $$render(consequent_20);
                  },
                  true
                );
              }
      ...
      var node_23 = sibling(node_20, 2);
      {
        var consequent_22 = ($$anchor3) => {
          ...
          key(node_24, () => get(chartVersion), ($$anchor4) => {
