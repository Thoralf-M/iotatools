import { p as push, D as legacy_pre_effect, g as get, m as mutable_source, l as set, F as legacy_pre_effect_reset, i as init, f as from_html, s as sibling, c as child, r as store_get, b as if_block, J as untrack, t as template_effect, d as set_text, S as set_class, L as bind_value, j as append, k as pop, u as setup_stores, ag as activeAddress, Y as isValidIotaAddress, G as each, H as index, P as comment, N as first_child, n as getClient, an as Transaction, z as delegate, aS as set_selected } from "/iota-utils/assets/index-LSzG6O2x.js";
...
const fetchAvailableCoins = async (_, fetchingCoins, fetchError, $activeAddress, availableCoins, extractSymbolFromCoinType, hasFetched) => {
  try {
...
var root_5 = from_html(`<div style="margin-top: 0.5rem; font-size: 0.9rem; color: #666;">No coins available</div>`);
var root_6 = from_html(`<div style="color: red; margin-top: 0.5rem; font-size: 0.9rem;"> </div>`);
var root_7 = from_html(`<div style="margin: 1rem 0; text-align: left; display: inline-block;"> <br/> </div>`);
var root = from_html(`<main><div><h3>Bulk Transfer</h3> <p>Transfer coins to multiple addresses in a single transaction.</p> <div style="margin-bottom: 1rem;"><div style="margin-bottom: 1rem;"><button style="padding: 0.5rem 1rem; margin-bottom: 0.5rem;" class="svelte-1ak88x7"> </button> <!></div> <!></div> <div><details style="margin-bottom: 1rem;"><summary>Example formats</summary> <div style="display: flex; gap: 2rem; justify-content: center;"><div><h4>JSON format:</h4> <pre style="padding: 1rem; text-align: left;"></pre></div> <div><h4>CSV format:</h4> <pre style="padding: 1rem; text-align: left;"></pre></div> <div><h4>Space-separated:</h4> <pre style="padding: 1rem;"></pre></div></div></details> <div style="display: inline-block;"><div style="text-align: left;">Transfers (amount in the smallest unit (NANO for IOTA)) - JSON, CSV, or
                    space-separated:</div> <textarea rows="15" placeholder="Enter transfers in JSON, CSV, or space-separated format"></textarea></div> <!></div> <!> <br/> <button class="svelte-1ak88x7">Execute Bulk Transfer</button></div> <!></main>`);
...
0x111173a14c3d402c01546c54265c30cc04414c7b7ec1732412bb19066dd49d11 2000000000`);
    ...
    var alternate = ($$anchor2) => {
      ...
      var node_3 = first_child(fragment);
      {
        ...
        if_block(
          node_3,
          ($$render) => {
            if (get(hasFetched)) $$render(consequent_2);
          },
          true
        );
      }
  ...
  template_effect(
    ($0) => {
      ...
      classes = set_class(textarea, 1, "svelte-1ak88x7", null, classes, $0);
    },
    [() => ({ error: !!get(errorMsg) })]
  );
